...
{
	/// <summary>
	﻿/// This section provides semantic information for the <see cref="PowerSource">PowerSource</see> entity.<br /><br />![PowerSource](figures/PowerSource.png "PowerSource"){: width="0.8"}<br/><br />
