...
{
	/// <summary>﻿The abstract <see cref="Interface">Interface</see> is realized by the following types listed in this section. <br /><br />In order to implement the <i>interaction model</i> for <i>interface</i>s, each piece of equipment associated with an <i>interface</i> <b>MUST</b> provide the corresponding <see cref="Interface">Interface</see> type. A piece of equipment <b>MAY</b> support any number of unique <i>interface</i>s.<br /><br /><br />Interfaces for Device and Observation Information Models<br /><br />The <i>interaction model</i> for implementing <i>interface</i>s is defined in the MTConnect Standard as an extension to the <i>Device Information Model</i> and <i>Observation Information Model</i>.<br /><br />A piece of equipment <b>MAY</b> support multiple different <i>interface</i>s. Each piece of equipment supporting <i>interface</i>s <b>MUST</b> model the information associated with each <i>interface</i> as an <see cref="Interface">Interface</see> component.  <see cref="Interface">Interface</see> is an abstract <see cref="Component">Component</see> and is realized by <see cref="Interface">Interface</see> component types. <br /><br />The {{figure(Interfaces in Entity Hierarchy)}} illustrates where an <see cref="Interface">Interface</see> is modeled in the <i>Device Information Model</i> for a piece of equipment.<br /><br />![Interfaces in Entity Hierarchy](figures/Interfaces%20in%20Entity%20Hierarchy.png "Interfaces in Entity Hierarchy"){: width="0.8"}<br /><br /><br /><br /><br />
