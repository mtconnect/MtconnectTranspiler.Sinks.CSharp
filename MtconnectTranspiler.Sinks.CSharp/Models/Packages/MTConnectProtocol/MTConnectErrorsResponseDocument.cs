...
";
		...
		#region Packages
	private Package.ErrorTypesPackage _ErrorTypesPackage;
	/// <summary>
	/// <inheritdoc cref="Package.ErrorTypesPackage" path="/summary" />
	/// </summary>
	public Package.ErrorTypesPackage ErrorTypesPackage => _ErrorTypesPackage ?? (_ErrorTypesPackage = new Package.ErrorTypesPackage());
