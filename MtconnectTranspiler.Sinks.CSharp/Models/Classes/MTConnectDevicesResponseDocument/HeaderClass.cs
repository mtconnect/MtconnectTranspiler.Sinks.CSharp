...
namespace Mtconnect.Fundamentals.MTConnectProtocol.MTConnectDevicesResponseDocument
{
	...
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure__EAID_08B1605D_39B4_4475_A436_A457B1D646A2">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class HeaderClass : IClass
	{
		...
		public const string REFERENCE_ID = "EAID_08B1605D_39B4_4475_A436_A457B1D646A2";
		/// <summary>Constant value for <see cref="HeaderClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure__EAID_08B1605D_39B4_4475_A436_A457B1D646A2";
...
";
				...
				/// <summary>Constant value for <see cref="AssetBufferSizeProperty.Multiplicity" /></summary>
...
";
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="CreationTimeProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "1";
...
";
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="SenderProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "1";
...
";
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="VersionProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "1";
...
";
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="FirstSequenceProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "0..1";
...
";
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="LastSequenceProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "0..1";
...
";
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="NextSequenceProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "0..1";
...
";
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="DeviceModelChangeTimeProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "1";
			...
			/// <summary>
			/// <inheritdoc cref="HasAssetCountPartProperty" path="/summary" /><br/>
			...
			{
				/// <summary>Constant value for <see cref="HasAssetCountPartProperty.Name" /></summary>
				public const string NAME = "hasAssetCount";
				/// <summary>Constant value for <see cref="HasAssetCountPartProperty.Summary" /></summary>
				public const string SUMMARY = @"";
				/// <summary>Constant value for <see cref="HasAssetCountPartProperty.AccessModifier" /></summary>
				public const string ACCESS_MODIFIER = "public";
				/// <summary>Constant value for <see cref="HasAssetCountPartProperty.Modifier" /></summary>
				public const string MODIFIER = "";
				/// <summary>Constant value for <see cref="HasAssetCountPartProperty.NormativeVersion" /></summary>
				public const string NORMATIVE_VERSION = "";
				/// <summary>Constant value for <see cref="HasAssetCountPartProperty.DeprecatedVersion" /></summary>
				public const string DEPRECATED_VERSION = "";
				/// <summary>Constant value for <see cref="HasAssetCountPartProperty.Aggregation" /></summary>
				public const string AGGREGATION = "composite";
				/// <summary>Constant value for <see cref="HasAssetCountPartProperty.Extension" /></summary>
				public const string EXTENSION = "";
				/// <summary>Constant value for <see cref="HasAssetCountPartProperty.Association" /></summary>
				public const string ASSOCIATION = "AssetCounts";
				/// <summary>Constant value for <see cref="HasAssetCountPartProperty.DefaultValue" /></summary>
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="HasAssetCountPartProperty.Multiplicity" /></summary>
...
";
		...
		*/
		...
		/// </summary>
		/// <remarks>Specification Language: <c>Unspecified</c></remarks>
		public string Header2 => @"creationTime->size() = 1 and
