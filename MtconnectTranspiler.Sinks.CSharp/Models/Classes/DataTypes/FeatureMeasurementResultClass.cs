...
namespace Mtconnect.DataTypes
{
	...
	public sealed class FeatureMeasurementResultClass : IClass
	{
		...
		/// </summary>
		public class FeatureMeasurementResultClassProperties : Mtconnect.ObservationInformationModel.Representations.Table.TableClass.TableClassProperties
		{
			/// <inheritdoc />
...
";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="FeatureMeasurementResultClass" />.
		/// </summary>
