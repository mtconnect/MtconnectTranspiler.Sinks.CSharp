...
{
	/// <summary>﻿<see cref="SampleEnum.ANGULAR_DECELERATION">SampleEnum.ANGULAR_DECELERATION</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605642749479_983550_196">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class AngularDecelerationClass : IClass
	{
		/// <summary>Constant value for <see cref="AngularDecelerationClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1605642749479_983550_196";
		/// <summary>Constant value for <see cref="AngularDecelerationClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605642749479_983550_196";
		/// <summary>Constant value for <see cref="AngularDecelerationClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::ANGULAR_DECELERATION)}}&#10;
";
		/// <summary>Constant value for <see cref="AngularDecelerationClass.Name" /></summary>
		public const string NAME = "AngularDeceleration";
		/// <summary>Constant value for <see cref="AngularDecelerationClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="AngularDecelerationClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="AngularDecelerationClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.7";
		/// <summary>Constant value for <see cref="AngularDecelerationClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new AngularDecelerationClassProperties Properties { get; } = new AngularDecelerationClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="AngularDecelerationClass" />.
		...
		/// </summary>
		public class AngularDecelerationClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DEGREE/SECOND^2";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "ANGULAR_DECELERATION";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="AngularDecelerationClass" />.
		/// </summary>
