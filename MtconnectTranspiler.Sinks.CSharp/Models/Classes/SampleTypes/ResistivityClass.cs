...
{
	/// <summary>﻿<see cref="SampleEnum.RESISTIVITY">SampleEnum.RESISTIVITY</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___2024x_68e0225_1727727419677_160573_24195">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class ResistivityClass : IClass
	{
		/// <summary>Constant value for <see cref="ResistivityClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_2024x_68e0225_1727727419677_160573_24195";
		/// <summary>Constant value for <see cref="ResistivityClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___2024x_68e0225_1727727419677_160573_24195";
		/// <summary>Constant value for <see cref="ResistivityClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::RESISTIVITY)}}&#10;
";
		/// <summary>Constant value for <see cref="ResistivityClass.Name" /></summary>
		public const string NAME = "Resistivity";
		/// <summary>Constant value for <see cref="ResistivityClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ResistivityClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ResistivityClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.5";
		/// <summary>Constant value for <see cref="ResistivityClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ResistivityClassProperties Properties { get; } = new ResistivityClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ResistivityClass" />.
		...
		/// </summary>
		public class ResistivityClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "OHM_METER";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "RESISTIVITY";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ResistivityClass" />.
		/// </summary>
