...
{
	/// <summary>﻿<see cref="SampleEnum.ELECTRICAL_ENERGY">SampleEnum.ELECTRICAL_ENERGY</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218285_896491_1770">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class ElectricalEnergyClass : IClass
	{
		/// <summary>Constant value for <see cref="ElectricalEnergyClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218285_896491_1770";
		/// <summary>Constant value for <see cref="ElectricalEnergyClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218285_896491_1770";
		/// <summary>Constant value for <see cref="ElectricalEnergyClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::ELECTRICAL_ENERGY)}}&#10;
";
		/// <summary>Constant value for <see cref="ElectricalEnergyClass.Name" /></summary>
		public const string NAME = "ElectricalEnergy";
		/// <summary>Constant value for <see cref="ElectricalEnergyClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ElectricalEnergyClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ElectricalEnergyClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="ElectricalEnergyClass.DeprecatedVersion" /></summary>
		...
		/// </summary>
		public class ElectricalEnergyClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "WATT_SECOND";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "ELECTRICAL_ENERGY";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ElectricalEnergyClass" />.
		/// </summary>
