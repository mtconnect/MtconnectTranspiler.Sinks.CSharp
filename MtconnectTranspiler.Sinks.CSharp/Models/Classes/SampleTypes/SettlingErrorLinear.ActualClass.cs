...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.SampleTypes
{
	...
	public sealed class SettlingErrorLinearActualClass : IClass
	{
		...
		/// <inheritdoc />
		public string Name => "SettlingErrorLinear.ActualClass";
		...
		/// <inheritdoc />
		public string Generalization => "_19_0_3_68e0225_1660329283868_866231_555";

		/// <inheritdoc />
		public SettlingErrorLinearActualClassProperties Properties { get; } = new SettlingErrorLinearActualClassProperties();
        IPropertyList IClass.Properties => Properties;
		public sealed class SettlingErrorLinearActualClassProperties : IPropertyList
		{
			/// <inheritdoc />
