...
{
	/// <summary>﻿<see cref="SampleEnum.RESISTANCE">SampleEnum.RESISTANCE</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218434_188173_2142">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class ResistanceClass : IClass
	{
		/// <summary>Constant value for <see cref="ResistanceClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218434_188173_2142";
		/// <summary>Constant value for <see cref="ResistanceClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218434_188173_2142";
		/// <summary>Constant value for <see cref="ResistanceClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::RESISTANCE)}}&#10;
";
		/// <summary>Constant value for <see cref="ResistanceClass.Name" /></summary>
		public const string NAME = "Resistance";
		/// <summary>Constant value for <see cref="ResistanceClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ResistanceClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ResistanceClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="ResistanceClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ResistanceClassProperties Properties { get; } = new ResistanceClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ResistanceClass" />.
		...
		/// </summary>
		public class ResistanceClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "OHM";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "RESISTANCE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ResistanceClass" />.
		/// </summary>
