...
{
	/// <summary>﻿<see cref="SampleEnum.VOLT_AMPERE_REACTIVE">SampleEnum.VOLT_AMPERE_REACTIVE</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218477_744952_2277">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class VoltAmpereReactiveClass : IClass
	{
		/// <summary>Constant value for <see cref="VoltAmpereReactiveClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218477_744952_2277";
		/// <summary>Constant value for <see cref="VoltAmpereReactiveClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218477_744952_2277";
		/// <summary>Constant value for <see cref="VoltAmpereReactiveClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::VOLT_AMPERE_REACTIVE)}}&#10;
";
		/// <summary>Constant value for <see cref="VoltAmpereReactiveClass.Name" /></summary>
		public const string NAME = "VoltAmpereReactive";
		/// <summary>Constant value for <see cref="VoltAmpereReactiveClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="VoltAmpereReactiveClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="VoltAmpereReactiveClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="VoltAmpereReactiveClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new VoltAmpereReactiveClassProperties Properties { get; } = new VoltAmpereReactiveClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="VoltAmpereReactiveClass" />.
		...
		/// </summary>
		public class VoltAmpereReactiveClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "VOLT_AMPERE_REACTIVE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="VoltAmpereReactiveClass" />.
		/// </summary>
