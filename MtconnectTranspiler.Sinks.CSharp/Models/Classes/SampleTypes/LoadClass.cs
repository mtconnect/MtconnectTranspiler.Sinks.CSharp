...
{
	/// <summary>﻿<see cref="SampleEnum.LOAD">SampleEnum.LOAD</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="LoadClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218342_32796_1902";
		/// <summary>Constant value for <see cref="LoadClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218342_32796_1902";
		/// <summary>Constant value for <see cref="LoadClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::LOAD)}}&#10;
";
		/// <summary>Constant value for <see cref="LoadClass.Name" /></summary>
		public const string NAME = "Load";
		/// <summary>Constant value for <see cref="LoadClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="LoadClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="LoadClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.0";
		/// <summary>Constant value for <see cref="LoadClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new LoadClassProperties Properties { get; } = new LoadClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="LoadClass" />.
		...
		public class LoadClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "LOAD";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="LoadClass" />.
		/// </summary>
