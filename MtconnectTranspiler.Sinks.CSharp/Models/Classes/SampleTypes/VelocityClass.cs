...
{
	/// <summary>﻿<see cref="SampleEnum.VELOCITY">SampleEnum.VELOCITY</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218467_799828_2253">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class VelocityClass : IClass
	{
		/// <summary>Constant value for <see cref="VelocityClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218467_799828_2253";
		/// <summary>Constant value for <see cref="VelocityClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218467_799828_2253";
		/// <summary>Constant value for <see cref="VelocityClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::VELOCITY)}}&#10;
";
		/// <summary>Constant value for <see cref="VelocityClass.Name" /></summary>
		public const string NAME = "Velocity";
		/// <summary>Constant value for <see cref="VelocityClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="VelocityClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="VelocityClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.0";
		/// <summary>Constant value for <see cref="VelocityClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new VelocityClassProperties Properties { get; } = new VelocityClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="VelocityClass" />.
		...
		/// </summary>
		public class VelocityClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "VELOCITY";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="VelocityClass" />.
		/// </summary>
