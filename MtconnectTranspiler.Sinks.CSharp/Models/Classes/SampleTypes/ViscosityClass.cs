...
{
	/// <summary>﻿<see cref="SampleEnum.VISCOSITY">SampleEnum.VISCOSITY</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218468_92553_2256">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class ViscosityClass : IClass
	{
		/// <summary>Constant value for <see cref="ViscosityClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218468_92553_2256";
		/// <summary>Constant value for <see cref="ViscosityClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218468_92553_2256";
		/// <summary>Constant value for <see cref="ViscosityClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::VISCOSITY)}}&#10;
";
		/// <summary>Constant value for <see cref="ViscosityClass.Name" /></summary>
		public const string NAME = "Viscosity";
		/// <summary>Constant value for <see cref="ViscosityClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ViscosityClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ViscosityClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="ViscosityClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ViscosityClassProperties Properties { get; } = new ViscosityClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ViscosityClass" />.
		...
		/// </summary>
		public class ViscosityClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PASCAL_SECOND";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "VISCOSITY";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ViscosityClass" />.
		/// </summary>
