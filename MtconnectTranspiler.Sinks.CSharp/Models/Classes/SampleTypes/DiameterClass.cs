...
{
	/// <summary>﻿<see cref="SampleEnum.DIAMETER">SampleEnum.DIAMETER</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587736194199_193243_1157">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class DiameterClass : IClass
	{
		/// <summary>Constant value for <see cref="DiameterClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_91b028d_1587736194199_193243_1157";
		/// <summary>Constant value for <see cref="DiameterClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587736194199_193243_1157";
		/// <summary>Constant value for <see cref="DiameterClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::DIAMETER)}}&#10;
";
		/// <summary>Constant value for <see cref="DiameterClass.Name" /></summary>
		public const string NAME = "Diameter";
		/// <summary>Constant value for <see cref="DiameterClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DiameterClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DiameterClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.6";
		/// <summary>Constant value for <see cref="DiameterClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new DiameterClassProperties Properties { get; } = new DiameterClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="DiameterClass" />.
		...
		/// </summary>
		public class DiameterClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DIAMETER";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DiameterClass" />.
		/// </summary>
