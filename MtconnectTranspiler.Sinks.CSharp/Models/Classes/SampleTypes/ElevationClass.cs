...
{
	/// <summary>﻿<see cref="SampleEnum.ELEVATION">SampleEnum.ELEVATION</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___2026x_e1e032f_1777120094005_743274_134">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class ElevationClass : IClass
	{
		/// <summary>Constant value for <see cref="ElevationClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_2026x_e1e032f_1777120094005_743274_134";
		/// <summary>Constant value for <see cref="ElevationClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___2026x_e1e032f_1777120094005_743274_134";
		/// <summary>Constant value for <see cref="ElevationClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::ELEVATION)}}&#10;
";
		/// <summary>Constant value for <see cref="ElevationClass.Name" /></summary>
		public const string NAME = "Elevation";
		/// <summary>Constant value for <see cref="ElevationClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ElevationClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ElevationClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.8";
		/// <summary>Constant value for <see cref="ElevationClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ElevationClassProperties Properties { get; } = new ElevationClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ElevationClass" />.
		...
		/// </summary>
		public class ElevationClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "METER";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "ELEVATION";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ElevationClass" />.
		/// </summary>
