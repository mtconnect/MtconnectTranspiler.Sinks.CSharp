...
{
	/// <summary>﻿<see cref="SampleEnum.FOLLOWING_ERROR">SampleEnum.FOLLOWING_ERROR</see><br /><br /><br />
	...
	public sealed class FollowingErrorClass : IClass
	{
		/// <summary>Constant value for <see cref="FollowingErrorClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1660329437798_692445_601";
		/// <summary>Constant value for <see cref="FollowingErrorClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1660329437798_692445_601";
		/// <summary>Constant value for <see cref="FollowingErrorClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::FOLLOWING_ERROR)}}&#10;
";
		/// <summary>Constant value for <see cref="FollowingErrorClass.Name" /></summary>
		public const string NAME = "FollowingError";
		/// <summary>Constant value for <see cref="FollowingErrorClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="FollowingErrorClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="FollowingErrorClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.1";
		/// <summary>Constant value for <see cref="FollowingErrorClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new FollowingErrorClassProperties Properties { get; } = new FollowingErrorClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="FollowingErrorClass" />.
		...
		/// </summary>
		public class FollowingErrorClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "FOLLOWING_ERROR";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="FollowingErrorClass" />.
		/// </summary>
