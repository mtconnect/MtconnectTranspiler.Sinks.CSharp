...
{
	/// <summary>
	/// <see cref="SampleEnum::FOLLOWING_ERROR">SampleEnum::FOLLOWING_ERROR</see>
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_68e0225_1660329437798_692445_601";
		
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""SampleEnum::FOLLOWING_ERROR"">SampleEnum::FOLLOWING_ERROR</see>";

		/// <inheritdoc />
		public string Name => "FollowingError";
		...
		/// <inheritdoc />
		public FollowingErrorClassProperties Properties { get; } = new FollowingErrorClassProperties();
		...
		public class FollowingErrorClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public sealed class TypeProperty : IProperty
			{
				...
				// Note: DefaultValue.Name
				/// <inheritdoc />
				public string DefaultValue => "FOLLOWING_ERROR";
			}
		};
