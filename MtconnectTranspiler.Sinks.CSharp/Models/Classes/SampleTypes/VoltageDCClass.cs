...
{
	/// <summary>﻿<see cref="SampleEnum.VOLTAGE_DC">SampleEnum.VOLTAGE_DC</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587735397938_964180_702">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class VoltageDCClass : IClass
	{
		/// <summary>Constant value for <see cref="VoltageDCClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_91b028d_1587735397938_964180_702";
		/// <summary>Constant value for <see cref="VoltageDCClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587735397938_964180_702";
		/// <summary>Constant value for <see cref="VoltageDCClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::VOLTAGE_DC)}}&#10;
";
		/// <summary>Constant value for <see cref="VoltageDCClass.Name" /></summary>
		public const string NAME = "VoltageDC";
		/// <summary>Constant value for <see cref="VoltageDCClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="VoltageDCClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="VoltageDCClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.6";
		/// <summary>Constant value for <see cref="VoltageDCClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new VoltageDCClassProperties Properties { get; } = new VoltageDCClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="VoltageDCClass" />.
		...
		/// </summary>
		public class VoltageDCClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "VOLTAGE_DC";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="VoltageDCClass" />.
		/// </summary>
