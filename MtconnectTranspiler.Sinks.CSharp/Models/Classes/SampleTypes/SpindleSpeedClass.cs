...
{
	/// <summary>﻿<see cref="SampleEnum.SPINDLE_SPEED">SampleEnum.SPINDLE_SPEED</see><br /><br /><br />
	...
	public sealed class SpindleSpeedClass : IClass
	{
		/// <summary>Constant value for <see cref="SpindleSpeedClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218447_87713_2190";
		/// <summary>Constant value for <see cref="SpindleSpeedClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218447_87713_2190";
		/// <summary>Constant value for <see cref="SpindleSpeedClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::SPINDLE_SPEED)}}&#10;
";
		/// <summary>Constant value for <see cref="SpindleSpeedClass.Name" /></summary>
		public const string NAME = "SpindleSpeed";
		/// <summary>Constant value for <see cref="SpindleSpeedClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="SpindleSpeedClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="SpindleSpeedClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.0";
		/// <summary>Constant value for <see cref="SpindleSpeedClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new SpindleSpeedClassProperties Properties { get; } = new SpindleSpeedClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="SpindleSpeedClass" />.
		...
		/// </summary>
		public class SpindleSpeedClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "SPINDLE_SPEED";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="SpindleSpeedClass" />.
		/// </summary>
