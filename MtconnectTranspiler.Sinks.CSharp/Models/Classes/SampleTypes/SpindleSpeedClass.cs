...
{
	/// <summary>
	/// <see cref="SampleEnum::SPINDLE_SPEED">SampleEnum::SPINDLE_SPEED</see>
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580378218447_87713_2190";
		
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""SampleEnum::SPINDLE_SPEED"">SampleEnum::SPINDLE_SPEED</see>";

		/// <inheritdoc />
		public string Name => "SpindleSpeed";
		...
		/// <inheritdoc />
		public SpindleSpeedClassProperties Properties { get; } = new SpindleSpeedClassProperties();
		...
		public class SpindleSpeedClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public sealed class TypeProperty : IProperty
			{
				...
				// Note: DefaultValue.Name
				/// <inheritdoc />
				public string DefaultValue => "SPINDLE_SPEED";
			}
		};
