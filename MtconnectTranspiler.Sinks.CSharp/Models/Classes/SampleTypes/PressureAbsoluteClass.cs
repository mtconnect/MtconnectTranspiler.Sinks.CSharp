...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.SampleTypes
{
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_68e0225_1614240624009_539158_28";
...
";
		...
		/// <inheritdoc />
		public string Name => "PressureAbsolute";
		...
		public class PressureAbsoluteClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				/// <inheritdoc />
				public string DefaultValue => "PASCAL";
			}
			/// <summary>
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				// Note: DefaultValue.Name
				/// <inheritdoc />
				public string DefaultValue => "PRESSURE_ABSOLUTE";
			}
		};
