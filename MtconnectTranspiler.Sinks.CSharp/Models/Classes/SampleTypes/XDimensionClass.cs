...
{
	/// <summary>﻿<see cref="SampleEnum.X_DIMENSION">SampleEnum.X_DIMENSION</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587735623100_731742_994">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class XDimensionClass : IClass
	{
		/// <summary>Constant value for <see cref="XDimensionClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_91b028d_1587735623100_731742_994";
		/// <summary>Constant value for <see cref="XDimensionClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587735623100_731742_994";
		/// <summary>Constant value for <see cref="XDimensionClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::X_DIMENSION)}}&#10;
";
		/// <summary>Constant value for <see cref="XDimensionClass.Name" /></summary>
		public const string NAME = "XDimension";
		/// <summary>Constant value for <see cref="XDimensionClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="XDimensionClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="XDimensionClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.6";
		/// <summary>Constant value for <see cref="XDimensionClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new XDimensionClassProperties Properties { get; } = new XDimensionClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="XDimensionClass" />.
		...
		/// </summary>
		public class XDimensionClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "X_DIMENSION";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="XDimensionClass" />.
		/// </summary>
