...
{
	/// <summary>
	/// <see cref="SampleEnum::POSITION">SampleEnum::POSITION</see>
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580378218398_567350_2046";
		
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""SampleEnum::POSITION"">SampleEnum::POSITION</see>";
		...
		public class PositionClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public sealed class TypeProperty : IProperty
			{
				...
				// Note: DefaultValue.Name
				/// <inheritdoc />
				public string DefaultValue => "POSITION";
			}
		};
