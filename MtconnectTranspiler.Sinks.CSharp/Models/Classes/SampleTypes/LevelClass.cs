...
{
	/// <summary>﻿<see cref="SampleEnum.LEVEL">SampleEnum.LEVEL</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="LevelClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218331_809018_1875";
		/// <summary>Constant value for <see cref="LevelClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218331_809018_1875";
		/// <summary>Constant value for <see cref="LevelClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::LEVEL)}}&#10;
";
		/// <summary>Constant value for <see cref="LevelClass.Name" /></summary>
		public const string NAME = "Level";
		/// <summary>Constant value for <see cref="LevelClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="LevelClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="LevelClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.1";
		/// <summary>Constant value for <see cref="LevelClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new LevelClassProperties Properties { get; } = new LevelClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="LevelClass" />.
		...
		public class LevelClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "LEVEL";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="LevelClass" />.
		/// </summary>
