...
{
	/// <summary>
	/// <see cref="SampleEnum::SETTLING_ERROR_ANGULAR">SampleEnum::SETTLING_ERROR_ANGULAR</see>
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_68e0225_1660329285538_924389_578";
		
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""SampleEnum::SETTLING_ERROR_ANGULAR"">SampleEnum::SETTLING_ERROR_ANGULAR</see>";

		/// <inheritdoc />
		public string Name => "SettlingErrorAngular";
		...
		/// <inheritdoc />
		public SettlingErrorAngularClassProperties Properties { get; } = new SettlingErrorAngularClassProperties();
		...
		public class SettlingErrorAngularClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public sealed class TypeProperty : IProperty
			{
				...
				// Note: DefaultValue.Name
				/// <inheritdoc />
				public string DefaultValue => "SETTLING_ERROR_ANGULAR";
			}
		};
