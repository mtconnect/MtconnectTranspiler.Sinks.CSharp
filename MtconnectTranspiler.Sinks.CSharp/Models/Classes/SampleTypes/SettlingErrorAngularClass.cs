...
{
	/// <summary>﻿<see cref="SampleEnum.SETTLING_ERROR_ANGULAR">SampleEnum.SETTLING_ERROR_ANGULAR</see><br /><br /><br />
	...
	public sealed class SettlingErrorAngularClass : IClass
	{
		/// <summary>Constant value for <see cref="SettlingErrorAngularClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1660329285538_924389_578";
		/// <summary>Constant value for <see cref="SettlingErrorAngularClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1660329285538_924389_578";
		/// <summary>Constant value for <see cref="SettlingErrorAngularClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::SETTLING_ERROR_ANGULAR)}}&#10;
";
		/// <summary>Constant value for <see cref="SettlingErrorAngularClass.Name" /></summary>
		public const string NAME = "SettlingErrorAngular";
		/// <summary>Constant value for <see cref="SettlingErrorAngularClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="SettlingErrorAngularClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="SettlingErrorAngularClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.1";
		/// <summary>Constant value for <see cref="SettlingErrorAngularClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new SettlingErrorAngularClassProperties Properties { get; } = new SettlingErrorAngularClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="SettlingErrorAngularClass" />.
		...
		/// </summary>
		public class SettlingErrorAngularClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "SETTLING_ERROR_ANGULAR";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="SettlingErrorAngularClass" />.
		/// </summary>
