...
{
	/// <summary>﻿<see cref="SampleEnum.BATTERY_CHARGE">SampleEnum.BATTERY_CHARGE</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="BatteryChargeClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1660319546823_134814_409";
		/// <summary>Constant value for <see cref="BatteryChargeClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1660319546823_134814_409";
		/// <summary>Constant value for <see cref="BatteryChargeClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::BATTERY_CHARGE)}}&#10;
";
		/// <summary>Constant value for <see cref="BatteryChargeClass.Name" /></summary>
		public const string NAME = "BatteryCharge";
		/// <summary>Constant value for <see cref="BatteryChargeClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="BatteryChargeClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="BatteryChargeClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.1";
		/// <summary>Constant value for <see cref="BatteryChargeClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new BatteryChargeClassProperties Properties { get; } = new BatteryChargeClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="BatteryChargeClass" />.
		...
		/// </summary>
		public class BatteryChargeClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "BATTERY_CHARGE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="BatteryChargeClass" />.
		/// </summary>
