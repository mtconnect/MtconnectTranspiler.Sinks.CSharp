...
{
	/// <summary>﻿<see cref="SampleEnum.CUTTING_SPEED">SampleEnum.CUTTING_SPEED</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218246_14931_1680">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class CuttingSpeedClass : IClass
	{
		/// <summary>Constant value for <see cref="CuttingSpeedClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218246_14931_1680";
		/// <summary>Constant value for <see cref="CuttingSpeedClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218246_14931_1680";
		/// <summary>Constant value for <see cref="CuttingSpeedClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::CUTTING_SPEED)}}&#10;
";
		/// <summary>Constant value for <see cref="CuttingSpeedClass.Name" /></summary>
		public const string NAME = "CuttingSpeed";
		/// <summary>Constant value for <see cref="CuttingSpeedClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="CuttingSpeedClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="CuttingSpeedClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="CuttingSpeedClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new CuttingSpeedClassProperties Properties { get; } = new CuttingSpeedClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="CuttingSpeedClass" />.
		...
		/// </summary>
		public class CuttingSpeedClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "CUTTING_SPEED";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="CuttingSpeedClass" />.
		/// </summary>
