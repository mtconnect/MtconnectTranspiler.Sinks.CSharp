...
{
	/// <summary>
	/// <see cref="SampleEnum::CONCENTRATION">SampleEnum::CONCENTRATION</see>
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580378218232_876552_1650";
		
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""SampleEnum::CONCENTRATION"">SampleEnum::CONCENTRATION</see>";
		...
		public class ConcentrationClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public sealed class TypeProperty : IProperty
			{
				...
				// Note: DefaultValue.Name
				/// <inheritdoc />
				public string DefaultValue => "CONCENTRATION";
			}
		};
