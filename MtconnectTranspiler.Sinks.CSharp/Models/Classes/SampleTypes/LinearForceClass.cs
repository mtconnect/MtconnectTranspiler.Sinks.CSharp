...
{
	/// <summary>﻿<see cref="SampleEnum.LINEAR_FORCE">SampleEnum.LINEAR_FORCE</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218335_32762_1887">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class LinearForceClass : IClass
	{
		/// <summary>Constant value for <see cref="LinearForceClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218335_32762_1887";
		/// <summary>Constant value for <see cref="LinearForceClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218335_32762_1887";
		/// <summary>Constant value for <see cref="LinearForceClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::LINEAR_FORCE)}}&#10;
";
		/// <summary>Constant value for <see cref="LinearForceClass.Name" /></summary>
		public const string NAME = "LinearForce";
		/// <summary>Constant value for <see cref="LinearForceClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="LinearForceClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="LinearForceClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="LinearForceClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new LinearForceClassProperties Properties { get; } = new LinearForceClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="LinearForceClass" />.
		...
		/// </summary>
		public class LinearForceClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "NEWTON";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "LINEAR_FORCE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="LinearForceClass" />.
		/// </summary>
