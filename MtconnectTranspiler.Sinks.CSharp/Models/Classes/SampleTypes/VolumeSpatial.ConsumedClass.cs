...
{
	/// <summary>﻿reported or measured value of the amount used in the manufacturing process.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="VolumeSpatialConsumedClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218482_865957_2295";
		/// <summary>Constant value for <see cref="VolumeSpatialConsumedClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218482_865957_2295";
		/// <summary>Constant value for <see cref="VolumeSpatialConsumedClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;reported or measured value of the amount used in the manufacturing process.&#10;
";
		/// <summary>Constant value for <see cref="VolumeSpatialConsumedClass.Name" /></summary>
		public const string NAME = "VolumeSpatial.Consumed";
		/// <summary>Constant value for <see cref="VolumeSpatialConsumedClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="VolumeSpatialConsumedClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="VolumeSpatialConsumedClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="VolumeSpatialConsumedClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new VolumeSpatialConsumedClassProperties Properties { get; } = new VolumeSpatialConsumedClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="VolumeSpatialConsumedClass" />.
		...
		public class VolumeSpatialConsumedClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.SampleTypes.VolumeSpatialClass.VolumeSpatialClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "CONSUMED";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="VolumeSpatialConsumedClass" />.
		/// </summary>
