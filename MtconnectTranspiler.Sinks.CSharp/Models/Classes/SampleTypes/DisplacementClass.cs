...
{
	/// <summary>﻿<see cref="SampleEnum.DISPLACEMENT">SampleEnum.DISPLACEMENT</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218283_155376_1764">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class DisplacementClass : IClass
	{
		/// <summary>Constant value for <see cref="DisplacementClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218283_155376_1764";
		/// <summary>Constant value for <see cref="DisplacementClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218283_155376_1764";
		/// <summary>Constant value for <see cref="DisplacementClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::DISPLACEMENT)}}&#10;
";
		/// <summary>Constant value for <see cref="DisplacementClass.Name" /></summary>
		public const string NAME = "Displacement";
		/// <summary>Constant value for <see cref="DisplacementClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DisplacementClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DisplacementClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.0";
		/// <summary>Constant value for <see cref="DisplacementClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new DisplacementClassProperties Properties { get; } = new DisplacementClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="DisplacementClass" />.
		...
		/// </summary>
		public class DisplacementClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DISPLACEMENT";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DisplacementClass" />.
		/// </summary>
