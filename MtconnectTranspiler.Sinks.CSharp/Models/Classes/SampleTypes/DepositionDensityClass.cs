...
{
	/// <summary>﻿<see cref="SampleEnum.DEPOSITION_DENSITY">SampleEnum.DEPOSITION_DENSITY</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218262_675415_1716">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class DepositionDensityClass : IClass
	{
		/// <summary>Constant value for <see cref="DepositionDensityClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218262_675415_1716";
		/// <summary>Constant value for <see cref="DepositionDensityClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218262_675415_1716";
		/// <summary>Constant value for <see cref="DepositionDensityClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::DEPOSITION_DENSITY)}}&#10;
";
		/// <summary>Constant value for <see cref="DepositionDensityClass.Name" /></summary>
		public const string NAME = "DepositionDensity";
		/// <summary>Constant value for <see cref="DepositionDensityClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DepositionDensityClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DepositionDensityClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="DepositionDensityClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new DepositionDensityClassProperties Properties { get; } = new DepositionDensityClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="DepositionDensityClass" />.
		...
		/// </summary>
		public class DepositionDensityClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "MILLIGRAM/CUBIC_MILLIMETER";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DEPOSITION_DENSITY";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DepositionDensityClass" />.
		/// </summary>
