...
{
	/// <summary>﻿<see cref="SampleEnum.BATTERY_CAPACITY">SampleEnum.BATTERY_CAPACITY</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="BatteryCapacityClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1660319150238_731788_295";
		/// <summary>Constant value for <see cref="BatteryCapacityClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1660319150238_731788_295";
		/// <summary>Constant value for <see cref="BatteryCapacityClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::BATTERY_CAPACITY)}}&#10;
";
		/// <summary>Constant value for <see cref="BatteryCapacityClass.Name" /></summary>
		public const string NAME = "BatteryCapacity";
		/// <summary>Constant value for <see cref="BatteryCapacityClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="BatteryCapacityClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="BatteryCapacityClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.1";
		/// <summary>Constant value for <see cref="BatteryCapacityClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new BatteryCapacityClassProperties Properties { get; } = new BatteryCapacityClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="BatteryCapacityClass" />.
		...
		public class BatteryCapacityClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "COULOMB";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "BATTERY_CAPACITY";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="BatteryCapacityClass" />.
		/// </summary>
