...
{
	/// <summary>
	/// <see cref="SampleEnum::AXIS_FEEDRATE">SampleEnum::AXIS_FEEDRATE</see>
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580378218186_884374_1560";
		
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""SampleEnum::AXIS_FEEDRATE"">SampleEnum::AXIS_FEEDRATE</see>";

		/// <inheritdoc />
		public string Name => "AxisFeedrate";
		...
		/// <inheritdoc />
		public AxisFeedrateClassProperties Properties { get; } = new AxisFeedrateClassProperties();
		...
		public class AxisFeedrateClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public sealed class TypeProperty : IProperty
			{
				...
				// Note: DefaultValue.Name
				/// <inheritdoc />
				public string DefaultValue => "AXIS_FEEDRATE";
			}
		};
