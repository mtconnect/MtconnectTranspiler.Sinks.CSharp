...
{
	/// <summary>﻿<see cref="SampleEnum.AXIS_FEEDRATE">SampleEnum.AXIS_FEEDRATE</see><br /><br /><br />
	...
	public sealed class AxisFeedrateClass : IClass
	{
		/// <summary>Constant value for <see cref="AxisFeedrateClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218186_884374_1560";
		/// <summary>Constant value for <see cref="AxisFeedrateClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218186_884374_1560";
		/// <summary>Constant value for <see cref="AxisFeedrateClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::AXIS_FEEDRATE)}}&#10;
";
		/// <summary>Constant value for <see cref="AxisFeedrateClass.Name" /></summary>
		public const string NAME = "AxisFeedrate";
		/// <summary>Constant value for <see cref="AxisFeedrateClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="AxisFeedrateClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="AxisFeedrateClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.0";
		/// <summary>Constant value for <see cref="AxisFeedrateClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new AxisFeedrateClassProperties Properties { get; } = new AxisFeedrateClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="AxisFeedrateClass" />.
		...
		/// </summary>
		public class AxisFeedrateClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "AXIS_FEEDRATE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="AxisFeedrateClass" />.
		/// </summary>
