...
{
	/// <summary>﻿<see cref="SampleEnum.CHARGE_RATE">SampleEnum.CHARGE_RATE</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_68e0225_1660319471493_20110_373">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class ChargeRateClass : IClass
	{
		/// <summary>Constant value for <see cref="ChargeRateClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1660319471493_20110_373";
		/// <summary>Constant value for <see cref="ChargeRateClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1660319471493_20110_373";
		/// <summary>Constant value for <see cref="ChargeRateClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::CHARGE_RATE)}}&#10;
";
		/// <summary>Constant value for <see cref="ChargeRateClass.Name" /></summary>
		public const string NAME = "ChargeRate";
		/// <summary>Constant value for <see cref="ChargeRateClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ChargeRateClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ChargeRateClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.1";
		/// <summary>Constant value for <see cref="ChargeRateClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ChargeRateClassProperties Properties { get; } = new ChargeRateClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ChargeRateClass" />.
		...
		/// </summary>
		public class ChargeRateClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "AMPERE";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "CHARGE_RATE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ChargeRateClass" />.
		/// </summary>
