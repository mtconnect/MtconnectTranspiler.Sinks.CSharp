...
{
	/// <summary>﻿<see cref="SampleEnum.POWER_FACTOR">SampleEnum.POWER_FACTOR</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218404_198407_2061">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class PowerFactorClass : IClass
	{
		/// <summary>Constant value for <see cref="PowerFactorClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218404_198407_2061";
		/// <summary>Constant value for <see cref="PowerFactorClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218404_198407_2061";
		/// <summary>Constant value for <see cref="PowerFactorClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::POWER_FACTOR)}}&#10;
";
		/// <summary>Constant value for <see cref="PowerFactorClass.Name" /></summary>
		public const string NAME = "PowerFactor";
		/// <summary>Constant value for <see cref="PowerFactorClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PowerFactorClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PowerFactorClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="PowerFactorClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new PowerFactorClassProperties Properties { get; } = new PowerFactorClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="PowerFactorClass" />.
		...
		/// </summary>
		public class PowerFactorClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "POWER_FACTOR";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PowerFactorClass" />.
		/// </summary>
