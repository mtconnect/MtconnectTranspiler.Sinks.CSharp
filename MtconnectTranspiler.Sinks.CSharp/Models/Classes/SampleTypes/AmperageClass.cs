...
{
	/// <summary>﻿<see cref="SampleEnum.AMPERAGE">SampleEnum.AMPERAGE</see><br /><br /><br />
	...
	public sealed class AmperageClass : IClass
	{
		/// <summary>Constant value for <see cref="AmperageClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218148_357939_1518";
		/// <summary>Constant value for <see cref="AmperageClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218148_357939_1518";
		/// <summary>Constant value for <see cref="AmperageClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::AMPERAGE)}}&#10;
";
		/// <summary>Constant value for <see cref="AmperageClass.Name" /></summary>
		public const string NAME = "Amperage";
		/// <summary>Constant value for <see cref="AmperageClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="AmperageClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="AmperageClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.0";
		/// <summary>Constant value for <see cref="AmperageClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new AmperageClassProperties Properties { get; } = new AmperageClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="AmperageClass" />.
		...
		/// </summary>
		public class AmperageClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "AMPERAGE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="AmperageClass" />.
		/// </summary>
