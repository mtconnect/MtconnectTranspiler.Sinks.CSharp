...
{
	/// <summary>
	/// <see cref="SampleEnum::AMPERAGE">SampleEnum::AMPERAGE</see>
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580378218148_357939_1518";
		
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""SampleEnum::AMPERAGE"">SampleEnum::AMPERAGE</see>";
		...
		/// <inheritdoc />
		public AmperageClassProperties Properties { get; } = new AmperageClassProperties();
		...
		public class AmperageClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public sealed class TypeProperty : IProperty
			{
				...
				// Note: DefaultValue.Name
				/// <inheritdoc />
				public string DefaultValue => "AMPERAGE";
			}
		};
