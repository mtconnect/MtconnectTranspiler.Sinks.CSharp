...
{
	/// <summary>﻿<see cref="SampleEnum.CONDUCTIVITY">SampleEnum.CONDUCTIVITY</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218234_78662_1653">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class ConductivityClass : IClass
	{
		/// <summary>Constant value for <see cref="ConductivityClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218234_78662_1653";
		/// <summary>Constant value for <see cref="ConductivityClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218234_78662_1653";
		/// <summary>Constant value for <see cref="ConductivityClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::CONDUCTIVITY)}}&#10;
";
		/// <summary>Constant value for <see cref="ConductivityClass.Name" /></summary>
		public const string NAME = "Conductivity";
		/// <summary>Constant value for <see cref="ConductivityClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ConductivityClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ConductivityClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="ConductivityClass.DeprecatedVersion" /></summary>
		...
		/// </summary>
		public class ConductivityClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "SIEMENS/METER";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "CONDUCTIVITY";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ConductivityClass" />.
		/// </summary>
