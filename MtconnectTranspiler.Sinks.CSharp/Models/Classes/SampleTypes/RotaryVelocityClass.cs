...
{
	/// <summary>
	/// <see cref="SampleEnum::ROTARY_VELOCITY">SampleEnum::ROTARY_VELOCITY</see>
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580378218436_532649_2148";
		
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""SampleEnum::ROTARY_VELOCITY"">SampleEnum::ROTARY_VELOCITY</see>";

		/// <inheritdoc />
		public string Name => "RotaryVelocity";
		...
		/// <inheritdoc />
		public RotaryVelocityClassProperties Properties { get; } = new RotaryVelocityClassProperties();
		...
		public class RotaryVelocityClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public sealed class UnitsProperty : IProperty
			{
				...
				/// <inheritdoc />
				public string DefaultValue => "REVOLUTION/MINUTE";
			}
			/// <summary>
			...
			public sealed class TypeProperty : IProperty
			{
				...
				// Note: DefaultValue.Name
				/// <inheritdoc />
				public string DefaultValue => "ROTARY_VELOCITY";
			}
		};
