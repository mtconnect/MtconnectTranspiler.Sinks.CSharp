...
{
	/// <summary>﻿<see cref="SampleEnum.ROTARY_VELOCITY">SampleEnum.ROTARY_VELOCITY</see><br /><br /><br />
	...
	public sealed class RotaryVelocityClass : IClass
	{
		/// <summary>Constant value for <see cref="RotaryVelocityClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218436_532649_2148";
		/// <summary>Constant value for <see cref="RotaryVelocityClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218436_532649_2148";
		/// <summary>Constant value for <see cref="RotaryVelocityClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::ROTARY_VELOCITY)}}&#10;
";
		/// <summary>Constant value for <see cref="RotaryVelocityClass.Name" /></summary>
		public const string NAME = "RotaryVelocity";
		/// <summary>Constant value for <see cref="RotaryVelocityClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="RotaryVelocityClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="RotaryVelocityClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="RotaryVelocityClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new RotaryVelocityClassProperties Properties { get; } = new RotaryVelocityClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="RotaryVelocityClass" />.
		...
		/// </summary>
		public class RotaryVelocityClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "REVOLUTION/MINUTE";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "ROTARY_VELOCITY";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="RotaryVelocityClass" />.
		/// </summary>
