...
{
	/// <summary>﻿<see cref="SampleEnum.AMPERAGE_AC">SampleEnum.AMPERAGE_AC</see><br /><br /><br />
	...
	public sealed class AmperageACClass : IClass
	{
		/// <summary>Constant value for <see cref="AmperageACClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_91b028d_1587734470067_838040_247";
		/// <summary>Constant value for <see cref="AmperageACClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587734470067_838040_247";
		/// <summary>Constant value for <see cref="AmperageACClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::AMPERAGE_AC)}}&#10;
";
		/// <summary>Constant value for <see cref="AmperageACClass.Name" /></summary>
		public const string NAME = "AmperageAC";
		/// <summary>Constant value for <see cref="AmperageACClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="AmperageACClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="AmperageACClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.6";
		/// <summary>Constant value for <see cref="AmperageACClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new AmperageACClassProperties Properties { get; } = new AmperageACClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="AmperageACClass" />.
		...
		/// </summary>
		public class AmperageACClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "AMPERAGE_AC";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="AmperageACClass" />.
		/// </summary>
