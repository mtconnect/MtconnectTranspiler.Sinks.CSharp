...
{
	/// <summary>﻿<see cref="SampleEnum.VOLT_AMPERE">SampleEnum.VOLT_AMPERE</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218475_318871_2274">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class VoltAmpereClass : IClass
	{
		/// <summary>Constant value for <see cref="VoltAmpereClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218475_318871_2274";
		/// <summary>Constant value for <see cref="VoltAmpereClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218475_318871_2274";
		/// <summary>Constant value for <see cref="VoltAmpereClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::VOLT_AMPERE)}}&#10;
";
		/// <summary>Constant value for <see cref="VoltAmpereClass.Name" /></summary>
		public const string NAME = "VoltAmpere";
		/// <summary>Constant value for <see cref="VoltAmpereClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="VoltAmpereClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="VoltAmpereClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="VoltAmpereClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new VoltAmpereClassProperties Properties { get; } = new VoltAmpereClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="VoltAmpereClass" />.
		...
		/// </summary>
		public class VoltAmpereClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "VOLT_AMPERE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="VoltAmpereClass" />.
		/// </summary>
