...
{
	/// <summary>﻿<see cref="SampleEnum.OPENNESS">SampleEnum.OPENNESS</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_68e0225_1640703266000_211548_225">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class OpennessClass : IClass
	{
		/// <summary>Constant value for <see cref="OpennessClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1640703266000_211548_225";
		/// <summary>Constant value for <see cref="OpennessClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1640703266000_211548_225";
		/// <summary>Constant value for <see cref="OpennessClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::OPENNESS)}}&#10;
";
		/// <summary>Constant value for <see cref="OpennessClass.Name" /></summary>
		public const string NAME = "Openness";
		/// <summary>Constant value for <see cref="OpennessClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="OpennessClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="OpennessClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.0";
		/// <summary>Constant value for <see cref="OpennessClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new OpennessClassProperties Properties { get; } = new OpennessClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="OpennessClass" />.
		...
		/// </summary>
		public class OpennessClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string MODIFIER = "readonly";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "OPENNESS";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="OpennessClass" />.
		/// </summary>
