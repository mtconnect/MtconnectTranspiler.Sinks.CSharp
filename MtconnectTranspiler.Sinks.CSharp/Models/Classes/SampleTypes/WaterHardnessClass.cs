...
{
	/// <summary>﻿<see cref="SampleEnum.WATER_HARDNESS">SampleEnum.WATER_HARDNESS</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___2024x_68e0225_1760962647094_276885_585">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class WaterHardnessClass : IClass
	{
		/// <summary>Constant value for <see cref="WaterHardnessClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_2024x_68e0225_1760962647094_276885_585";
		/// <summary>Constant value for <see cref="WaterHardnessClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___2024x_68e0225_1760962647094_276885_585";
		/// <summary>Constant value for <see cref="WaterHardnessClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::WATER_HARDNESS)}}&#10;
";
		/// <summary>Constant value for <see cref="WaterHardnessClass.Name" /></summary>
		public const string NAME = "WaterHardness";
		/// <summary>Constant value for <see cref="WaterHardnessClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="WaterHardnessClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="WaterHardnessClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.7";
		/// <summary>Constant value for <see cref="WaterHardnessClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new WaterHardnessClassProperties Properties { get; } = new WaterHardnessClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="WaterHardnessClass" />.
		...
		/// </summary>
		public class WaterHardnessClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "MILLIGRAM/LITER";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "WATER_HARDNESS";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="WaterHardnessClass" />.
		/// </summary>
