...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.SampleTypes
{
	...
	{
		/// <summary>Constant value for <see cref="SettlingErrorAngularActualClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1660329285538_208737_579";
		/// <summary>Constant value for <see cref="SettlingErrorAngularActualClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1660329285538_208737_579";
		/// <summary>Constant value for <see cref="SettlingErrorAngularActualClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;measured or reported value of an {{term(observation)}}.&#10;
";
		/// <summary>Constant value for <see cref="SettlingErrorAngularActualClass.Name" /></summary>
		public const string NAME = "SettlingErrorAngular.Actual";
		/// <summary>Constant value for <see cref="SettlingErrorAngularActualClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="SettlingErrorAngularActualClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="SettlingErrorAngularActualClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.1";
		/// <summary>Constant value for <see cref="SettlingErrorAngularActualClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new SettlingErrorAngularActualClassProperties Properties { get; } = new SettlingErrorAngularActualClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="SettlingErrorAngularActualClass" />.
		/// <br/><b>Note</b>, some properties (<see cref="IProperty" />) are inherited from <see cref="Mtconnect.ObservationInformationModel.ObservationTypes.SampleTypes.SettlingErrorAngularClass.SettlingErrorAngularClassProperties" />.
		/// </summary>
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="SettlingErrorAngularActualClass" />.
		/// </summary>
