...
{
	/// <summary>﻿<see cref="SampleEnum.DISCHARGE_RATE">SampleEnum.DISCHARGE_RATE</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="DischargeRateClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1660319365123_992796_335";
		/// <summary>Constant value for <see cref="DischargeRateClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1660319365123_992796_335";
		/// <summary>Constant value for <see cref="DischargeRateClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::DISCHARGE_RATE)}}&#10;
";
		/// <summary>Constant value for <see cref="DischargeRateClass.Name" /></summary>
		public const string NAME = "DischargeRate";
		/// <summary>Constant value for <see cref="DischargeRateClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DischargeRateClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DischargeRateClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.1";
		/// <summary>Constant value for <see cref="DischargeRateClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new DischargeRateClassProperties Properties { get; } = new DischargeRateClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="DischargeRateClass" />.
		...
		/// </summary>
		public class DischargeRateClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DISCHARGE_RATE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DischargeRateClass" />.
		/// </summary>
