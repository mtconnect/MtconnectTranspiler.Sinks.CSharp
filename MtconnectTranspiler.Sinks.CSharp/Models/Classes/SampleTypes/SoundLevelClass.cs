...
{
	/// <summary>﻿<see cref="SampleEnum.SOUND_LEVEL">SampleEnum.SOUND_LEVEL</see><br /><br /><br />
	...
	public sealed class SoundLevelClass : IClass
	{
		/// <summary>Constant value for <see cref="SoundLevelClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218442_613083_2169";
		/// <summary>Constant value for <see cref="SoundLevelClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218442_613083_2169";
		/// <summary>Constant value for <see cref="SoundLevelClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::SOUND_LEVEL)}}&#10;
";
		/// <summary>Constant value for <see cref="SoundLevelClass.Name" /></summary>
		public const string NAME = "SoundLevel";
		/// <summary>Constant value for <see cref="SoundLevelClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="SoundLevelClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="SoundLevelClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="SoundLevelClass.DeprecatedVersion" /></summary>
		...
		/// </summary>
		public class SoundLevelClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DECIBEL";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "SOUND_LEVEL";
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "A_SCALE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="SoundLevelClass" />.
		/// </summary>
