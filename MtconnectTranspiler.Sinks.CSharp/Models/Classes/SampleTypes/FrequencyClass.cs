...
{
	/// <summary>﻿<see cref="SampleEnum.FREQUENCY">SampleEnum.FREQUENCY</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218311_52693_1830">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class FrequencyClass : IClass
	{
		/// <summary>Constant value for <see cref="FrequencyClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218311_52693_1830";
		/// <summary>Constant value for <see cref="FrequencyClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218311_52693_1830";
		/// <summary>Constant value for <see cref="FrequencyClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::FREQUENCY)}}&#10;
";
		/// <summary>Constant value for <see cref="FrequencyClass.Name" /></summary>
		public const string NAME = "Frequency";
		/// <summary>Constant value for <see cref="FrequencyClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="FrequencyClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="FrequencyClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.0";
		/// <summary>Constant value for <see cref="FrequencyClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new FrequencyClassProperties Properties { get; } = new FrequencyClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="FrequencyClass" />.
		...
		/// </summary>
		public class FrequencyClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "HERTZ";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "FREQUENCY";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="FrequencyClass" />.
		/// </summary>
