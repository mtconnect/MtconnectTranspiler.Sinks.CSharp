...
{
	/// <summary>
	/// <see cref="SampleEnum::VOLUME_SPATIAL">SampleEnum::VOLUME_SPATIAL</see>
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580378218480_687893_2289";
		
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""SampleEnum::VOLUME_SPATIAL"">SampleEnum::VOLUME_SPATIAL</see>";

		/// <inheritdoc />
		public string Name => "VolumeSpatial";
		...
		/// <inheritdoc />
		public VolumeSpatialClassProperties Properties { get; } = new VolumeSpatialClassProperties();
		...
		public class VolumeSpatialClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public sealed class TypeProperty : IProperty
			{
				...
				// Note: DefaultValue.Name
				/// <inheritdoc />
				public string DefaultValue => "VOLUME_SPATIAL";
			}
		};
