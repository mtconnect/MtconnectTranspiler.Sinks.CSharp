...
{
	/// <summary>
	﻿/// <see cref="SampleEnum.DISPLACEMENT_LINEAR">SampleEnum.DISPLACEMENT_LINEAR</see><br /><br />> Note: The displacement vector <b>MAY</b> be defined by the motion of the owning <see cref="Component">Component</see>.<br/><br />
