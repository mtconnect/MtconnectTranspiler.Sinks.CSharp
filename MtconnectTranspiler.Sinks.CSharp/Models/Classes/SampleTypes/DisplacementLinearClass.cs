...
{
	/// <summary>﻿<see cref="SampleEnum.DISPLACEMENT_LINEAR">SampleEnum.DISPLACEMENT_LINEAR</see><br /><br />&gt; Note: The displacement vector <b>MAY</b> be defined by the motion of the owning <see cref="Component">Component</see>.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="DisplacementLinearClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1660362461854_725457_735";
		/// <summary>Constant value for <see cref="DisplacementLinearClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1660362461854_725457_735";
		/// <summary>Constant value for <see cref="DisplacementLinearClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="DisplacementLinearClass.Name" /></summary>
		public const string NAME = "DisplacementLinear";
		/// <summary>Constant value for <see cref="DisplacementLinearClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DisplacementLinearClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DisplacementLinearClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.1";
		/// <summary>Constant value for <see cref="DisplacementLinearClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new DisplacementLinearClassProperties Properties { get; } = new DisplacementLinearClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="DisplacementLinearClass" />.
		...
		public class DisplacementLinearClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DISPLACEMENT_LINEAR";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DisplacementLinearClass" />.
		/// </summary>
