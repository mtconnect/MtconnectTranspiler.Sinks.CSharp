...
{
	/// <summary>﻿<see cref="SampleEnum.FLOW">SampleEnum.FLOW</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218309_653847_1827">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class FlowClass : IClass
	{
		/// <summary>Constant value for <see cref="FlowClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218309_653847_1827";
		/// <summary>Constant value for <see cref="FlowClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218309_653847_1827";
		/// <summary>Constant value for <see cref="FlowClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::FLOW)}}&#10;
";
		/// <summary>Constant value for <see cref="FlowClass.Name" /></summary>
		public const string NAME = "Flow";
		/// <summary>Constant value for <see cref="FlowClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="FlowClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="FlowClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="FlowClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new FlowClassProperties Properties { get; } = new FlowClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="FlowClass" />.
		...
		/// </summary>
		public class FlowClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "LITER/SECOND";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "FLOW";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="FlowClass" />.
		/// </summary>
