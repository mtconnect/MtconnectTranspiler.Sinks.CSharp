...
{
	/// <summary>﻿<see cref="SampleEnum.TENSION">SampleEnum.TENSION</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218452_603125_2208">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class TensionClass : IClass
	{
		/// <summary>Constant value for <see cref="TensionClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218452_603125_2208";
		/// <summary>Constant value for <see cref="TensionClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218452_603125_2208";
		/// <summary>Constant value for <see cref="TensionClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::TENSION)}}&#10;
";
		/// <summary>Constant value for <see cref="TensionClass.Name" /></summary>
		public const string NAME = "Tension";
		/// <summary>Constant value for <see cref="TensionClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="TensionClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="TensionClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="TensionClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new TensionClassProperties Properties { get; } = new TensionClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="TensionClass" />.
		...
		/// </summary>
		public class TensionClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "TENSION";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="TensionClass" />.
		/// </summary>
