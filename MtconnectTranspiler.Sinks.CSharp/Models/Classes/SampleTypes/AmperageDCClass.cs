...
{
	/// <summary>﻿<see cref="SampleEnum.AMPERAGE_DC">SampleEnum.AMPERAGE_DC</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="AmperageDCClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_91b028d_1587732508736_614537_16";
		/// <summary>Constant value for <see cref="AmperageDCClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587732508736_614537_16";
		/// <summary>Constant value for <see cref="AmperageDCClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::AMPERAGE_DC)}}&#10;
";
		/// <summary>Constant value for <see cref="AmperageDCClass.Name" /></summary>
		public const string NAME = "AmperageDC";
		/// <summary>Constant value for <see cref="AmperageDCClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="AmperageDCClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="AmperageDCClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.6";
		/// <summary>Constant value for <see cref="AmperageDCClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new AmperageDCClassProperties Properties { get; } = new AmperageDCClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="AmperageDCClass" />.
		...
		public class AmperageDCClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "AMPERAGE_DC";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="AmperageDCClass" />.
		/// </summary>
