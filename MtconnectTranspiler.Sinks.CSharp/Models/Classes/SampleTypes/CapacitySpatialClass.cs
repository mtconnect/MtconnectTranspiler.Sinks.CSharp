...
{
	/// <summary>
	/// <see cref="SampleEnum::CAPACITY_SPATIAL">SampleEnum::CAPACITY_SPATIAL</see>
	...
	public sealed class CapacitySpatialClass : IClass
	{
		...
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""SampleEnum::CAPACITY_SPATIAL"">SampleEnum::CAPACITY_SPATIAL</see>";
		...
		public class CapacitySpatialClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public sealed class TypeProperty : IProperty
			{
				...
				// Note: DefaultValue.Name
				/// <inheritdoc />
				public string DefaultValue => "CAPACITY_SPATIAL";
			}
		};
