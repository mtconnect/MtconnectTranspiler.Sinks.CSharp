...
{
	/// <summary>﻿<see cref="SampleEnum.PH">SampleEnum.PH</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218397_987893_2043">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	{
		/// <summary>Constant value for <see cref="PHClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218397_987893_2043";
		/// <summary>Constant value for <see cref="PHClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218397_987893_2043";
		/// <summary>Constant value for <see cref="PHClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::PH)}}&#10;
";
		/// <summary>Constant value for <see cref="PHClass.Name" /></summary>
		public const string NAME = "PH";
		/// <summary>Constant value for <see cref="PHClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PHClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PHClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.1";
		/// <summary>Constant value for <see cref="PHClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new PHClassProperties Properties { get; } = new PHClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="PHClass" />.
		...
		/// </summary>
		public class PHClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PH";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PHClass" />.
		/// </summary>
