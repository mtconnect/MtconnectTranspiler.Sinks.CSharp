...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.SampleTypes
{
	...
	{
		/// <summary>Constant value for <see cref="DisplacementAngularClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1660362465264_70518_748";
		/// <summary>Constant value for <see cref="DisplacementAngularClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1660362465264_70518_748";
		/// <summary>Constant value for <see cref="DisplacementAngularClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="DisplacementAngularClass.Name" /></summary>
		public const string NAME = "DisplacementAngular";
		/// <summary>Constant value for <see cref="DisplacementAngularClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DisplacementAngularClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DisplacementAngularClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.1";
		/// <summary>Constant value for <see cref="DisplacementAngularClass.DeprecatedVersion" /></summary>
		...
		public class DisplacementAngularClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DISPLACEMENT_ANGULAR";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DisplacementAngularClass" />.
		/// </summary>
