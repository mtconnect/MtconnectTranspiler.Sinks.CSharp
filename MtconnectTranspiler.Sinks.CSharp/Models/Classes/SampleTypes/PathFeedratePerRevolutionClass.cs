...
{
	/// <summary>﻿<see cref="SampleEnum.PATH_FEEDRATE_PER_REVOLUTION">SampleEnum.PATH_FEEDRATE_PER_REVOLUTION</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="PathFeedratePerRevolutionClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218385_361913_2013";
		/// <summary>Constant value for <see cref="PathFeedratePerRevolutionClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218385_361913_2013";
		/// <summary>Constant value for <see cref="PathFeedratePerRevolutionClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::PATH_FEEDRATE_PER_REVOLUTION)}}&#10;
";
		/// <summary>Constant value for <see cref="PathFeedratePerRevolutionClass.Name" /></summary>
		public const string NAME = "PathFeedratePerRevolution";
		/// <summary>Constant value for <see cref="PathFeedratePerRevolutionClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PathFeedratePerRevolutionClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PathFeedratePerRevolutionClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="PathFeedratePerRevolutionClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new PathFeedratePerRevolutionClassProperties Properties { get; } = new PathFeedratePerRevolutionClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="PathFeedratePerRevolutionClass" />.
		...
		public class PathFeedratePerRevolutionClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "MILLIMETER/REVOLUTION";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PATH_FEEDRATE_PER_REVOLUTION";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PathFeedratePerRevolutionClass" />.
		/// </summary>
