...
{
	/// <summary>﻿<see cref="SampleEnum.Z_DIMENSION">SampleEnum.Z_DIMENSION</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587735921521_446335_1060">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class ZDimensionClass : IClass
	{
		/// <summary>Constant value for <see cref="ZDimensionClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_91b028d_1587735921521_446335_1060";
		/// <summary>Constant value for <see cref="ZDimensionClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587735921521_446335_1060";
		/// <summary>Constant value for <see cref="ZDimensionClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::Z_DIMENSION)}}&#10;
";
		/// <summary>Constant value for <see cref="ZDimensionClass.Name" /></summary>
		public const string NAME = "ZDimension";
		/// <summary>Constant value for <see cref="ZDimensionClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ZDimensionClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ZDimensionClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.6";
		/// <summary>Constant value for <see cref="ZDimensionClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ZDimensionClassProperties Properties { get; } = new ZDimensionClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ZDimensionClass" />.
		...
		/// </summary>
		public class ZDimensionClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "Z_DIMENSION";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ZDimensionClass" />.
		/// </summary>
