...
{
	/// <summary>﻿<see cref="SampleEnum.TORQUE">SampleEnum.TORQUE</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218461_778117_2235">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class TorqueClass : IClass
	{
		/// <summary>Constant value for <see cref="TorqueClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218461_778117_2235";
		/// <summary>Constant value for <see cref="TorqueClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218461_778117_2235";
		/// <summary>Constant value for <see cref="TorqueClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::TORQUE)}}&#10;
";
		/// <summary>Constant value for <see cref="TorqueClass.Name" /></summary>
		public const string NAME = "Torque";
		/// <summary>Constant value for <see cref="TorqueClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="TorqueClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="TorqueClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.0";
		/// <summary>Constant value for <see cref="TorqueClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new TorqueClassProperties Properties { get; } = new TorqueClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="TorqueClass" />.
		...
		/// </summary>
		public class TorqueClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "NEWTON_METER";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "TORQUE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="TorqueClass" />.
		/// </summary>
