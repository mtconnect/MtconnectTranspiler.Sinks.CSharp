...
{
	/// <summary>﻿operator's overridden value.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="AxisFeedrateOverrideClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218197_586088_1578";
		/// <summary>Constant value for <see cref="AxisFeedrateOverrideClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218197_586088_1578";
		/// <summary>Constant value for <see cref="AxisFeedrateOverrideClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;operator's overridden value.&#10;
";
		/// <summary>Constant value for <see cref="AxisFeedrateOverrideClass.Name" /></summary>
		public const string NAME = "AxisFeedrate.Override";
		/// <summary>Constant value for <see cref="AxisFeedrateOverrideClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="AxisFeedrateOverrideClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="AxisFeedrateOverrideClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.0";
		/// <summary>Constant value for <see cref="AxisFeedrateOverrideClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new AxisFeedrateOverrideClassProperties Properties { get; } = new AxisFeedrateOverrideClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="AxisFeedrateOverrideClass" />.
		...
		public class AxisFeedrateOverrideClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.SampleTypes.AxisFeedrateClass.AxisFeedrateClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "OVERRIDE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="AxisFeedrateOverrideClass" />.
		/// </summary>
