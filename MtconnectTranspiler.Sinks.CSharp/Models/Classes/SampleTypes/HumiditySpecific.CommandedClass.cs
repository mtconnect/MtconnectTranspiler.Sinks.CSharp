...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.SampleTypes
{
	...
	public sealed class HumiditySpecificCommandedClass : IClass
	{
		...
		/// <inheritdoc />
		public string Name => "HumiditySpecific.CommandedClass";
		...
		/// <inheritdoc />
		public string Generalization => "_19_0_3_91b028d_1587736930758_553256_1601";

		/// <inheritdoc />
		public HumiditySpecificCommandedClassProperties Properties { get; } = new HumiditySpecificCommandedClassProperties();
        IPropertyList IClass.Properties => Properties;
		public sealed class HumiditySpecificCommandedClassProperties : IPropertyList
		{
			/// <inheritdoc />
