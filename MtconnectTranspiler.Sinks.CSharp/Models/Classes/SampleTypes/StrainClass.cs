...
{
	/// <summary>﻿<see cref="SampleEnum.STRAIN">SampleEnum.STRAIN</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="StrainClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218450_141184_2202";
		/// <summary>Constant value for <see cref="StrainClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218450_141184_2202";
		/// <summary>Constant value for <see cref="StrainClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::STRAIN)}}&#10;
";
		/// <summary>Constant value for <see cref="StrainClass.Name" /></summary>
		public const string NAME = "Strain";
		/// <summary>Constant value for <see cref="StrainClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="StrainClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="StrainClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="StrainClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new StrainClassProperties Properties { get; } = new StrainClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="StrainClass" />.
		...
		/// </summary>
		public class StrainClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "STRAIN";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="StrainClass" />.
		/// </summary>
