...
{
	/// <summary>
	/// <see cref="SampleEnum::ACCELERATION">SampleEnum::ACCELERATION</see>
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580378218114_556156_1503";
		
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""SampleEnum::ACCELERATION"">SampleEnum::ACCELERATION</see>";
		...
		/// <inheritdoc />
		public AccelerationClassProperties Properties { get; } = new AccelerationClassProperties();
		...
		public class AccelerationClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public sealed class TypeProperty : IProperty
			{
				...
				// Note: DefaultValue.Name
				/// <inheritdoc />
				public string DefaultValue => "ACCELERATION";
			}
			/// <summary>
