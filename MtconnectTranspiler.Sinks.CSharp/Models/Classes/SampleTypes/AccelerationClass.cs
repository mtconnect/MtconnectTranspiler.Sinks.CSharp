...
{
	/// <summary>﻿<see cref="SampleEnum.ACCELERATION">SampleEnum.ACCELERATION</see><br /><br /><br />
	...
	public sealed class AccelerationClass : IClass
	{
		/// <summary>Constant value for <see cref="AccelerationClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218114_556156_1503";
		/// <summary>Constant value for <see cref="AccelerationClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218114_556156_1503";
		/// <summary>Constant value for <see cref="AccelerationClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::ACCELERATION)}}&#10;
";
		/// <summary>Constant value for <see cref="AccelerationClass.Name" /></summary>
		public const string NAME = "Acceleration";
		/// <summary>Constant value for <see cref="AccelerationClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="AccelerationClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="AccelerationClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.0";
		/// <summary>Constant value for <see cref="AccelerationClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new AccelerationClassProperties Properties { get; } = new AccelerationClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="AccelerationClass" />.
		...
		/// </summary>
		public class AccelerationClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "ACCELERATION";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="AccelerationClass" />.
		/// </summary>
