...
{
	/// <summary>﻿<see cref="SampleEnum.DEPOSITION_MASS">SampleEnum.DEPOSITION_MASS</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218266_15261_1725">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class DepositionMassClass : IClass
	{
		/// <summary>Constant value for <see cref="DepositionMassClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218266_15261_1725";
		/// <summary>Constant value for <see cref="DepositionMassClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218266_15261_1725";
		/// <summary>Constant value for <see cref="DepositionMassClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::DEPOSITION_MASS)}}&#10;
";
		/// <summary>Constant value for <see cref="DepositionMassClass.Name" /></summary>
		public const string NAME = "DepositionMass";
		/// <summary>Constant value for <see cref="DepositionMassClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DepositionMassClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DepositionMassClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="DepositionMassClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new DepositionMassClassProperties Properties { get; } = new DepositionMassClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="DepositionMassClass" />.
		...
		/// </summary>
		public class DepositionMassClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "MILLIGRAM";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DEPOSITION_MASS";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DepositionMassClass" />.
		/// </summary>
