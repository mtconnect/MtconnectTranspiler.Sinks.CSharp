...
{
	/// <summary>﻿<see cref="SampleEnum.DENSITY">SampleEnum.DENSITY</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218257_564545_1704">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class DensityClass : IClass
	{
		/// <summary>Constant value for <see cref="DensityClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218257_564545_1704";
		/// <summary>Constant value for <see cref="DensityClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218257_564545_1704";
		/// <summary>Constant value for <see cref="DensityClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::DENSITY)}}&#10;
";
		/// <summary>Constant value for <see cref="DensityClass.Name" /></summary>
		public const string NAME = "Density";
		/// <summary>Constant value for <see cref="DensityClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DensityClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DensityClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="DensityClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new DensityClassProperties Properties { get; } = new DensityClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="DensityClass" />.
		...
		/// </summary>
		public class DensityClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DENSITY";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DensityClass" />.
		/// </summary>
