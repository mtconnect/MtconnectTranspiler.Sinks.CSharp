...
{
	/// <summary>﻿<see cref="SampleEnum.VOLTAGE">SampleEnum.VOLTAGE</see><br /><br /><br />
	...
	public sealed class VoltageClass : IClass
	{
		/// <summary>Constant value for <see cref="VoltageClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218469_994902_2259";
		/// <summary>Constant value for <see cref="VoltageClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218469_994902_2259";
		/// <summary>Constant value for <see cref="VoltageClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::VOLTAGE)}}&#10;
";
		/// <summary>Constant value for <see cref="VoltageClass.Name" /></summary>
		public const string NAME = "Voltage";
		/// <summary>Constant value for <see cref="VoltageClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="VoltageClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="VoltageClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.0";
		/// <summary>Constant value for <see cref="VoltageClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new VoltageClassProperties Properties { get; } = new VoltageClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="VoltageClass" />.
		...
		/// </summary>
		public class VoltageClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "VOLTAGE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="VoltageClass" />.
		/// </summary>
