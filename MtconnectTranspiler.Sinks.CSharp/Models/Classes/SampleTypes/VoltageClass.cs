...
{
	/// <summary>
	/// <see cref="SampleEnum::VOLTAGE">SampleEnum::VOLTAGE</see>
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580378218469_994902_2259";
		
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""SampleEnum::VOLTAGE"">SampleEnum::VOLTAGE</see>";
		...
		/// <inheritdoc />
		public VoltageClassProperties Properties { get; } = new VoltageClassProperties();
		...
		public class VoltageClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public sealed class TypeProperty : IProperty
			{
				...
				// Note: DefaultValue.Name
				/// <inheritdoc />
				public string DefaultValue => "VOLTAGE";
			}
		};
