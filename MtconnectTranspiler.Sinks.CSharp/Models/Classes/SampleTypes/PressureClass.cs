...
{
	/// <summary>
	/// <see cref="SampleEnum::PRESSURE">SampleEnum::PRESSURE</see>
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580378218410_510683_2076";
		
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""SampleEnum::PRESSURE"">SampleEnum::PRESSURE</see>";
		...
		public class PressureClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public sealed class TypeProperty : IProperty
			{
				...
				// Note: DefaultValue.Name
				/// <inheritdoc />
				public string DefaultValue => "PRESSURE";
			}
		};
