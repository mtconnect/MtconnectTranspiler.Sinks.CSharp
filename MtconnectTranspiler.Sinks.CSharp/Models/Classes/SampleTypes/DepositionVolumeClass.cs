...
{
	/// <summary>﻿<see cref="SampleEnum.DEPOSITION_VOLUME">SampleEnum.DEPOSITION_VOLUME</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218274_239056_1743">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class DepositionVolumeClass : IClass
	{
		/// <summary>Constant value for <see cref="DepositionVolumeClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218274_239056_1743";
		/// <summary>Constant value for <see cref="DepositionVolumeClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218274_239056_1743";
		/// <summary>Constant value for <see cref="DepositionVolumeClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::DEPOSITION_VOLUME)}}&#10;
";
		/// <summary>Constant value for <see cref="DepositionVolumeClass.Name" /></summary>
		public const string NAME = "DepositionVolume";
		/// <summary>Constant value for <see cref="DepositionVolumeClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DepositionVolumeClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DepositionVolumeClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="DepositionVolumeClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new DepositionVolumeClassProperties Properties { get; } = new DepositionVolumeClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="DepositionVolumeClass" />.
		...
		/// </summary>
		public class DepositionVolumeClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "CUBIC_MILLIMETER";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DEPOSITION_VOLUME";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DepositionVolumeClass" />.
		/// </summary>
