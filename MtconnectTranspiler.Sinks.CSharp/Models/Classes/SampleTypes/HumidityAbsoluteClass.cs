...
{
	/// <summary>﻿<see cref="SampleEnum.HUMIDITY_ABSOLUTE">SampleEnum.HUMIDITY_ABSOLUTE</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="HumidityAbsoluteClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_91b028d_1587736925365_875845_1574";
		/// <summary>Constant value for <see cref="HumidityAbsoluteClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587736925365_875845_1574";
		/// <summary>Constant value for <see cref="HumidityAbsoluteClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::HUMIDITY_ABSOLUTE)}}&#10;
";
		/// <summary>Constant value for <see cref="HumidityAbsoluteClass.Name" /></summary>
		public const string NAME = "HumidityAbsolute";
		/// <summary>Constant value for <see cref="HumidityAbsoluteClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="HumidityAbsoluteClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="HumidityAbsoluteClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.6";
		/// <summary>Constant value for <see cref="HumidityAbsoluteClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new HumidityAbsoluteClassProperties Properties { get; } = new HumidityAbsoluteClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="HumidityAbsoluteClass" />.
		...
		/// </summary>
		public class HumidityAbsoluteClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "GRAM/CUBIC_METER";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "HUMIDITY_ABSOLUTE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="HumidityAbsoluteClass" />.
		/// </summary>
