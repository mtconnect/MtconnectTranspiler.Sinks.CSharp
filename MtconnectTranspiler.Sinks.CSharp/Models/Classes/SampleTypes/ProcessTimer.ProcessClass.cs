...
{
	/// <summary>﻿time from the beginning of production of a part or product on a piece of equipment until the time that production is complete for that part or product on<br />that piece of equipment.<br /><br />This includes the time that the piece of equipment is running, producing parts or products, or in the process of producing parts.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="ProcessTimerProcessClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218418_463201_2094";
		/// <summary>Constant value for <see cref="ProcessTimerProcessClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218418_463201_2094";
		/// <summary>Constant value for <see cref="ProcessTimerProcessClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="ProcessTimerProcessClass.Name" /></summary>
		public const string NAME = "ProcessTimer.Process";
		/// <summary>Constant value for <see cref="ProcessTimerProcessClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ProcessTimerProcessClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ProcessTimerProcessClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="ProcessTimerProcessClass.DeprecatedVersion" /></summary>
		...
		public class ProcessTimerProcessClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.SampleTypes.ProcessTimerClass.ProcessTimerClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PROCESS";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ProcessTimerProcessClass" />.
		/// </summary>
