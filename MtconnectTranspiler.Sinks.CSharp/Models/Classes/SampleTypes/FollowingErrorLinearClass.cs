...
{
	/// <summary>﻿<see cref="SampleEnum.FOLLOWING_ERROR_LINEAR">SampleEnum.FOLLOWING_ERROR_LINEAR</see><br /><br /><br />
	...
	public sealed class FollowingErrorLinearClass : IClass
	{
		/// <summary>Constant value for <see cref="FollowingErrorLinearClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1660329532358_541025_625";
		/// <summary>Constant value for <see cref="FollowingErrorLinearClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1660329532358_541025_625";
		/// <summary>Constant value for <see cref="FollowingErrorLinearClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::FOLLOWING_ERROR_LINEAR)}}&#10;
";
		/// <summary>Constant value for <see cref="FollowingErrorLinearClass.Name" /></summary>
		public const string NAME = "FollowingErrorLinear";
		/// <summary>Constant value for <see cref="FollowingErrorLinearClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="FollowingErrorLinearClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="FollowingErrorLinearClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.1";
		/// <summary>Constant value for <see cref="FollowingErrorLinearClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new FollowingErrorLinearClassProperties Properties { get; } = new FollowingErrorLinearClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="FollowingErrorLinearClass" />.
		...
		/// </summary>
		public class FollowingErrorLinearClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "FOLLOWING_ERROR_LINEAR";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="FollowingErrorLinearClass" />.
		/// </summary>
