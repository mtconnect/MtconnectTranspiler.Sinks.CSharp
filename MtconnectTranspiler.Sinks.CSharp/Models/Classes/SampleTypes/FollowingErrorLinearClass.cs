...
{
	/// <summary>
	/// <see cref="SampleEnum::FOLLOWING_ERROR_LINEAR">SampleEnum::FOLLOWING_ERROR_LINEAR</see>
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_68e0225_1660329532358_541025_625";
		
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""SampleEnum::FOLLOWING_ERROR_LINEAR"">SampleEnum::FOLLOWING_ERROR_LINEAR</see>";

		/// <inheritdoc />
		public string Name => "FollowingErrorLinear";
		...
		/// <inheritdoc />
		public FollowingErrorLinearClassProperties Properties { get; } = new FollowingErrorLinearClassProperties();
		...
		public class FollowingErrorLinearClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public sealed class TypeProperty : IProperty
			{
				...
				// Note: DefaultValue.Name
				/// <inheritdoc />
				public string DefaultValue => "FOLLOWING_ERROR_LINEAR";
			}
		};
