...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.SampleTypes
{
	...
	public sealed class FollowingErrorActualClass : IClass
	{
		...
		/// <inheritdoc />
		public string Name => "FollowingError.ActualClass";
		...
		/// <inheritdoc />
		public string Generalization => "_19_0_3_68e0225_1660329437798_692445_601";

		/// <inheritdoc />
		public FollowingErrorActualClassProperties Properties { get; } = new FollowingErrorActualClassProperties();
        IPropertyList IClass.Properties => Properties;
		public sealed class FollowingErrorActualClassProperties : IPropertyList
		{
			/// <inheritdoc />
