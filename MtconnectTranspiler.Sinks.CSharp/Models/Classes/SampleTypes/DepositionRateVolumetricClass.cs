...
{
	/// <summary>﻿<see cref="SampleEnum.DEPOSITION_RATE_VOLUMETRIC">SampleEnum.DEPOSITION_RATE_VOLUMETRIC</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218270_651166_1734">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class DepositionRateVolumetricClass : IClass
	{
		/// <summary>Constant value for <see cref="DepositionRateVolumetricClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218270_651166_1734";
		/// <summary>Constant value for <see cref="DepositionRateVolumetricClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218270_651166_1734";
		/// <summary>Constant value for <see cref="DepositionRateVolumetricClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::DEPOSITION_RATE_VOLUMETRIC)}}&#10;
";
		/// <summary>Constant value for <see cref="DepositionRateVolumetricClass.Name" /></summary>
		public const string NAME = "DepositionRateVolumetric";
		/// <summary>Constant value for <see cref="DepositionRateVolumetricClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DepositionRateVolumetricClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DepositionRateVolumetricClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="DepositionRateVolumetricClass.DeprecatedVersion" /></summary>
		...
		/// </summary>
		public class DepositionRateVolumetricClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "CUBIC_MILLIMETER/SECOND";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DEPOSITION_RATE_VOLUMETRIC";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DepositionRateVolumetricClass" />.
		/// </summary>
