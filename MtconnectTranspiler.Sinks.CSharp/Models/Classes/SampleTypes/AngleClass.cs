...
{
	/// <summary>
	/// <see cref="SampleEnum::ANGLE">SampleEnum::ANGLE</see>
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580378218165_258018_1533";
		
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""SampleEnum::ANGLE"">SampleEnum::ANGLE</see>";
		...
		public class AngleClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public sealed class TypeProperty : IProperty
			{
				...
				// Note: DefaultValue.Name
				/// <inheritdoc />
				public string DefaultValue => "ANGLE";
			}
		};
