...
{
	/// <summary>﻿<see cref="SampleEnum.DECELERATION">SampleEnum.DECELERATION</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605642679847_825017_142">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class DecelerationClass : IClass
	{
		/// <summary>Constant value for <see cref="DecelerationClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1605642679847_825017_142";
		/// <summary>Constant value for <see cref="DecelerationClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605642679847_825017_142";
		/// <summary>Constant value for <see cref="DecelerationClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::DECELERATION)}}&#10;
";
		/// <summary>Constant value for <see cref="DecelerationClass.Name" /></summary>
		public const string NAME = "Deceleration";
		/// <summary>Constant value for <see cref="DecelerationClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DecelerationClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DecelerationClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.7";
		/// <summary>Constant value for <see cref="DecelerationClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new DecelerationClassProperties Properties { get; } = new DecelerationClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="DecelerationClass" />.
		...
		/// </summary>
		public class DecelerationClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "MILLIMETER/SECOND^2";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DECELERATION";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DecelerationClass" />.
		/// </summary>
