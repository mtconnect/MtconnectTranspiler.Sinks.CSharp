...
{
	/// <summary>﻿<see cref="SampleEnum.PATH_FEEDRATE">SampleEnum.PATH_FEEDRATE</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218374_970818_1980">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class PathFeedrateClass : IClass
	{
		/// <summary>Constant value for <see cref="PathFeedrateClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218374_970818_1980";
		/// <summary>Constant value for <see cref="PathFeedrateClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218374_970818_1980";
		/// <summary>Constant value for <see cref="PathFeedrateClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::PATH_FEEDRATE)}}&#10;
";
		/// <summary>Constant value for <see cref="PathFeedrateClass.Name" /></summary>
		public const string NAME = "PathFeedrate";
		/// <summary>Constant value for <see cref="PathFeedrateClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PathFeedrateClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PathFeedrateClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.0";
		/// <summary>Constant value for <see cref="PathFeedrateClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new PathFeedrateClassProperties Properties { get; } = new PathFeedrateClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="PathFeedrateClass" />.
		...
		/// </summary>
		public class PathFeedrateClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "MILLIMETER/SECOND";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PATH_FEEDRATE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PathFeedrateClass" />.
		/// </summary>
