...
{
	/// <summary>﻿<see cref="SampleEnum.ANGULAR_ACCELERATION">SampleEnum.ANGULAR_ACCELERATION</see><br /><br /><br />
	...
	public sealed class AngularAccelerationClass : IClass
	{
		/// <summary>Constant value for <see cref="AngularAccelerationClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218171_690924_1542";
		/// <summary>Constant value for <see cref="AngularAccelerationClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218171_690924_1542";
		/// <summary>Constant value for <see cref="AngularAccelerationClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::ANGULAR_ACCELERATION)}}&#10;
";
		/// <summary>Constant value for <see cref="AngularAccelerationClass.Name" /></summary>
		public const string NAME = "AngularAcceleration";
		/// <summary>Constant value for <see cref="AngularAccelerationClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="AngularAccelerationClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="AngularAccelerationClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.0";
		/// <summary>Constant value for <see cref="AngularAccelerationClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new AngularAccelerationClassProperties Properties { get; } = new AngularAccelerationClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="AngularAccelerationClass" />.
		...
		/// </summary>
		public class AngularAccelerationClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "ANGULAR_ACCELERATION";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="AngularAccelerationClass" />.
		/// </summary>
