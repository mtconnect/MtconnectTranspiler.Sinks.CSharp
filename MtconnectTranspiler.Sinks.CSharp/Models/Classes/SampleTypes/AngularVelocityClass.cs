...
{
	/// <summary>﻿<see cref="SampleEnum.ANGULAR_VELOCITY">SampleEnum.ANGULAR_VELOCITY</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218174_350188_1545">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class AngularVelocityClass : IClass
	{
		/// <summary>Constant value for <see cref="AngularVelocityClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218174_350188_1545";
		/// <summary>Constant value for <see cref="AngularVelocityClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218174_350188_1545";
		/// <summary>Constant value for <see cref="AngularVelocityClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::ANGULAR_VELOCITY)}}&#10;
";
		/// <summary>Constant value for <see cref="AngularVelocityClass.Name" /></summary>
		public const string NAME = "AngularVelocity";
		/// <summary>Constant value for <see cref="AngularVelocityClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="AngularVelocityClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="AngularVelocityClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.0";
		/// <summary>Constant value for <see cref="AngularVelocityClass.DeprecatedVersion" /></summary>
		...
		/// </summary>
		public class AngularVelocityClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DEGREE/SECOND";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "ANGULAR_VELOCITY";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="AngularVelocityClass" />.
		/// </summary>
