...
{
	/// <summary>﻿<see cref="SampleEnum.EQUIPMENT_TIMER">SampleEnum.EQUIPMENT_TIMER</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="EquipmentTimerClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218298_41713_1803";
		/// <summary>Constant value for <see cref="EquipmentTimerClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218298_41713_1803";
		/// <summary>Constant value for <see cref="EquipmentTimerClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::EQUIPMENT_TIMER)}}&#10;
";
		/// <summary>Constant value for <see cref="EquipmentTimerClass.Name" /></summary>
		public const string NAME = "EquipmentTimer";
		/// <summary>Constant value for <see cref="EquipmentTimerClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="EquipmentTimerClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="EquipmentTimerClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="EquipmentTimerClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new EquipmentTimerClassProperties Properties { get; } = new EquipmentTimerClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="EquipmentTimerClass" />.
		...
		/// </summary>
		public class EquipmentTimerClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "EQUIPMENT_TIMER";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="EquipmentTimerClass" />.
		/// </summary>
