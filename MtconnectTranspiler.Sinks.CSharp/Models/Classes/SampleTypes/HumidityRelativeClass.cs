...
{
	/// <summary>﻿<see cref="SampleEnum.HUMIDITY_RELATIVE">SampleEnum.HUMIDITY_RELATIVE</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587736744120_539399_1413">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class HumidityRelativeClass : IClass
	{
		/// <summary>Constant value for <see cref="HumidityRelativeClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_91b028d_1587736744120_539399_1413";
		/// <summary>Constant value for <see cref="HumidityRelativeClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587736744120_539399_1413";
		/// <summary>Constant value for <see cref="HumidityRelativeClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::HUMIDITY_RELATIVE)}}&#10;
";
		/// <summary>Constant value for <see cref="HumidityRelativeClass.Name" /></summary>
		public const string NAME = "HumidityRelative";
		/// <summary>Constant value for <see cref="HumidityRelativeClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="HumidityRelativeClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="HumidityRelativeClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.6";
		/// <summary>Constant value for <see cref="HumidityRelativeClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new HumidityRelativeClassProperties Properties { get; } = new HumidityRelativeClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="HumidityRelativeClass" />.
		...
		/// </summary>
		public class HumidityRelativeClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PERCENT";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "HUMIDITY_RELATIVE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="HumidityRelativeClass" />.
		/// </summary>
