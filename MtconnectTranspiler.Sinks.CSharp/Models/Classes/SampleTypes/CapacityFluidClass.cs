...
{
	/// <summary>﻿<see cref="SampleEnum.CAPACITY_FLUID">SampleEnum.CAPACITY_FLUID</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218209_919961_1605">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class CapacityFluidClass : IClass
	{
		/// <summary>Constant value for <see cref="CapacityFluidClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218209_919961_1605";
		/// <summary>Constant value for <see cref="CapacityFluidClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218209_919961_1605";
		/// <summary>Constant value for <see cref="CapacityFluidClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::CAPACITY_FLUID)}}&#10;
";
		/// <summary>Constant value for <see cref="CapacityFluidClass.Name" /></summary>
		public const string NAME = "CapacityFluid";
		/// <summary>Constant value for <see cref="CapacityFluidClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="CapacityFluidClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="CapacityFluidClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="CapacityFluidClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new CapacityFluidClassProperties Properties { get; } = new CapacityFluidClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="CapacityFluidClass" />.
		...
		/// </summary>
		public class CapacityFluidClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "MILLILITER";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "CAPACITY_FLUID";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="CapacityFluidClass" />.
		/// </summary>
