...
{
	/// <summary>﻿<see cref="SampleEnum.VOLUME_FLUID">SampleEnum.VOLUME_FLUID</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218478_384104_2280">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class VolumeFluidClass : IClass
	{
		/// <summary>Constant value for <see cref="VolumeFluidClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218478_384104_2280";
		/// <summary>Constant value for <see cref="VolumeFluidClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218478_384104_2280";
		/// <summary>Constant value for <see cref="VolumeFluidClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::VOLUME_FLUID)}}&#10;
";
		/// <summary>Constant value for <see cref="VolumeFluidClass.Name" /></summary>
		public const string NAME = "VolumeFluid";
		/// <summary>Constant value for <see cref="VolumeFluidClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="VolumeFluidClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="VolumeFluidClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="VolumeFluidClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new VolumeFluidClassProperties Properties { get; } = new VolumeFluidClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="VolumeFluidClass" />.
		...
		/// </summary>
		public class VolumeFluidClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "VOLUME_FLUID";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="VolumeFluidClass" />.
		/// </summary>
