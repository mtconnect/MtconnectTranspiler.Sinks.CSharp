...
{
	/// <summary>﻿<see cref="SampleEnum.PROCESS_TIMER">SampleEnum.PROCESS_TIMER</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218416_705945_2091">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class ProcessTimerClass : IClass
	{
		/// <summary>Constant value for <see cref="ProcessTimerClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218416_705945_2091";
		/// <summary>Constant value for <see cref="ProcessTimerClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218416_705945_2091";
		/// <summary>Constant value for <see cref="ProcessTimerClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::PROCESS_TIMER)}}&#10;
";
		/// <summary>Constant value for <see cref="ProcessTimerClass.Name" /></summary>
		public const string NAME = "ProcessTimer";
		/// <summary>Constant value for <see cref="ProcessTimerClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ProcessTimerClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ProcessTimerClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="ProcessTimerClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ProcessTimerClassProperties Properties { get; } = new ProcessTimerClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ProcessTimerClass" />.
		...
		/// </summary>
		public class ProcessTimerClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "SECOND";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PROCESS_TIMER";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ProcessTimerClass" />.
		/// </summary>
