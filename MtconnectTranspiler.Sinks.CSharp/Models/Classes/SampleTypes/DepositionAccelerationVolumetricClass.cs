...
{
	/// <summary>﻿<see cref="SampleEnum.DEPOSITION_ACCELERATION_VOLUMETRIC">SampleEnum.DEPOSITION_ACCELERATION_VOLUMETRIC</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218258_380747_1707">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class DepositionAccelerationVolumetricClass : IClass
	{
		/// <summary>Constant value for <see cref="DepositionAccelerationVolumetricClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218258_380747_1707";
		/// <summary>Constant value for <see cref="DepositionAccelerationVolumetricClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218258_380747_1707";
		/// <summary>Constant value for <see cref="DepositionAccelerationVolumetricClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::DEPOSITION_ACCELERATION_VOLUMETRIC)}}&#10;
";
		/// <summary>Constant value for <see cref="DepositionAccelerationVolumetricClass.Name" /></summary>
		public const string NAME = "DepositionAccelerationVolumetric";
		/// <summary>Constant value for <see cref="DepositionAccelerationVolumetricClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DepositionAccelerationVolumetricClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DepositionAccelerationVolumetricClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="DepositionAccelerationVolumetricClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new DepositionAccelerationVolumetricClassProperties Properties { get; } = new DepositionAccelerationVolumetricClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="DepositionAccelerationVolumetricClass" />.
		...
		/// </summary>
		public class DepositionAccelerationVolumetricClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "CUBIC_MILLIMETER/SECOND^2";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DEPOSITION_ACCELERATION_VOLUMETRIC";
