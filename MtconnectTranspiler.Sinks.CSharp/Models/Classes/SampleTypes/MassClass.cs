...
{
	/// <summary>﻿<see cref="SampleEnum.MASS">SampleEnum.MASS</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218343_830417_1905">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class MassClass : IClass
	{
		/// <summary>Constant value for <see cref="MassClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218343_830417_1905";
		/// <summary>Constant value for <see cref="MassClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218343_830417_1905";
		/// <summary>Constant value for <see cref="MassClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::MASS)}}&#10;
";
		/// <summary>Constant value for <see cref="MassClass.Name" /></summary>
		public const string NAME = "Mass";
		/// <summary>Constant value for <see cref="MassClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="MassClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="MassClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="MassClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new MassClassProperties Properties { get; } = new MassClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="MassClass" />.
		...
		/// </summary>
		public class MassClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "KILOGRAM";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "MASS";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="MassClass" />.
		/// </summary>
