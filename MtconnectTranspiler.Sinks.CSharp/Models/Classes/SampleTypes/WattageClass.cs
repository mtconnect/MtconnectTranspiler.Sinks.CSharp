...
{
	/// <summary>
	/// <see cref="SampleEnum::WATTAGE">SampleEnum::WATTAGE</see>
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580378218484_57384_2301";
		
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""SampleEnum::WATTAGE"">SampleEnum::WATTAGE</see>";
		...
		/// <inheritdoc />
		public WattageClassProperties Properties { get; } = new WattageClassProperties();
		...
		public class WattageClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			...
			public sealed class UnitsProperty : IProperty
			{
				...
				/// <inheritdoc />
				public string DefaultValue => "WATT";
			}
			/// <summary>
			...
			public sealed class TypeProperty : IProperty
			{
				...
				// Note: DefaultValue.Name
				/// <inheritdoc />
				public string DefaultValue => "WATTAGE";
			}
		};
