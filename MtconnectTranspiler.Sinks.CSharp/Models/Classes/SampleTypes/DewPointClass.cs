...
{
	/// <summary>﻿<see cref="SampleEnum.DEW_POINT">SampleEnum.DEW_POINT</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_68e0225_1659032383380_200012_108">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class DewPointClass : IClass
	{
		/// <summary>Constant value for <see cref="DewPointClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1659032383380_200012_108";
		/// <summary>Constant value for <see cref="DewPointClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1659032383380_200012_108";
		/// <summary>Constant value for <see cref="DewPointClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::DEW_POINT)}}&#10;
";
		/// <summary>Constant value for <see cref="DewPointClass.Name" /></summary>
		public const string NAME = "DewPoint";
		/// <summary>Constant value for <see cref="DewPointClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DewPointClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DewPointClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.1";
		/// <summary>Constant value for <see cref="DewPointClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new DewPointClassProperties Properties { get; } = new DewPointClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="DewPointClass" />.
		...
		/// </summary>
		public class DewPointClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class UnitsProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "CELSIUS";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DEW_POINT";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DewPointClass" />.
		/// </summary>
