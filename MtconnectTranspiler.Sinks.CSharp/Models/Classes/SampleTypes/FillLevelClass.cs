...
{
	/// <summary>﻿<see cref="SampleEnum.FILL_LEVEL">SampleEnum.FILL_LEVEL</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218308_747718_1824">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class FillLevelClass : IClass
	{
		/// <summary>Constant value for <see cref="FillLevelClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218308_747718_1824";
		/// <summary>Constant value for <see cref="FillLevelClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218308_747718_1824";
		/// <summary>Constant value for <see cref="FillLevelClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(SampleEnum::FILL_LEVEL)}}&#10;
";
		/// <summary>Constant value for <see cref="FillLevelClass.Name" /></summary>
		public const string NAME = "FillLevel";
		/// <summary>Constant value for <see cref="FillLevelClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="FillLevelClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="FillLevelClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="FillLevelClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new FillLevelClassProperties Properties { get; } = new FillLevelClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="FillLevelClass" />.
		...
		/// </summary>
		public class FillLevelClassProperties : Mtconnect.ObservationInformationModel.SampleClass.SampleClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "FILL_LEVEL";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="FillLevelClass" />.
		/// </summary>
