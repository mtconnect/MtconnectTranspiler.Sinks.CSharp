...
{
	/// <summary>﻿measurement of DC current or voltage.<br /><br /><b>DEPRECATED</b> in <i>Version 1.6</i>.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="AmperageDirectClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218154_24803_1524";
		/// <summary>Constant value for <see cref="AmperageDirectClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218154_24803_1524";
		/// <summary>Constant value for <see cref="AmperageDirectClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;measurement of DC current or voltage.

**DEPRECATED** in *Version 1.6*.&#10;
";
		/// <summary>Constant value for <see cref="AmperageDirectClass.Name" /></summary>
		public const string NAME = "Amperage.Direct";
		/// <summary>Constant value for <see cref="AmperageDirectClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="AmperageDirectClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="AmperageDirectClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="AmperageDirectClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new AmperageDirectClassProperties Properties { get; } = new AmperageDirectClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="AmperageDirectClass" />.
		...
		public class AmperageDirectClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.SampleTypes.AmperageClass.AmperageClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DIRECT";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="AmperageDirectClass" />.
		/// </summary>
