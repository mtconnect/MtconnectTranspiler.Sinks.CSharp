...
namespace Mtconnect.ObservationInformationModel.Representations.Table
{
	/// <summary>﻿<i>key-value pair</i> published as part of a <see cref="Table">Table</see>.<br /><br /><br /><br /><br />
...
";
			...
			public sealed class ResultPartProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="ResultPartProperty.Multiplicity" /></summary>
				...
				/// </summary>
				public System.Type Type => typeof(Mtconnect.ObservationInformationModel.Representations.Table.CellClass);
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="EntryClass" />.
		/// </summary>
