...
{
	/// <summary>﻿rotations about X, Y, and Z axes are expressed in A, B, and C respectively within a 3-dimensional vector represented as a dataset.<br /><br /><br /><br />
...
";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="RotationDataSetGeneralization" />.
		/// </summary>
