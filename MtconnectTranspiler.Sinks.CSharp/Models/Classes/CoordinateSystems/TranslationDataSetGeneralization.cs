...
{
	/// <summary>﻿translations along X, Y, and Z axes are expressed as x,y, and z respectively within a 3-dimensional vector represented as a dataset.<br /><br /><br />
...
";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="TranslationDataSetGeneralization" />.
		/// </summary>
