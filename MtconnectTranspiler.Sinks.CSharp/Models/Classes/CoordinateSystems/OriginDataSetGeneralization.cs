...
{
	/// <summary>﻿coordinates of the origin position of a coordinate system represented as a dataset.<br /><br /><br />
...
";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="OriginDataSetGeneralization" />.
		/// </summary>
