...
";
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="FirmwareVersionProperty.Multiplicity" /></summary>
...
";
			...
			public sealed class HasChannelPartProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="HasChannelPartProperty.Multiplicity" /></summary>
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="SensorConfigurationClass" />.
		/// </summary>
