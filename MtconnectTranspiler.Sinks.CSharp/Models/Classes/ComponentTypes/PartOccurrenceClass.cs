...
";
		...
		public class PartOccurrenceClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentTypes.PartClass.PartClassProperties
		{
			...
			public new sealed class ObservesPartIdProperty : IProperty
			{
				...
				/// <summary>Constant value for <see cref="ObservesPartIdProperty.Multiplicity" /></summary>
			...
			public new sealed class ObservesPartGroupIdProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="ObservesPartGroupIdProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "0..1";
			...
			public new sealed class ObservesPartKindIdProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="ObservesPartKindIdProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "0..1";
			...
			public new sealed class ObservesPartStatusProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="ObservesPartStatusProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "0..1";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PartOccurrenceClass" />.
		/// </summary>
