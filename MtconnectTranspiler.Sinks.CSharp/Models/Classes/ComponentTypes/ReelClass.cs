...
{
	/// <summary>
	/// leaf <see cref="Component">Component</see> composed of a rotary storage unit for material.
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580312106474_29298_44447";
		
		/// <inheritdoc />
		public string Summary => @"/// leaf <see cref=""Component"">Component</see> composed of a rotary storage unit for material.";
		...
		/// <inheritdoc />
		public ReelClassProperties Properties { get; } = new ReelClassProperties();
