...
";
		...
		public class ControllerClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentTypes.SystemClass.SystemClassProperties
		{
			...
			public new sealed class HasPathPartProperty : IProperty
			{
				...
				/// <summary>Constant value for <see cref="HasPathPartProperty.Multiplicity" /></summary>
			...
			public new sealed class IsControllerOfPartProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="IsControllerOfPartProperty.Multiplicity" /></summary>
			...
			public new sealed class ObservesEmergencyStopProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="ObservesEmergencyStopProperty.Multiplicity" /></summary>
			...
			public new sealed class ObservesSystemConditionProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="ObservesSystemConditionProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "0..1";
			...
			public new sealed class ObservesControllerModeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="ObservesControllerModeProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "0..1";
			...
			public new sealed class ObservesCommunicationsConditionProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="ObservesCommunicationsConditionProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "0..1";
			...
			public new sealed class ObservesLogicProgramConditionProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="ObservesLogicProgramConditionProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "0..1";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ControllerClass" />.
		/// </summary>
