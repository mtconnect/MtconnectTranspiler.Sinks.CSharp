...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> that physically moves a tool from one location to another.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="TransferArmClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1605552257830_675148_2688";
		/// <summary>Constant value for <see cref="TransferArmClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605552257830_675148_2688";
		/// <summary>Constant value for <see cref="TransferArmClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;leaf {{block(Component)}} that physically moves a tool from one location to another.&#10;
";
		/// <summary>Constant value for <see cref="TransferArmClass.Name" /></summary>
		public const string NAME = "TransferArm";
		/// <summary>Constant value for <see cref="TransferArmClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="TransferArmClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="TransferArmClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.7";
		/// <summary>Constant value for <see cref="TransferArmClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new TransferArmClassProperties Properties { get; } = new TransferArmClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="TransferArmClass" />.
		...
		/// </summary>
		public class TransferArmClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentGeneralization.ComponentGeneralizationProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="TransferArmClass" />.
		/// </summary>
