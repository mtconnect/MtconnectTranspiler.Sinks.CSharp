...
{
	/// <summary>
	/// leaf <see cref="Component">Component</see> that raises, drives, exhausts, or compresses fluids or gases by means of a piston, plunger, or set of rotating vanes.
	/// </summary>
	...
	public sealed class PumpClass : IClass
	{
		...
		/// <inheritdoc />
		public string Summary => @"/// leaf <see cref=""Component"">Component</see> that raises, drives, exhausts, or compresses fluids or gases by means of a piston, plunger, or set of rotating vanes.";

		/// <inheritdoc />
		public string Name => "PumpClass";
		...
		public sealed class PumpClassProperties : IPropertyList
		{
			/// <inheritdoc />
