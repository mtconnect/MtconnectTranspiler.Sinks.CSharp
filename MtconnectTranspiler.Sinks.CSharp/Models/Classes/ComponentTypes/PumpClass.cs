...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> that raises, drives, exhausts, or compresses fluids or gases by means of a piston, plunger, or set of rotating vanes.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="PumpClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580312106473_448314_44444";
		/// <summary>Constant value for <see cref="PumpClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106473_448314_44444";
		/// <summary>Constant value for <see cref="PumpClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="PumpClass.Name" /></summary>
		public const string NAME = "Pump";
		/// <summary>Constant value for <see cref="PumpClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PumpClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PumpClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="PumpClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new PumpClassProperties Properties { get; } = new PumpClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="PumpClass" />.
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PumpClass" />.
		/// </summary>
