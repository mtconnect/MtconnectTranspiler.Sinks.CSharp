...
{
	/// <summary>
	/// leaf <see cref="Component">Component</see> that converts electrical, pneumatic, or hydraulic energy into mechanical energy.
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580312106471_971269_44432";
		
		/// <inheritdoc />
		public string Summary => @"/// leaf <see cref=""Component"">Component</see> that converts electrical, pneumatic, or hydraulic energy into mechanical energy.";
		...
		/// <inheritdoc />
		public MotorClassProperties Properties { get; } = new MotorClassProperties();
