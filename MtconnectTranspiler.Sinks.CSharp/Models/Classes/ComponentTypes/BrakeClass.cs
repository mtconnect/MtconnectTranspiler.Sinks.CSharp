...
namespace Mtconnect.DeviceInformationModel.Components.ComponentTypes
{
	...
	public sealed class BrakeClass : IClass
	{
		...
		/// <inheritdoc />
		public string Summary => @"/// leaf <see cref=""Component"">Component</see> that slows or stops a moving object by the absorption or transfer of the energy of momentum, usually by means of friction, electrical force, or magnetic force.";
