...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> that slows or stops a moving object by the absorption or transfer of the energy of momentum, usually by means of friction, electrical force, or magnetic force.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106461_720908_44375">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class BrakeClass : IClass
	{
		/// <summary>Constant value for <see cref="BrakeClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580312106461_720908_44375";
		/// <summary>Constant value for <see cref="BrakeClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106461_720908_44375";
		/// <summary>Constant value for <see cref="BrakeClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="BrakeClass.Name" /></summary>
		public const string NAME = "Brake";
		/// <summary>Constant value for <see cref="BrakeClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="BrakeClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="BrakeClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="BrakeClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new BrakeClassProperties Properties { get; } = new BrakeClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="BrakeClass" />.
		...
		/// </summary>
		public class BrakeClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentGeneralization.ComponentGeneralizationProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="BrakeClass" />.
		/// </summary>
