...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> that allows material to flow for the purpose of drainage from, for example, a vessel or tank.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106466_143410_44402">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class DrainClass : IClass
	{
		/// <summary>Constant value for <see cref="DrainClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580312106466_143410_44402";
		/// <summary>Constant value for <see cref="DrainClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106466_143410_44402";
		/// <summary>Constant value for <see cref="DrainClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;leaf {{block(Component)}} that allows material to flow for the purpose of drainage from, for example, a vessel or tank.&#10;
";
		/// <summary>Constant value for <see cref="DrainClass.Name" /></summary>
		public const string NAME = "Drain";
		/// <summary>Constant value for <see cref="DrainClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DrainClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DrainClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="DrainClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new DrainClassProperties Properties { get; } = new DrainClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="DrainClass" />.
		...
		/// </summary>
		public class DrainClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentGeneralization.ComponentGeneralizationProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DrainClass" />.
		/// </summary>
