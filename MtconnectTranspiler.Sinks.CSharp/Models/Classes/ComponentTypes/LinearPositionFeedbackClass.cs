...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> that measures linear motion or position.<br /><br /><b>DEPRECATION WARNING</b> : May be deprecated in the future. Recommend using <see cref="Encoder">Encoder</see>.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="LinearPositionFeedbackClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580312106471_40319_44429";
		/// <summary>Constant value for <see cref="LinearPositionFeedbackClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106471_40319_44429";
		/// <summary>Constant value for <see cref="LinearPositionFeedbackClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="LinearPositionFeedbackClass.Name" /></summary>
		public const string NAME = "LinearPositionFeedback";
		/// <summary>Constant value for <see cref="LinearPositionFeedbackClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="LinearPositionFeedbackClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="LinearPositionFeedbackClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="LinearPositionFeedbackClass.DeprecatedVersion" /></summary>
