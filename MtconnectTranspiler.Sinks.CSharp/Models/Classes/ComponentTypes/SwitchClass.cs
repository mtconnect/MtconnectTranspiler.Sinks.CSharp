...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> that turns on or off an electric current or makes or breaks a circuit.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106476_558459_44459">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class SwitchClass : IClass
	{
		/// <summary>Constant value for <see cref="SwitchClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580312106476_558459_44459";
		/// <summary>Constant value for <see cref="SwitchClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106476_558459_44459";
		/// <summary>Constant value for <see cref="SwitchClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;leaf {{block(Component)}} that turns on or off an electric current or makes or breaks a circuit.&#10;
";
		/// <summary>Constant value for <see cref="SwitchClass.Name" /></summary>
		public const string NAME = "Switch";
		/// <summary>Constant value for <see cref="SwitchClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="SwitchClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="SwitchClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="SwitchClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new SwitchClassProperties Properties { get; } = new SwitchClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="SwitchClass" />.
		...
		/// </summary>
		public class SwitchClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentGeneralization.ComponentGeneralizationProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="SwitchClass" />.
		/// </summary>
