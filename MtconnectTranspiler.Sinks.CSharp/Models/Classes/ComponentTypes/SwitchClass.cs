...
{
	/// <summary>
	/// leaf <see cref="Component">Component</see> that turns on or off an electric current or makes or breaks a circuit.
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580312106476_558459_44459";
		
		/// <inheritdoc />
		public string Summary => @"/// leaf <see cref=""Component"">Component</see> that turns on or off an electric current or makes or breaks a circuit.";
		...
		/// <inheritdoc />
		public SwitchClassProperties Properties { get; } = new SwitchClassProperties();
