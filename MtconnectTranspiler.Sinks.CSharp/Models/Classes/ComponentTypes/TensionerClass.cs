...
{
	/// <summary>
	/// leaf <see cref="Component">Component</see> that provides or applies a stretch or strain to another mechanism.
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580312106477_119326_44468";
		
		/// <inheritdoc />
		public string Summary => @"/// leaf <see cref=""Component"">Component</see> that provides or applies a stretch or strain to another mechanism.";
		...
		/// <inheritdoc />
		public TensionerClassProperties Properties { get; } = new TensionerClassProperties();
