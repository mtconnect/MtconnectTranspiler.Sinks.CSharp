...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> that is a <see cref="Pot">Pot</see> for a tool that is no longer usable for removal from a <see cref="ToolMagazine">ToolMagazine</see> or <see cref="Turret">Turret</see>.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="ExpiredPotClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1605552258379_348093_2712";
		/// <summary>Constant value for <see cref="ExpiredPotClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605552258379_348093_2712";
		/// <summary>Constant value for <see cref="ExpiredPotClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="ExpiredPotClass.Name" /></summary>
		public const string NAME = "ExpiredPot";
		/// <summary>Constant value for <see cref="ExpiredPotClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ExpiredPotClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ExpiredPotClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.7";
		/// <summary>Constant value for <see cref="ExpiredPotClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ExpiredPotClassProperties Properties { get; } = new ExpiredPotClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ExpiredPotClass" />.
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ExpiredPotClass" />.
		/// </summary>
