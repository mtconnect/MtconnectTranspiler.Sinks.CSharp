...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> that transforms electric energy from a source to a secondary circuit.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106478_840214_44471">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class TransformerClass : IClass
	{
		/// <summary>Constant value for <see cref="TransformerClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580312106478_840214_44471";
		/// <summary>Constant value for <see cref="TransformerClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106478_840214_44471";
		/// <summary>Constant value for <see cref="TransformerClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;leaf {{block(Component)}} that transforms electric energy from a source to a secondary circuit.&#10;
";
		/// <summary>Constant value for <see cref="TransformerClass.Name" /></summary>
		public const string NAME = "Transformer";
		/// <summary>Constant value for <see cref="TransformerClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="TransformerClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="TransformerClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="TransformerClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new TransformerClassProperties Properties { get; } = new TransformerClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="TransformerClass" />.
		...
		/// </summary>
		public class TransformerClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentGeneralization.ComponentGeneralizationProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="TransformerClass" />.
		/// </summary>
