...
{
	/// <summary>
	/// leaf <see cref="Component">Component</see> that transforms electric energy from a source to a secondary circuit.
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580312106478_840214_44471";
		
		/// <inheritdoc />
		public string Summary => @"/// leaf <see cref=""Component"">Component</see> that transforms electric energy from a source to a secondary circuit.";
		...
		/// <inheritdoc />
		public TransformerClassProperties Properties { get; } = new TransformerClassProperties();
