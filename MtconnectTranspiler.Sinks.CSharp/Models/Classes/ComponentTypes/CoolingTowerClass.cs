...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> composed of a heat exchange system that uses a fluid to transfer heat to the atmosphere.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="CoolingTowerClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1605117477013_561048_2109";
		/// <summary>Constant value for <see cref="CoolingTowerClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605117477013_561048_2109";
		/// <summary>Constant value for <see cref="CoolingTowerClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;leaf {{block(Component)}} composed of a heat exchange system that uses a fluid to transfer heat to the atmosphere.&#10;
";
		/// <summary>Constant value for <see cref="CoolingTowerClass.Name" /></summary>
		public const string NAME = "CoolingTower";
		/// <summary>Constant value for <see cref="CoolingTowerClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="CoolingTowerClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="CoolingTowerClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.7";
		/// <summary>Constant value for <see cref="CoolingTowerClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new CoolingTowerClassProperties Properties { get; } = new CoolingTowerClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="CoolingTowerClass" />.
		...
		/// </summary>
		public class CoolingTowerClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentGeneralization.ComponentGeneralizationProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="CoolingTowerClass" />.
		/// </summary>
