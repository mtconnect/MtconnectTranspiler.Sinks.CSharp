...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> composed of an electromechanical actuator that produces deflection of a beam of light or energy in response to electric current through its coil in a magnetic field.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106469_237105_44420">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class GalvanomotorClass : IClass
	{
		/// <summary>Constant value for <see cref="GalvanomotorClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580312106469_237105_44420";
		/// <summary>Constant value for <see cref="GalvanomotorClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106469_237105_44420";
		/// <summary>Constant value for <see cref="GalvanomotorClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="GalvanomotorClass.Name" /></summary>
		public const string NAME = "Galvanomotor";
		/// <summary>Constant value for <see cref="GalvanomotorClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="GalvanomotorClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="GalvanomotorClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="GalvanomotorClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new GalvanomotorClassProperties Properties { get; } = new GalvanomotorClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="GalvanomotorClass" />.
		...
		/// </summary>
		public class GalvanomotorClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentGeneralization.ComponentGeneralizationProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="GalvanomotorClass" />.
		/// </summary>
