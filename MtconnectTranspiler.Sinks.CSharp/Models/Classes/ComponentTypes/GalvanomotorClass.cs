...
namespace Mtconnect.DeviceInformationModel.Components.ComponentTypes
{
	...
	public sealed class GalvanomotorClass : IClass
	{
		...
		/// <inheritdoc />
		public string Summary => @"/// leaf <see cref=""Component"">Component</see> composed of an electromechanical actuator that produces deflection of a beam of light or energy in response to electric current through its coil in a magnetic field.";
