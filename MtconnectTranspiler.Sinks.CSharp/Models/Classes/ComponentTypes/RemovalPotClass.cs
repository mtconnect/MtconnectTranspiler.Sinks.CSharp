...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> that is a <see cref="Pot">Pot</see> for a tool that has to be removed from a <see cref="ToolMagazine">ToolMagazine</see> or <see cref="Turret">Turret</see> to a location outside of the piece of equipment.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605552258019_616231_2696">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	{
		/// <summary>Constant value for <see cref="RemovalPotClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1605552258019_616231_2696";
		/// <summary>Constant value for <see cref="RemovalPotClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605552258019_616231_2696";
		/// <summary>Constant value for <see cref="RemovalPotClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="RemovalPotClass.Name" /></summary>
		public const string NAME = "RemovalPot";
		/// <summary>Constant value for <see cref="RemovalPotClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="RemovalPotClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="RemovalPotClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.7";
		/// <summary>Constant value for <see cref="RemovalPotClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new RemovalPotClassProperties Properties { get; } = new RemovalPotClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="RemovalPotClass" />.
		...
		/// </summary>
		public class RemovalPotClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentGeneralization.ComponentGeneralizationProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="RemovalPotClass" />.
		/// </summary>
