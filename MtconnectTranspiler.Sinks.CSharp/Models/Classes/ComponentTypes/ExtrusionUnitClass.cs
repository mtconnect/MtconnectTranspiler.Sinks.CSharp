...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> that dispenses liquid or powered materials.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106467_401181_44411">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class ExtrusionUnitClass : IClass
	{
		/// <summary>Constant value for <see cref="ExtrusionUnitClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580312106467_401181_44411";
		/// <summary>Constant value for <see cref="ExtrusionUnitClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106467_401181_44411";
		/// <summary>Constant value for <see cref="ExtrusionUnitClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;leaf {{block(Component)}} that dispenses liquid or powered materials.&#10;
";
		/// <summary>Constant value for <see cref="ExtrusionUnitClass.Name" /></summary>
		public const string NAME = "ExtrusionUnit";
		/// <summary>Constant value for <see cref="ExtrusionUnitClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ExtrusionUnitClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ExtrusionUnitClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="ExtrusionUnitClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ExtrusionUnitClassProperties Properties { get; } = new ExtrusionUnitClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ExtrusionUnitClass" />.
		...
		/// </summary>
		public class ExtrusionUnitClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentGeneralization.ComponentGeneralizationProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ExtrusionUnitClass" />.
		/// </summary>
