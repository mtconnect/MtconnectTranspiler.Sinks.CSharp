...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> that interrupts an electric circuit.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106464_188160_44390">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class CircuitBreakerClass : IClass
	{
		/// <summary>Constant value for <see cref="CircuitBreakerClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580312106464_188160_44390";
		/// <summary>Constant value for <see cref="CircuitBreakerClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106464_188160_44390";
		/// <summary>Constant value for <see cref="CircuitBreakerClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;leaf {{block(Component)}} that interrupts an electric circuit.&#10;
";
		/// <summary>Constant value for <see cref="CircuitBreakerClass.Name" /></summary>
		public const string NAME = "CircuitBreaker";
		/// <summary>Constant value for <see cref="CircuitBreakerClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="CircuitBreakerClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="CircuitBreakerClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="CircuitBreakerClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new CircuitBreakerClassProperties Properties { get; } = new CircuitBreakerClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="CircuitBreakerClass" />.
		...
		/// </summary>
		public class CircuitBreakerClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentGeneralization.ComponentGeneralizationProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="CircuitBreakerClass" />.
		/// </summary>
