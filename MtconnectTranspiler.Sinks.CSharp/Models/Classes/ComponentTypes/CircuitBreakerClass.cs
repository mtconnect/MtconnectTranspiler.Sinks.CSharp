...
{
	/// <summary>
	/// leaf <see cref="Component">Component</see> that interrupts an electric circuit.
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580312106464_188160_44390";
		
		/// <inheritdoc />
		public string Summary => @"/// leaf <see cref=""Component"">Component</see> that interrupts an electric circuit.";
		...
		/// <inheritdoc />
		public CircuitBreakerClassProperties Properties { get; } = new CircuitBreakerClassProperties();
