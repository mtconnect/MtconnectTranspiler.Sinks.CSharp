...
{
	/// <summary>
	﻿/// leaf <see cref="Component">Component</see> composed of an endless flexible band that transmits motion for a piece of equipment or conveys materials and objects.<br/><br />
