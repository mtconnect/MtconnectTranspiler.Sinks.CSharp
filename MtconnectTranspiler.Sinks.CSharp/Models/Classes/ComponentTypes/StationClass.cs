...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> composed of a storage or mounting location for a tool associated with a <see cref="Turret">Turret</see>, <see cref="GangToolBar">GangToolBar</see>, or <see cref="ToolRack">ToolRack</see>.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="StationClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1605552257415_810787_2672";
		/// <summary>Constant value for <see cref="StationClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605552257415_810787_2672";
		/// <summary>Constant value for <see cref="StationClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="StationClass.Name" /></summary>
		public const string NAME = "Station";
		/// <summary>Constant value for <see cref="StationClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="StationClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="StationClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.7";
		/// <summary>Constant value for <see cref="StationClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new StationClassProperties Properties { get; } = new StationClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="StationClass" />.
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="StationClass" />.
		/// </summary>
