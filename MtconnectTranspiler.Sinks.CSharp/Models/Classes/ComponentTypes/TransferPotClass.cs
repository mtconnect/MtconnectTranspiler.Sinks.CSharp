...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> that is a <see cref="Pot">Pot</see> for a tool that is awaiting transfer from a <see cref="ToolMagazine">ToolMagazine</see> to <i>spindle</i> or <see cref="Turret">Turret</see>.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="TransferPotClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1605552258190_552410_2704";
		/// <summary>Constant value for <see cref="TransferPotClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605552258190_552410_2704";
		/// <summary>Constant value for <see cref="TransferPotClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="TransferPotClass.Name" /></summary>
		public const string NAME = "TransferPot";
		/// <summary>Constant value for <see cref="TransferPotClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="TransferPotClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="TransferPotClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.7";
		/// <summary>Constant value for <see cref="TransferPotClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new TransferPotClassProperties Properties { get; } = new TransferPotClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="TransferPotClass" />.
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="TransferPotClass" />.
		/// </summary>
