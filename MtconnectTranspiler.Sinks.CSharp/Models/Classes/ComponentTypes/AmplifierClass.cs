...
namespace Mtconnect.DeviceInformationModel.Components.ComponentTypes
{
	...
	public sealed class AmplifierClass : IClass
	{
		...
		/// <inheritdoc />
		public string Summary => @"/// leaf <see cref=""Component"">Component</see> composed of an electronic component or circuit that amplifies power, electric current, or voltage.";

		/// <inheritdoc />
		public string Name => "AmplifierClass";
		...
		/// <inheritdoc />
		public AmplifierClassProperties Properties { get; } = new AmplifierClassProperties();
        IPropertyList IClass.Properties => Properties;
		public sealed class AmplifierClassProperties : IPropertyList
		{
			/// <inheritdoc />
