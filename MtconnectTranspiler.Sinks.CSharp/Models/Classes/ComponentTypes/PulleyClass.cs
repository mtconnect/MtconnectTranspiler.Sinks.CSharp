...
{
	/// <summary>
	/// leaf <see cref="Component">Component</see> composed of a mechanism or wheel that turns in a frame or block and serves to change the direction of or to transmit force.
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580312106473_162844_44441";
		
		/// <inheritdoc />
		public string Summary => @"/// leaf <see cref=""Component"">Component</see> composed of a mechanism or wheel that turns in a frame or block and serves to change the direction of or to transmit force.";
		...
		/// <inheritdoc />
		public PulleyClassProperties Properties { get; } = new PulleyClassProperties();
