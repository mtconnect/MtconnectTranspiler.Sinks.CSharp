...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> composed of a mechanism or wheel that turns in a frame or block and serves to change the direction of or to transmit force.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106473_162844_44441">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class PulleyClass : IClass
	{
		/// <summary>Constant value for <see cref="PulleyClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580312106473_162844_44441";
		/// <summary>Constant value for <see cref="PulleyClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106473_162844_44441";
		/// <summary>Constant value for <see cref="PulleyClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="PulleyClass.Name" /></summary>
		public const string NAME = "Pulley";
		/// <summary>Constant value for <see cref="PulleyClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PulleyClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PulleyClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="PulleyClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new PulleyClassProperties Properties { get; } = new PulleyClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="PulleyClass" />.
		...
		/// </summary>
		public class PulleyClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentGeneralization.ComponentGeneralizationProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PulleyClass" />.
		/// </summary>
