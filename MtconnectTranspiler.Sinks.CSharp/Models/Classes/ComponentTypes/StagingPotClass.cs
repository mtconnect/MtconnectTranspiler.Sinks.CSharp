...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> that is a <see cref="Pot">Pot</see> for a tool that is awaiting transfer to a <see cref="ToolMagazine">ToolMagazine</see> or <see cref="Turret">Turret</see> from outside of the piece of equipment.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605552257626_405215_2680">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class StagingPotClass : IClass
	{
		/// <summary>Constant value for <see cref="StagingPotClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1605552257626_405215_2680";
		/// <summary>Constant value for <see cref="StagingPotClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605552257626_405215_2680";
		/// <summary>Constant value for <see cref="StagingPotClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="StagingPotClass.Name" /></summary>
		public const string NAME = "StagingPot";
		/// <summary>Constant value for <see cref="StagingPotClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="StagingPotClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="StagingPotClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.7";
		/// <summary>Constant value for <see cref="StagingPotClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new StagingPotClassProperties Properties { get; } = new StagingPotClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="StagingPotClass" />.
		...
		/// </summary>
		public class StagingPotClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentGeneralization.ComponentGeneralizationProperties
		{
			/// <inheritdoc />
			...
			public new sealed class HasCompositionProperty : IProperty
			{
				...
				/// <summary>Constant value for <see cref="HasCompositionProperty.Multiplicity" /></summary>
			...
			public new sealed class HasComponentProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="HasComponentProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "0..*";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="StagingPotClass" />.
		/// </summary>
