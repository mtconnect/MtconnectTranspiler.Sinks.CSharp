...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> composed of interconnected series of objects that band together and are used to transmit motion for a piece of equipment or to convey materials and objects.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106462_246830_44378">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class ChainClass : IClass
	{
		/// <summary>Constant value for <see cref="ChainClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580312106462_246830_44378";
		/// <summary>Constant value for <see cref="ChainClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106462_246830_44378";
		/// <summary>Constant value for <see cref="ChainClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="ChainClass.Name" /></summary>
		public const string NAME = "Chain";
		/// <summary>Constant value for <see cref="ChainClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ChainClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ChainClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="ChainClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ChainClassProperties Properties { get; } = new ChainClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ChainClass" />.
		...
		/// </summary>
		public class ChainClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentGeneralization.ComponentGeneralizationProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ChainClass" />.
		/// </summary>
