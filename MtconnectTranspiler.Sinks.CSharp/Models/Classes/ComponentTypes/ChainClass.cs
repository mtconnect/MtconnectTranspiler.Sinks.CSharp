...
{
	/// <summary>
	﻿/// leaf <see cref="Component">Component</see> composed of interconnected series of objects that band together and are used to transmit motion for a piece of equipment or to convey materials and objects.<br/><br />
