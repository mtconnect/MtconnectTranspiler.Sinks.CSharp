...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> composed of a pump or other mechanism that reduces volume and increases pressure of gases in order to condense the gases to drive pneumatically powered pieces of equipment.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106465_576708_44396">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	{
		/// <summary>Constant value for <see cref="CompressorClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580312106465_576708_44396";
		/// <summary>Constant value for <see cref="CompressorClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106465_576708_44396";
		/// <summary>Constant value for <see cref="CompressorClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="CompressorClass.Name" /></summary>
		public const string NAME = "Compressor";
		/// <summary>Constant value for <see cref="CompressorClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="CompressorClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="CompressorClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="CompressorClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new CompressorClassProperties Properties { get; } = new CompressorClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="CompressorClass" />.
		...
		/// </summary>
		public class CompressorClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentGeneralization.ComponentGeneralizationProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="CompressorClass" />.
		/// </summary>
