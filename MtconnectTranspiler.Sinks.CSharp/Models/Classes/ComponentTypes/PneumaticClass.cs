...
namespace Mtconnect.DeviceInformationModel.Components.ComponentTypes
{
	...
	{
		/// <summary>Constant value for <see cref="PneumaticClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1579572382008_658658_42273";
		/// <summary>Constant value for <see cref="PneumaticClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1579572382008_658658_42273";
		/// <summary>Constant value for <see cref="PneumaticClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="PneumaticClass.Name" /></summary>
		public const string NAME = "Pneumatic";
		/// <summary>Constant value for <see cref="PneumaticClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PneumaticClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PneumaticClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.1";
		/// <summary>Constant value for <see cref="PneumaticClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new PneumaticClassProperties Properties { get; } = new PneumaticClassProperties();
		...
		public class PneumaticClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentTypes.ActuatorClass.ActuatorClassProperties
		{
			...
			public new sealed class ObservesPressureProperty : IProperty
			{
				...
				/// <summary>Constant value for <see cref="ObservesPressureProperty.Multiplicity" /></summary>
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PneumaticClass" />.
		/// </summary>
