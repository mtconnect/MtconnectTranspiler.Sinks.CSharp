...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> composed of a string like piece or filament of relatively rigid or flexible material provided in a variety of diameters.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="WireClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580312106480_27284_44483";
		/// <summary>Constant value for <see cref="WireClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106480_27284_44483";
		/// <summary>Constant value for <see cref="WireClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="WireClass.Name" /></summary>
		public const string NAME = "Wire";
		/// <summary>Constant value for <see cref="WireClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="WireClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="WireClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="WireClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new WireClassProperties Properties { get; } = new WireClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="WireClass" />.
		...
		/// </summary>
		public class WireClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentGeneralization.ComponentGeneralizationProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="WireClass" />.
		/// </summary>
