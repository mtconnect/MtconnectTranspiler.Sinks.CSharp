...
{
	/// <summary>
	/// leaf <see cref="Component">Component</see> composed of a container that holds liquid or powdered materials.
	/// </summary>
	[GeneratedCode("MtconnectTranspiler.Sinks.CSharp", "2.3.0.0")]
	public sealed class VatClass : IClass
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580312106479_944360_44477";
		
		/// <inheritdoc />
		public string Summary => @"/// leaf <see cref=""Component"">Component</see> composed of a container that holds liquid or powdered materials.";

		/// <inheritdoc />
		public string Name => "VatClass";
		...
		/// <inheritdoc />
		public VatClassProperties Properties { get; } = new VatClassProperties();
        IPropertyList IClass.Properties => Properties;
		public sealed class VatClassProperties : IPropertyList
		{
			/// <inheritdoc />
