...
{
	/// <summary>
	/// leaf <see cref="Component">Component</see> that breaks material into smaller pieces.
	/// </summary>
	...
	public sealed class ChopperClass : IClass
	{
		...
		/// <inheritdoc />
		public string Summary => @"/// leaf <see cref=""Component"">Component</see> that breaks material into smaller pieces.";

		/// <inheritdoc />
		public string Name => "ChopperClass";
		...
		public sealed class ChopperClassProperties : IPropertyList
		{
			/// <inheritdoc />
