...
";
		...
		public class StockClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentTypes.MaterialClass.MaterialClassProperties
		{
			...
			public new sealed class ObservesMaterialProperty : IProperty
			{
				...
				/// <summary>Constant value for <see cref="ObservesMaterialProperty.Multiplicity" /></summary>
			...
			public new sealed class ObservesLengthRemainingProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="ObservesLengthRemainingProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "0..1";
			...
			public new sealed class ObservesLengthStandardProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="ObservesLengthStandardProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "0..1";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="StockClass" />.
		/// </summary>
