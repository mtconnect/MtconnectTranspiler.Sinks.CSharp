...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> composed of a chamber or bin in which materials are stored temporarily, typically being filled through the top and dispensed through the bottom.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="HopperClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580312106470_968785_44426";
		/// <summary>Constant value for <see cref="HopperClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106470_968785_44426";
		/// <summary>Constant value for <see cref="HopperClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="HopperClass.Name" /></summary>
		public const string NAME = "Hopper";
		/// <summary>Constant value for <see cref="HopperClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="HopperClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="HopperClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="HopperClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new HopperClassProperties Properties { get; } = new HopperClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="HopperClass" />.
		...
		/// </summary>
		public class HopperClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentGeneralization.ComponentGeneralizationProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="HopperClass" />.
		/// </summary>
