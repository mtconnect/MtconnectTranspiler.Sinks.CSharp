...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> composed of a tool storage location associated with a <see cref="ToolMagazine">ToolMagazine</see> or <see cref="AutomaticToolChanger">AutomaticToolChanger</see>.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605552256946_709565_2656">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class PotClass : IClass
	{
		/// <summary>Constant value for <see cref="PotClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1605552256946_709565_2656";
		/// <summary>Constant value for <see cref="PotClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605552256946_709565_2656";
		/// <summary>Constant value for <see cref="PotClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="PotClass.Name" /></summary>
		public const string NAME = "Pot";
		/// <summary>Constant value for <see cref="PotClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PotClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PotClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.7";
		/// <summary>Constant value for <see cref="PotClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new PotClassProperties Properties { get; } = new PotClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="PotClass" />.
		...
		/// </summary>
		public class PotClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentGeneralization.ComponentGeneralizationProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PotClass" />.
		/// </summary>
