...
{
	/// <summary>
	/// leaf <see cref="Component">Component</see> composed of a tool storage location associated with a <see cref="ToolMagazine">ToolMagazine</see> or <see cref="AutomaticToolChanger">AutomaticToolChanger</see>.
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_68e0225_1605552256946_709565_2656";
		
		/// <inheritdoc />
		public string Summary => @"/// leaf <see cref=""Component"">Component</see> composed of a tool storage location associated with a <see cref=""ToolMagazine"">ToolMagazine</see> or <see cref=""AutomaticToolChanger"">AutomaticToolChanger</see>.";
		...
		/// <inheritdoc />
		public PotClassProperties Properties { get; } = new PotClassProperties();
