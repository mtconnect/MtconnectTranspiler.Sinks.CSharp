...
{
	/// <summary>
	﻿/// leaf <see cref="Component">Component</see> composed of one or more cells in which chemical energy is converted into electricity and used as a source of power. <br/><br />
