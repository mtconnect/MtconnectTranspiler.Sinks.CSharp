...
{
	/// <summary>﻿leaf <see cref="Component">Component</see> composed of one or more cells in which chemical energy is converted into electricity and used as a source of power. <br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106475_664974_44456">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class StorageBatteryClass : IClass
	{
		/// <summary>Constant value for <see cref="StorageBatteryClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580312106475_664974_44456";
		/// <summary>Constant value for <see cref="StorageBatteryClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580312106475_664974_44456";
		/// <summary>Constant value for <see cref="StorageBatteryClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="StorageBatteryClass.Name" /></summary>
		public const string NAME = "StorageBattery";
		/// <summary>Constant value for <see cref="StorageBatteryClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="StorageBatteryClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="StorageBatteryClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="StorageBatteryClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new StorageBatteryClassProperties Properties { get; } = new StorageBatteryClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="StorageBatteryClass" />.
		...
		/// </summary>
		public class StorageBatteryClassProperties : Mtconnect.DeviceInformationModel.Components.ComponentGeneralization.ComponentGeneralizationProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="StorageBatteryClass" />.
		/// </summary>
