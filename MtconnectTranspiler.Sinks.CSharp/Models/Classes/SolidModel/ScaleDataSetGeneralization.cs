...
{
	/// <summary>﻿either a single multiplier applied to all three dimensions or a three space multiplier given in the X, Y, and Z dimensions in the coordinate system used for the <see cref="SolidModel">SolidModel</see> represented as a dataset.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___2024x_68e0225_1727807698383_716499_23819">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class ScaleDataSetGeneralization : IClass
	{
		...
		public const string REFERENCE_ID = "_2024x_68e0225_1727807698383_716499_23819";
		/// <summary>Constant value for <see cref="ScaleDataSetGeneralization.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___2024x_68e0225_1727807698383_716499_23819";
		/// <summary>Constant value for <see cref="ScaleDataSetGeneralization.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;either a single multiplier applied to all three dimensions or a three space multiplier given in the X, Y, and Z dimensions in the coordinate system used for the {{block(SolidModel)}} represented as a dataset.&#10;
";
		/// <summary>Constant value for <see cref="ScaleDataSetGeneralization.Name" /></summary>
		public const string NAME = "ScaleDataSet";
		/// <summary>Constant value for <see cref="ScaleDataSetGeneralization.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ScaleDataSetGeneralization.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ScaleDataSetGeneralization.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.5";
		/// <summary>Constant value for <see cref="ScaleDataSetGeneralization.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ScaleDataSetGeneralizationProperties Properties { get; } = new ScaleDataSetGeneralizationProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ScaleDataSetGeneralization" />.
		...
		/// </summary>
		public class ScaleDataSetGeneralizationProperties : Mtconnect.ObservationInformationModel.Representations.DataSetClass.DataSetClassProperties
		{
			/// <inheritdoc />
			...
			/// <summary>﻿multiplier for X axis.<br /><br /><br />
			/// </summary>
...
";
			...
			/// <summary>﻿multiplier for Y axis.<br /><br /><br />
			/// </summary>
...
";
			...
			/// <summary>﻿multiplier for Z axis.<br /><br /><br />
			/// </summary>
...
";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ScaleDataSetGeneralization" />.
		/// </summary>
