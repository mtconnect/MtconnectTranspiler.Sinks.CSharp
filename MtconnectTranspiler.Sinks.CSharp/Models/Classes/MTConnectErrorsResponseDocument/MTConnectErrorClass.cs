...
";
		...
		public class MTConnectErrorClassProperties : IPropertyList
		{
			...
			public sealed class HasErrorPartProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="HasErrorPartProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "1..*";
			...
			public sealed class ErrorPartProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="ErrorPartProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "1";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="MTConnectErrorClass" />.
		/// </summary>
