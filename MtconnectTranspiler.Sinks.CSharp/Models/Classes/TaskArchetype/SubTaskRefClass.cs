...
namespace Mtconnect.AssetInformationModel.Task.TaskArchetype
{
	...
	public sealed class SubTaskRefClass : IClass
	{
		...
		public const string REFERENCE_ID = "_2024x_68e0225_1759816184988_138247_660";
		/// <summary>Constant value for <see cref="SubTaskRefClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___2024x_68e0225_1759816184988_138247_660";
		...
		public class SubTaskRefClassProperties : IPropertyList
		{
			...
			/// <summary>﻿indication signifying that subtasks can be executed simultaneously<br /><br /><br />
			/// </summary>
...
";
			...
			/// <summary>﻿identifier to a set of subtasks organized to be treated collectively within the parent task<br /><br /><br />
			/// </summary>
...
";
			...
			/// <summary>﻿position of a subtask within an explicit arrangement where one subtask follows another<br /><br /><br />
			/// </summary>
...
";
			...
			/// <summary>﻿indicates if a subtask is discretionary and not mandatory<br /><br /><br />
			/// </summary>
...
";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="SubTaskRefClass" />.
		/// </summary>
