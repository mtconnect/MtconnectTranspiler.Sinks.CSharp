...
{
	/// <summary>﻿
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_4_45f01b9_1673982139230_860585_299">model.mtconnect.org</seealso> for more information.
	/// </summary>
	
	[GeneratedCode("MtconnectTranspiler.Sinks.CSharp", "2.8.0.0")]
	public sealed class Entity_Data_Class : IClass
	{
		/// <summary>Constant value for <see cref="Entity_Data_Class.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_4_45f01b9_1673982139230_860585_299";
		/// <summary>Constant value for <see cref="Entity_Data_Class.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_4_45f01b9_1673982139230_860585_299";
		/// <summary>Constant value for <see cref="Entity_Data_Class.Summary" /></summary>
		public const string SUMMARY = @"";
		/// <summary>Constant value for <see cref="Entity_Data_Class.Name" /></summary>
		public const string NAME = "Entity{Data}";
		/// <summary>Constant value for <see cref="Entity_Data_Class.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="Entity_Data_Class.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="Entity_Data_Class.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "";
		/// <summary>Constant value for <see cref="Entity_Data_Class.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new Entity_Data_ClassProperties Properties { get; } = new Entity_Data_ClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="Entity_Data_Class" />.
		...
		/// </summary>
		public class Entity_Data_ClassProperties : Mtconnect.ReferenceAgentArchitecture.Pipelines.EntityClass.EntityClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class NameProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "Data";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="Entity_Data_Class" />.
		/// </summary>
