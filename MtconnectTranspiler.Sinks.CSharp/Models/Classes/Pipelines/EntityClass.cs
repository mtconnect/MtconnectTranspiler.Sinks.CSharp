...
namespace Mtconnect.ReferenceAgentArchitecture.Pipelines
{
	...
	{
		/// <summary>Constant value for <see cref="EntityClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_4_45f01b9_1673982182900_756304_302";
		/// <summary>Constant value for <see cref="EntityClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_4_45f01b9_1673982182900_756304_302";
		/// <summary>Constant value for <see cref="EntityClass.Summary" /></summary>
		public const string SUMMARY = @"";
		/// <summary>Constant value for <see cref="EntityClass.Name" /></summary>
		public const string NAME = "Entity";
		/// <summary>Constant value for <see cref="EntityClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="EntityClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="EntityClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "";
		/// <summary>Constant value for <see cref="EntityClass.DeprecatedVersion" /></summary>
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="EntityClass" />.
		/// </summary>
