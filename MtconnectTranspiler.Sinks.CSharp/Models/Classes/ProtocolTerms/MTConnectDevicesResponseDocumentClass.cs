...
namespace Mtconnect.Glossary.ProtocolTerms
{
	...
	{
		/// <summary>Constant value for <see cref="MTConnectDevicesResponseDocumentClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1623664375174_150349_2044";
		/// <summary>Constant value for <see cref="MTConnectDevicesResponseDocumentClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1623664375174_150349_2044";
		/// <summary>Constant value for <see cref="MTConnectDevicesResponseDocumentClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{term(response document)}} published by an {{term(MTConnect Agent)}} in response to a {{term(probe request)}}.&#10;
";
		/// <summary>Constant value for <see cref="MTConnectDevicesResponseDocumentClass.Name" /></summary>
		public const string NAME = "MTConnectDevices Response Document";
		/// <summary>Constant value for <see cref="MTConnectDevicesResponseDocumentClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="MTConnectDevicesResponseDocumentClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="MTConnectDevicesResponseDocumentClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "";
		/// <summary>Constant value for <see cref="MTConnectDevicesResponseDocumentClass.DeprecatedVersion" /></summary>
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="MTConnectDevicesResponseDocumentClass" />.
		/// </summary>
