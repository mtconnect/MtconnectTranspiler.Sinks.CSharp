...
{
	/// <summary>
	/// <i>request</i> for information issued from a <i>client</i> to an <i>MTConnect Agent</i>.
	...
	public sealed class MTConnectRequestGeneralization : IClass
	{
		...
		/// <inheritdoc />
		public string Summary => @"/// <i>request</i> for information issued from a <i>client</i> to an <i>MTConnect Agent</i>.";
