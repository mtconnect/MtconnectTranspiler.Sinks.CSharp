...
namespace Mtconnect.Glossary.MTConnectTerms.AdditionalObservationTerms
{
	...
	{
		/// <summary>Constant value for <see cref="ObservedFaultClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1581814889992_601120_5456";
		/// <summary>Constant value for <see cref="ObservedFaultClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1581814889992_601120_5456";
		/// <summary>Constant value for <see cref="ObservedFaultClass.Summary" /></summary>
		public const string SUMMARY = @"";
		/// <summary>Constant value for <see cref="ObservedFaultClass.Name" /></summary>
		public const string NAME = "Observed Fault";
		/// <summary>Constant value for <see cref="ObservedFaultClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ObservedFaultClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ObservedFaultClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "";
		/// <summary>Constant value for <see cref="ObservedFaultClass.DeprecatedVersion" /></summary>
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ObservedFaultClass" />.
		/// </summary>
