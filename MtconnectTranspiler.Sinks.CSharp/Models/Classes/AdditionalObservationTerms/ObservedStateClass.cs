...
namespace Mtconnect.Glossary.MTConnectTerms.AdditionalObservationTerms
{
	...
	{
		/// <summary>Constant value for <see cref="ObservedStateClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1581814797181_38604_5344";
		/// <summary>Constant value for <see cref="ObservedStateClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1581814797181_38604_5344";
		/// <summary>Constant value for <see cref="ObservedStateClass.Summary" /></summary>
		public const string SUMMARY = @"";
		/// <summary>Constant value for <see cref="ObservedStateClass.Name" /></summary>
		public const string NAME = "Observed State";
		/// <summary>Constant value for <see cref="ObservedStateClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ObservedStateClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ObservedStateClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "";
		/// <summary>Constant value for <see cref="ObservedStateClass.DeprecatedVersion" /></summary>
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ObservedStateClass" />.
		/// </summary>
