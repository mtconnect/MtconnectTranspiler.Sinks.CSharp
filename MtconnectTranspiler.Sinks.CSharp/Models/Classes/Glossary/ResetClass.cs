...
{
	/// <summary>
	﻿/// act of reverting back the accumulated value or statistic to their initial value.<br /><br />> Note: An <i>Observation</i> with a <i>data set</i> representation removes all <i>key-value pair</i>s, setting the <i>data set</i> to an empty set.<br /><br /><br/><br />
