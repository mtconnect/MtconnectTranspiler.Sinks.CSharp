...
namespace Mtconnect.ReferenceAgentArchitecture.InformationModel
{
	...
	public sealed class TextValueClass : IClass
	{
		...
		/// </summary>
		public class TextValueClassProperties : Mtconnect.ReferenceAgentArchitecture.InformationModel.ObservationValueClass.ObservationValueClassProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="TextValueClass" />.
		/// </summary>
