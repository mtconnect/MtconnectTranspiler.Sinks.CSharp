...
{
	/// <summary>﻿
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1585536734789_253067_2898">model.mtconnect.org</seealso> for more information.
	/// </summary>
	
	[GeneratedCode("MtconnectTranspiler.Sinks.CSharp", "2.8.0.0")]
	public sealed class ContitionClass : IClass
	{
		/// <summary>Constant value for <see cref="ContitionClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1585536734789_253067_2898";
		/// <summary>Constant value for <see cref="ContitionClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1585536734789_253067_2898";
		/// <summary>Constant value for <see cref="ContitionClass.Summary" /></summary>
		public const string SUMMARY = @"";
		/// <summary>Constant value for <see cref="ContitionClass.Name" /></summary>
		public const string NAME = "Contition";
		/// <summary>Constant value for <see cref="ContitionClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ContitionClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ContitionClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "";
		/// <summary>Constant value for <see cref="ContitionClass.DeprecatedVersion" /></summary>
		...
		/// </summary>
		public class ContitionClassProperties : Mtconnect.ReferenceAgentArchitecture.InformationModel.ObservationClass.ObservationClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class HasValueProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: ConditionValueClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.ReferenceAgentArchitecture.InformationModel.ConditionValueClass);
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ContitionClass" />.
		/// </summary>
