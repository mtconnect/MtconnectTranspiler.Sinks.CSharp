...
namespace Mtconnect.AssetInformationModel.Pallet.Measurements
{
	...
	public sealed class LoadedSwingClass : IClass
	{
		/// <summary>Constant value for <see cref="LoadedSwingClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_2024x_68e0225_1727796007725_733990_24860";
...
";
		...
		/// <summary>Constant value for <see cref="LoadedSwingClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="LoadedSwingClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="LoadedSwingClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.5";
		/// <summary>Constant value for <see cref="LoadedSwingClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new LoadedSwingClassProperties Properties { get; } = new LoadedSwingClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="LoadedSwingClass" />.
		...
		/// </summary>
		public class LoadedSwingClassProperties : Mtconnect.AssetInformationModel.Pallet.Measurements.MeasurementClass.MeasurementClassProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="LoadedSwingClass" />.
		/// </summary>
