...
namespace Mtconnect.AssetInformationModel.Pallet.Measurements
{
	...
	public sealed class LoadedWidthClass : IClass
	{
		/// <summary>Constant value for <see cref="LoadedWidthClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_2024x_68e0225_1727795992160_973071_24790";
...
";
		...
		/// <summary>Constant value for <see cref="LoadedWidthClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="LoadedWidthClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="LoadedWidthClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.5";
		/// <summary>Constant value for <see cref="LoadedWidthClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new LoadedWidthClassProperties Properties { get; } = new LoadedWidthClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="LoadedWidthClass" />.
		...
		/// </summary>
		public class LoadedWidthClassProperties : Mtconnect.AssetInformationModel.Pallet.Measurements.MeasurementClass.MeasurementClassProperties
		{
			/// <inheritdoc />
