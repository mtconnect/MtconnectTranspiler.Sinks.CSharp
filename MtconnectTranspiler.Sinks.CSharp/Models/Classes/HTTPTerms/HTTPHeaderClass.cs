...
{
	/// <summary>
	﻿/// header of either an <i>HTTP Request</i> from a <i>client</i> or an <i>HTTP Response</i> from an <i>agent</i>. <seealso href="https://www.google.com/search?q=IETF:RFC-2616&btnI=I">IETF:RFC-2616</seealso><br/><br />
