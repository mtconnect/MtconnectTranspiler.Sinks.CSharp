...
";
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="ToolIdProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "1";
			...
			public new sealed class HasCuttingToolLifeCyclePartProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="HasCuttingToolLifeCyclePartProperty.Multiplicity" /></summary>
			...
			public new sealed class HasCuttingToolArchetypeReferencePartProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="HasCuttingToolArchetypeReferencePartProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "0..1";
...
";
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="HasCuttingToolDefinitionPartProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "0..1";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="CuttingToolClass" />.
		/// </summary>
