...
{
	/// <summary>
	﻿/// association between two pieces of equipment that function independently but together perform a manufacturing operation.<br/><br />Description<br/><see cref="ConfigurationRelationship">ConfigurationRelationship</see> is an abstract entity and hence will be realized by specific <see cref="ConfigurationRelationship">ConfigurationRelationship</see> types in an <see cref="MTConnectDevices">MTConnectDevices</see> entity. See <see cref="ComponentRelationship">ComponentRelationship</see> and <see cref="DeviceRelationship">DeviceRelationship</see>.<br/><br/><br />
...
";
		...
		public class ConfigurationRelationshipClassProperties : IPropertyList
		{
			...
			/// <summary>
			﻿/// name associated with this <see cref="ConfigurationRelationship">ConfigurationRelationship</see>.<br/><br />
...
";
			...
			/// <summary>
			﻿/// unique identifier for this <see cref="ConfigurationRelationship">ConfigurationRelationship</see>.<br/><br />
...
";
			...
			/// <summary>
			﻿/// defines the authority that this piece of equipment has relative to the associated piece of equipment.<br/><br />
...
";
			...
			/// <summary>
			﻿/// defines whether the services or functions provided by the associated piece of equipment is required for the operation of this piece of equipment.<br/><br />
