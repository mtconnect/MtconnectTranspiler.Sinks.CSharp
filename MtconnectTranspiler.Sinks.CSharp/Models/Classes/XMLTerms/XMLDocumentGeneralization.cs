...
";
		...
		public class XMLDocumentGeneralizationProperties : Mtconnect.Glossary.DocumentClass.DocumentClassProperties
		{
			...
			public new sealed class HasDocumentHeaderProperty : IProperty
			{
				...
				/// <summary>Constant value for <see cref="HasDocumentHeaderProperty.Multiplicity" /></summary>
			...
			public new sealed class HasDocumentBodyProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="HasDocumentBodyProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "0..1";
			...
			public new sealed class HasNamespaceProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="HasNamespaceProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "0..1";
			...
			public new sealed class HasXmlSchemaProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "";
				/// <summary>Constant value for <see cref="HasXmlSchemaProperty.Multiplicity" /></summary>
				public const string MULTIPLICITY = "0..1";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="XMLDocumentGeneralization" />.
		/// </summary>
