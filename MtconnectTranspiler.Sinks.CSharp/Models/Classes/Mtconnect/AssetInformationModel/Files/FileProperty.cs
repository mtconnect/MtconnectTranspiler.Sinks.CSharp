...
namespace Mtconnect.AssetInformationModel.Files
{
	...
	public sealed class FilePropertyClass
	{
		...
		public FilePropertyProperties Properties { get; } = new FilePropertyProperties();
		public sealed class FilePropertyProperties
		{
