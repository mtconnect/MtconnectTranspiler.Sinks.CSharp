...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingToolMeasurementSubtypes
{
	...
	public sealed class BodyLengthMaxClass
	{
		...
		public BodyLengthMaxProperties Properties { get; } = new BodyLengthMaxProperties();
		public sealed class BodyLengthMaxProperties
		{
