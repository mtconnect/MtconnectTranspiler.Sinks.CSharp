...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingToolMeasurementSubtypes
{
	...
	public sealed class FlangeDiameterMaxClass
	{
		...
		public FlangeDiameterMaxProperties Properties { get; } = new FlangeDiameterMaxProperties();
		public sealed class FlangeDiameterMaxProperties
		{
