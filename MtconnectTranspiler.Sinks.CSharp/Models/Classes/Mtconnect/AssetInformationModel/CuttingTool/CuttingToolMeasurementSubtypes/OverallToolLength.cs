...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingToolMeasurementSubtypes
{
	...
	public sealed class OverallToolLengthClass
	{
		...
		public OverallToolLengthProperties Properties { get; } = new OverallToolLengthProperties();
		public sealed class OverallToolLengthProperties
		{
