...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingItem.CuttingItemMeasurementSubtypes
{
	...
	public sealed class ChamferWidthClass
	{
		...
		public ChamferWidthProperties Properties { get; } = new ChamferWidthProperties();
		public sealed class ChamferWidthProperties
		{
