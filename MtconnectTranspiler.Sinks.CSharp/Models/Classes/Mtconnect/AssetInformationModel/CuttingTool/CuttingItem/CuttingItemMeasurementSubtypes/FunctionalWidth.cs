...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingItem.CuttingItemMeasurementSubtypes
{
	...
	public sealed class FunctionalWidthClass
	{
		...
		public FunctionalWidthProperties Properties { get; } = new FunctionalWidthProperties();
		public sealed class FunctionalWidthProperties
		{
