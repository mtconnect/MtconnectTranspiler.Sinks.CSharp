...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingItem.CuttingItemMeasurementSubtypes
{
	...
	public sealed class CuttingEdgeLengthClass
	{
		...
		public CuttingEdgeLengthProperties Properties { get; } = new CuttingEdgeLengthProperties();
		public sealed class CuttingEdgeLengthProperties
		{
