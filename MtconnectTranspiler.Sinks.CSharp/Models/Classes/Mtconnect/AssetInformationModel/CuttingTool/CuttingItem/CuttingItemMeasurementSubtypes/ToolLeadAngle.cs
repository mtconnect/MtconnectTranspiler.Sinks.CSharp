...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingItem.CuttingItemMeasurementSubtypes
{
	...
	public sealed class ToolLeadAngleClass
	{
		...
		public ToolLeadAngleProperties Properties { get; } = new ToolLeadAngleProperties();
		public sealed class ToolLeadAngleProperties
		{
