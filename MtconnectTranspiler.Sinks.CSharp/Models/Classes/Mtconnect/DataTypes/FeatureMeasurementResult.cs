...
namespace Mtconnect.DataTypes
{
	...
	public sealed class FeatureMeasurementResultClass
	{
		...
		public FeatureMeasurementResultProperties Properties { get; } = new FeatureMeasurementResultProperties();
		public sealed class FeatureMeasurementResultProperties
		{
		
		
			/// <remarks>Original Name: MeasurementId</remarks>
			public MeasurementIdProperty MeasurementId { get; } = new MeasurementIdProperty();
			public sealed class MeasurementIdProperty
			{
			...
			public sealed class FeaturePersistentIdProperty
			{
				/// <inheritdoc cref="Property.Type" />
				/// Original Type: _19_0_3_91b028d_1579272245466_691733_672
				public Type Type => typeof(String);
			...
			public sealed class CharacteristicPersistentIdProperty
			{
				/// <inheritdoc cref="Property.Type" />
				/// Original Type: _19_0_3_91b028d_1579272245466_691733_672
				public Type Type => typeof(String);
			...
			public sealed class MeasurementTypeProperty
			{
				/// <inheritdoc cref="Property.Type" />
			...
			public sealed class MeasurementValueProperty
			{
				/// <inheritdoc cref="Property.Type" />
			...
			public sealed class MeasurementUnitsProperty
			{
				/// <inheritdoc cref="Property.Type" />
				/// Original Type: _19_0_3_91b028d_1579272360416_763325_681
				public Type Type => typeof(String);
			...
			public sealed class CharacteristicStatusProperty
			{
				/// <inheritdoc cref="Property.Type" />
			...
			public sealed class UncertaintyTypeProperty
			{
				/// <inheritdoc cref="Property.Type" />
			...
			public sealed class UncertaintyProperty
			{
				/// <inheritdoc cref="Property.Type" />
				/// Original Type: _19_0_3_91b028d_1579272506322_914606_702
				public Type Type => typeof(Single);
