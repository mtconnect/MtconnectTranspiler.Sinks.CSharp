...
namespace Mtconnect.DeviceInformationModel.DataItems.PropertiesOfDataItem.PropertiesOfDefinition
{
	...
	public sealed class EntryDefinitionClass
	{
		...
		public EntryDefinitionProperties Properties { get; } = new EntryDefinitionProperties();
		public sealed class EntryDefinitionProperties
		{
		
		
			/// <remarks>Original Name: Key</remarks>
			public KeyProperty Key { get; } = new KeyProperty();
			public sealed class KeyProperty
			{
			...
			public sealed class KeyTypeProperty
			{
				/// <inheritdoc cref="Property.Type" />
				/// Original Type: _19_0_3_45f01b9_1579563576485_587701_22033
				public Type Type => typeof(DataItemTypeEnum);
