...
namespace Mtconnect.DeviceInformationModel.Configurations.Specifications
{
	...
	public sealed class UpperWarningClass
	{
		...
		public UpperWarningProperties Properties { get; } = new UpperWarningProperties();
		public sealed class UpperWarningProperties
		{
