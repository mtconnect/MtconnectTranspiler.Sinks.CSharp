...
namespace Mtconnect.DeviceInformationModel.Configurations.Specifications
{
	...
	public sealed class LowerWarningClass
	{
		...
		public LowerWarningProperties Properties { get; } = new LowerWarningProperties();
		public sealed class LowerWarningProperties
		{
