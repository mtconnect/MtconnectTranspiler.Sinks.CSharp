...
namespace Mtconnect.DeviceInformationModel.Configurations.Relationships
{
	...
	public sealed class ConfigurationRelationshipClass
	{
		...
		public ConfigurationRelationshipProperties Properties { get; } = new ConfigurationRelationshipProperties();
		public sealed class ConfigurationRelationshipProperties
		{
			...
			{
				/// <inheritdoc cref="Property.Type" />
				/// Original Type: EAID_17E78CC7_671B_40bb_91A0_1F7CC06799BF
				public Type Type => typeof(RelationshipTypeEnum);
			...
			public sealed class CriticalityProperty
			{
				/// <inheritdoc cref="Property.Type" />
				/// Original Type: EAID_9E68B125_F907_4cd0_9198_CC77ADBB8C75
				public Type Type => typeof(CriticalityTypeEnum);
