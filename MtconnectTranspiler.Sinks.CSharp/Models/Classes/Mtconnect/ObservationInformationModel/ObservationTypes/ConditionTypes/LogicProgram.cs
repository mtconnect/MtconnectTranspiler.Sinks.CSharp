...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.ConditionTypes
{
	...
	public sealed class LogicProgramClass
	{
		...
		public LogicProgramProperties Properties { get; } = new LogicProgramProperties();
		public sealed class LogicProgramProperties
		{
