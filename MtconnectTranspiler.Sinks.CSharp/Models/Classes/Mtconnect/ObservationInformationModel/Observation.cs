...
namespace Mtconnect.ObservationInformationModel
{
	...
	public sealed class ObservationClass
	{
		...
		public sealed class ObservationProperties
		{
			...
			public sealed class SequenceProperty
			{
				/// <inheritdoc cref="Property.Type" />
			...
			public sealed class MadeByComponentPartProperty
			{
				/// <inheritdoc cref="Property.Type" />
			...
			public sealed class IsUnavailableProperty
			{
				/// <inheritdoc cref="Property.Type" />
			...
			public sealed class MadeForDataItemPartProperty
			{
				/// <inheritdoc cref="Property.Type" />
