...
namespace Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface
{
	...
	public sealed class MaterialChangeResponseClass
	{
		...
		public MaterialChangeResponseProperties Properties { get; } = new MaterialChangeResponseProperties();
		public sealed class MaterialChangeResponseProperties
		{
