...
namespace Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface
{
	...
	public sealed class OpenChuckResponseClass
	{
		...
		public OpenChuckResponseProperties Properties { get; } = new OpenChuckResponseProperties();
		public sealed class OpenChuckResponseProperties
		{
