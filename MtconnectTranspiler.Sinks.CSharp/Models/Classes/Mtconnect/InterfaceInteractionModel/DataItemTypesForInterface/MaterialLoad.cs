...
namespace Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface
{
	...
	public sealed class MaterialLoadClass
	{
		...
		public MaterialLoadProperties Properties { get; } = new MaterialLoadProperties();
		public sealed class MaterialLoadProperties
		{
