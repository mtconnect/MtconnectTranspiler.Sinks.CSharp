...
namespace Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface
{
	...
	public sealed class CloseDoorResponseClass
	{
		...
		public CloseDoorResponseProperties Properties { get; } = new CloseDoorResponseProperties();
		public sealed class CloseDoorResponseProperties
		{
