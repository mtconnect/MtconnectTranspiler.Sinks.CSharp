...
namespace Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface
{
	...
	public sealed class InterfaceStateClass
	{
		...
		public InterfaceStateProperties Properties { get; } = new InterfaceStateProperties();
		public sealed class InterfaceStateProperties
		{
			...
			{
				/// <inheritdoc cref="Property.Type" />
				/// Original Type: _19_0_3_45f01b9_1580378417666_27713_2880
				public Type Type => typeof(InterfaceStateEnum);
