...
namespace Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface
{
	...
	public sealed class MaterialUnloadClass
	{
		...
		public MaterialUnloadProperties Properties { get; } = new MaterialUnloadProperties();
		public sealed class MaterialUnloadProperties
		{
