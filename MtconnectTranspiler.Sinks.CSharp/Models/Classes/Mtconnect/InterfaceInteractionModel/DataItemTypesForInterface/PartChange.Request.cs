...
namespace Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface
{
	...
	public sealed class PartChangeRequestClass
	{
		...
		public PartChangeRequestProperties Properties { get; } = new PartChangeRequestProperties();
		public sealed class PartChangeRequestProperties
		{
