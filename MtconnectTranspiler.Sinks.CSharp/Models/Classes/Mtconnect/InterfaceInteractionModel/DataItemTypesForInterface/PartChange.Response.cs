...
namespace Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface
{
	...
	public sealed class PartChangeResponseClass
	{
		...
		public PartChangeResponseProperties Properties { get; } = new PartChangeResponseProperties();
		public sealed class PartChangeResponseProperties
		{
