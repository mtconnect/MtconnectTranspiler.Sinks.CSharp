...
namespace Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface
{
	...
	public sealed class MaterialFeedClass
	{
		...
		public MaterialFeedProperties Properties { get; } = new MaterialFeedProperties();
		public sealed class MaterialFeedProperties
		{
