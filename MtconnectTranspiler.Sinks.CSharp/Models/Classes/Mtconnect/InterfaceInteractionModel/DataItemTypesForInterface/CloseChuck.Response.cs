...
namespace Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface
{
	...
	public sealed class CloseChuckResponseClass
	{
		...
		public CloseChuckResponseProperties Properties { get; } = new CloseChuckResponseProperties();
		public sealed class CloseChuckResponseProperties
		{
