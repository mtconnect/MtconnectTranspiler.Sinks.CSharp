...
{
	/// <summary>﻿request for information specifies streaming data that includes sequence number(s) for pieces of data that are beyond the end of the buffer.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___2024x_68e0225_1744717258218_255485_23903">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class OutOfRangeClass : IClass
	{
		/// <summary>Constant value for <see cref="OutOfRangeClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_2024x_68e0225_1744717258218_255485_23903";
		/// <summary>Constant value for <see cref="OutOfRangeClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___2024x_68e0225_1744717258218_255485_23903";
		/// <summary>Constant value for <see cref="OutOfRangeClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;request for information specifies streaming data that includes sequence number(s) for pieces of data that are beyond the end of the buffer.&#10;
";
		/// <summary>Constant value for <see cref="OutOfRangeClass.Name" /></summary>
		public const string NAME = "OutOfRange";
		/// <summary>Constant value for <see cref="OutOfRangeClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="OutOfRangeClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="OutOfRangeClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.6";
		/// <summary>Constant value for <see cref="OutOfRangeClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new OutOfRangeClassProperties Properties { get; } = new OutOfRangeClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="OutOfRangeClass" />.
		...
		/// </summary>
		public class OutOfRangeClassProperties : Mtconnect.Fundamentals.MTConnectProtocol.MTConnectErrorsResponseDocument.ErrorClass.ErrorClassProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="OutOfRangeClass" />.
		/// </summary>
