...
{
	/// <summary>﻿operating state of the <i>request</i> to change the part or product associated with a piece of equipment to a different part or product.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="PartChangeRequestClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1623846332463_494092_2688";
		/// <summary>Constant value for <see cref="PartChangeRequestClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1623846332463_494092_2688";
		/// <summary>Constant value for <see cref="PartChangeRequestClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="PartChangeRequestClass.Name" /></summary>
		public const string NAME = "PartChange.Request";
		/// <summary>Constant value for <see cref="PartChangeRequestClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PartChangeRequestClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PartChangeRequestClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="PartChangeRequestClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new PartChangeRequestClassProperties Properties { get; } = new PartChangeRequestClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="PartChangeRequestClass" />.
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PartChangeRequestClass" />.
		/// </summary>
