...
{
	/// <summary>﻿operating state of the <i>response</i> to a <i>request</i> to close a door.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="CloseDoorResponseClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1623846243174_727333_2543";
		/// <summary>Constant value for <see cref="CloseDoorResponseClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1623846243174_727333_2543";
		/// <summary>Constant value for <see cref="CloseDoorResponseClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;operating state of the {{term(response)}} to a {{term(request)}} to close a door.&#10;
";
		/// <summary>Constant value for <see cref="CloseDoorResponseClass.Name" /></summary>
		public const string NAME = "CloseDoor.Response";
		/// <summary>Constant value for <see cref="CloseDoorResponseClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="CloseDoorResponseClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="CloseDoorResponseClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="CloseDoorResponseClass.DeprecatedVersion" /></summary>
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="CloseDoorResponseClass" />.
		/// </summary>
