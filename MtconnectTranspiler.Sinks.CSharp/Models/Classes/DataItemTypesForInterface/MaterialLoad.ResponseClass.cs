...
{
	/// <summary>﻿operating state of the <i>response</i> to a <i>request</i> to load a piece of material or product.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_68e0225_1623846332885_807381_2709">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class MaterialLoadResponseClass : IClass
	{
		/// <summary>Constant value for <see cref="MaterialLoadResponseClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1623846332885_807381_2709";
		/// <summary>Constant value for <see cref="MaterialLoadResponseClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1623846332885_807381_2709";
		/// <summary>Constant value for <see cref="MaterialLoadResponseClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;operating state of the {{term(response)}} to a {{term(request)}} to load a piece of material or product.&#10;
";
		/// <summary>Constant value for <see cref="MaterialLoadResponseClass.Name" /></summary>
		public const string NAME = "MaterialLoad.Response";
		/// <summary>Constant value for <see cref="MaterialLoadResponseClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="MaterialLoadResponseClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="MaterialLoadResponseClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="MaterialLoadResponseClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new MaterialLoadResponseClassProperties Properties { get; } = new MaterialLoadResponseClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="MaterialLoadResponseClass" />.
		...
		/// </summary>
		public class MaterialLoadResponseClassProperties : Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface.MaterialLoadClass.MaterialLoadClassProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="MaterialLoadResponseClass" />.
		/// </summary>
