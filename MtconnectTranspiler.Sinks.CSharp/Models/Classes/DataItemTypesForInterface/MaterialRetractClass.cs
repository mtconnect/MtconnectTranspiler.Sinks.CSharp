...
{
	/// <summary>﻿<see cref="InterfaceEventEnum.MATERIAL_RETRACT">InterfaceEventEnum.MATERIAL_RETRACT</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218353_840620_1929">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	{
		/// <summary>Constant value for <see cref="MaterialRetractClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218353_840620_1929";
		/// <summary>Constant value for <see cref="MaterialRetractClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218353_840620_1929";
		/// <summary>Constant value for <see cref="MaterialRetractClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(InterfaceEventEnum::MATERIAL_RETRACT)}}&#10;
";
		/// <summary>Constant value for <see cref="MaterialRetractClass.Name" /></summary>
		public const string NAME = "MaterialRetract";
		/// <summary>Constant value for <see cref="MaterialRetractClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="MaterialRetractClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="MaterialRetractClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="MaterialRetractClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new MaterialRetractClassProperties Properties { get; } = new MaterialRetractClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="MaterialRetractClass" />.
		...
		/// </summary>
		public class MaterialRetractClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "MATERIAL_RETRACT";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="MaterialRetractClass" />.
		/// </summary>
