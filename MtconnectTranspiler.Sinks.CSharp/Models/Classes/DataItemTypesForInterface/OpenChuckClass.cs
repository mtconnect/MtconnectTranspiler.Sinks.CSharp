...
{
	/// <summary>﻿<see cref="InterfaceEventEnum.OPEN_CHUCK">InterfaceEventEnum.OPEN_CHUCK</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="OpenChuckClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218357_970458_1938";
		/// <summary>Constant value for <see cref="OpenChuckClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218357_970458_1938";
		/// <summary>Constant value for <see cref="OpenChuckClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(InterfaceEventEnum::OPEN_CHUCK)}}&#10;
";
		/// <summary>Constant value for <see cref="OpenChuckClass.Name" /></summary>
		public const string NAME = "OpenChuck";
		/// <summary>Constant value for <see cref="OpenChuckClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="OpenChuckClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="OpenChuckClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="OpenChuckClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new OpenChuckClassProperties Properties { get; } = new OpenChuckClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="OpenChuckClass" />.
		...
		public class OpenChuckClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "OPEN_CHUCK";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="OpenChuckClass" />.
		/// </summary>
