...
{
	/// <summary>﻿operating state of the <i>request</i> to advance material or feed product to a piece of equipment from a continuous or bulk source.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="MaterialFeedRequestClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1623846333719_341345_2748";
		/// <summary>Constant value for <see cref="MaterialFeedRequestClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1623846333719_341345_2748";
		/// <summary>Constant value for <see cref="MaterialFeedRequestClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="MaterialFeedRequestClass.Name" /></summary>
		public const string NAME = "MaterialFeed.Request";
		/// <summary>Constant value for <see cref="MaterialFeedRequestClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="MaterialFeedRequestClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="MaterialFeedRequestClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="MaterialFeedRequestClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new MaterialFeedRequestClassProperties Properties { get; } = new MaterialFeedRequestClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="MaterialFeedRequestClass" />.
		/// <br/><b>Note</b>, some properties (<see cref="IProperty" />) are inherited from <see cref="Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface.MaterialFeedClass.MaterialFeedClassProperties" />.
		/// </summary>
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="MaterialFeedRequestClass" />.
		/// </summary>
