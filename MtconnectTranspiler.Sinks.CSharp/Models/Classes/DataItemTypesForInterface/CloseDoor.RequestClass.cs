...
{
	/// <summary>﻿operating state of the <i>request</i> to close a door.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_68e0225_1623846243172_989237_2542">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class CloseDoorRequestClass : IClass
	{
		/// <summary>Constant value for <see cref="CloseDoorRequestClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1623846243172_989237_2542";
		/// <summary>Constant value for <see cref="CloseDoorRequestClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1623846243172_989237_2542";
		/// <summary>Constant value for <see cref="CloseDoorRequestClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;operating state of the {{term(request)}} to close a door.&#10;
";
		/// <summary>Constant value for <see cref="CloseDoorRequestClass.Name" /></summary>
		public const string NAME = "CloseDoor.Request";
		/// <summary>Constant value for <see cref="CloseDoorRequestClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="CloseDoorRequestClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="CloseDoorRequestClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="CloseDoorRequestClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new CloseDoorRequestClassProperties Properties { get; } = new CloseDoorRequestClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="CloseDoorRequestClass" />.
		/// <br/><b>Note</b>, some properties (<see cref="IProperty" />) are inherited from <see cref="Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface.CloseDoorClass.CloseDoorClassProperties" />.
		/// </summary>
		public class CloseDoorRequestClassProperties : Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface.CloseDoorClass.CloseDoorClassProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="CloseDoorRequestClass" />.
		/// </summary>
