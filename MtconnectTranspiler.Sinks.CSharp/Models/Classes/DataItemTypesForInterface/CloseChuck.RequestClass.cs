...
{
	/// <summary>﻿operating state of the <i>request</i> to close a chuck.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_68e0225_1623845929509_904789_2427">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class CloseChuckRequestClass : IClass
	{
		/// <summary>Constant value for <see cref="CloseChuckRequestClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1623845929509_904789_2427";
		/// <summary>Constant value for <see cref="CloseChuckRequestClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1623845929509_904789_2427";
		/// <summary>Constant value for <see cref="CloseChuckRequestClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;operating state of the {{term(request)}} to close a chuck.&#10;
";
		/// <summary>Constant value for <see cref="CloseChuckRequestClass.Name" /></summary>
		public const string NAME = "CloseChuck.Request";
		/// <summary>Constant value for <see cref="CloseChuckRequestClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="CloseChuckRequestClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="CloseChuckRequestClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="CloseChuckRequestClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new CloseChuckRequestClassProperties Properties { get; } = new CloseChuckRequestClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="CloseChuckRequestClass" />.
		/// <br/><b>Note</b>, some properties (<see cref="IProperty" />) are inherited from <see cref="Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface.CloseChuckClass.CloseChuckClassProperties" />.
		/// </summary>
		public class CloseChuckRequestClassProperties : Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface.CloseChuckClass.CloseChuckClassProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="CloseChuckRequestClass" />.
		/// </summary>
