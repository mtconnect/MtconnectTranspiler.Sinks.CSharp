...
{
	/// <summary>﻿operating state of the <i>response</i> to a <i>request</i> to unload a piece of material or product.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_68e0225_1623846333302_943133_2729">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	{
		/// <summary>Constant value for <see cref="MaterialUnloadResponseClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1623846333302_943133_2729";
		/// <summary>Constant value for <see cref="MaterialUnloadResponseClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1623846333302_943133_2729";
		/// <summary>Constant value for <see cref="MaterialUnloadResponseClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;operating state of the {{term(response)}} to a {{term(request)}} to unload a piece of material or product.&#10;
";
		/// <summary>Constant value for <see cref="MaterialUnloadResponseClass.Name" /></summary>
		public const string NAME = "MaterialUnload.Response";
		/// <summary>Constant value for <see cref="MaterialUnloadResponseClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="MaterialUnloadResponseClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="MaterialUnloadResponseClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="MaterialUnloadResponseClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		/// <remarks>
		/// Original Type: _19_0_3_45f01b9_1580378218354_760416_1932
		/// </remarks>
		public Type Generalization => typeof(Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface.MaterialUnloadClass);

		/// <inheritdoc />
		public new MaterialUnloadResponseClassProperties Properties { get; } = new MaterialUnloadResponseClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="MaterialUnloadResponseClass" />.
		/// <br/><b>Note</b>, some properties (<see cref="IProperty" />) are inherited from <see cref="Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface.MaterialUnloadClass.MaterialUnloadClassProperties" />.
		/// </summary>
		public class MaterialUnloadResponseClassProperties : Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface.MaterialUnloadClass.MaterialUnloadClassProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="MaterialUnloadResponseClass" />.
		/// </summary>
