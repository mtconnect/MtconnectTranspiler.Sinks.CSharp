...
namespace Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface
{
	...
	{
		/// <summary>Constant value for <see cref="OpenChuckResponseClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1623846314912_181643_2649";
		/// <summary>Constant value for <see cref="OpenChuckResponseClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1623846314912_181643_2649";
		/// <summary>Constant value for <see cref="OpenChuckResponseClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;operating state of the {{term(response)}} to a {{term(request)}} to open a chuck.&#10;
";
		/// <summary>Constant value for <see cref="OpenChuckResponseClass.Name" /></summary>
		public const string NAME = "OpenChuck.Response";
		/// <summary>Constant value for <see cref="OpenChuckResponseClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="OpenChuckResponseClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="OpenChuckResponseClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="OpenChuckResponseClass.DeprecatedVersion" /></summary>
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="OpenChuckResponseClass" />.
		/// </summary>
