...
{
	/// <summary>﻿operating state of the <i>response</i> to a <i>request</i> to close a chuck.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="CloseChuckResponseClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1623845936473_867534_2475";
		/// <summary>Constant value for <see cref="CloseChuckResponseClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1623845936473_867534_2475";
		/// <summary>Constant value for <see cref="CloseChuckResponseClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;operating state of the {{term(response)}} to a {{term(request)}} to close a chuck.&#10;
";
		/// <summary>Constant value for <see cref="CloseChuckResponseClass.Name" /></summary>
		public const string NAME = "CloseChuck.Response";
		/// <summary>Constant value for <see cref="CloseChuckResponseClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="CloseChuckResponseClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="CloseChuckResponseClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="CloseChuckResponseClass.DeprecatedVersion" /></summary>
