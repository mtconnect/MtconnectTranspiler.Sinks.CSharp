...
{
	/// <summary>﻿operating state of the <i>request</i> to open a door.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_68e0225_1623846331922_738200_2668">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class OpenDoorRequestClass : IClass
	{
		/// <summary>Constant value for <see cref="OpenDoorRequestClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1623846331922_738200_2668";
		/// <summary>Constant value for <see cref="OpenDoorRequestClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1623846331922_738200_2668";
		/// <summary>Constant value for <see cref="OpenDoorRequestClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;operating state of the {{term(request)}} to open a door.&#10;
";
		/// <summary>Constant value for <see cref="OpenDoorRequestClass.Name" /></summary>
		public const string NAME = "OpenDoor.Request";
		/// <summary>Constant value for <see cref="OpenDoorRequestClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="OpenDoorRequestClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="OpenDoorRequestClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="OpenDoorRequestClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new OpenDoorRequestClassProperties Properties { get; } = new OpenDoorRequestClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="OpenDoorRequestClass" />.
		...
		/// </summary>
		public class OpenDoorRequestClassProperties : Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface.OpenDoorClass.OpenDoorClassProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="OpenDoorRequestClass" />.
		/// </summary>
