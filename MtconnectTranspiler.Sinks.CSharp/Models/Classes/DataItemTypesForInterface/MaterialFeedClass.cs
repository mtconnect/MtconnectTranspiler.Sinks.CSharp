...
{
	/// <summary>﻿<see cref="InterfaceEventEnum.MATERIAL_FEED">InterfaceEventEnum.MATERIAL_FEED</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="MaterialFeedClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218347_189027_1914";
		/// <summary>Constant value for <see cref="MaterialFeedClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218347_189027_1914";
		/// <summary>Constant value for <see cref="MaterialFeedClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(InterfaceEventEnum::MATERIAL_FEED)}}&#10;
";
		/// <summary>Constant value for <see cref="MaterialFeedClass.Name" /></summary>
		public const string NAME = "MaterialFeed";
		/// <summary>Constant value for <see cref="MaterialFeedClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="MaterialFeedClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="MaterialFeedClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="MaterialFeedClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new MaterialFeedClassProperties Properties { get; } = new MaterialFeedClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="MaterialFeedClass" />.
		...
		public class MaterialFeedClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "MATERIAL_FEED";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="MaterialFeedClass" />.
		/// </summary>
