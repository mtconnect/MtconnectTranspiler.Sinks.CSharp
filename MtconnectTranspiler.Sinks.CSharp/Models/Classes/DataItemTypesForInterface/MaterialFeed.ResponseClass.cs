...
{
	/// <summary>
	﻿/// operating state of the <i>response</i> to a <i>request</i> to advance material or feed product to a piece of equipment from a continuous or bulk source.<br/><br />
