...
{
	/// <summary>﻿operating state of the <i>response</i> to a <i>request</i> to advance material or feed product to a piece of equipment from a continuous or bulk source.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="MaterialFeedResponseClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1623846333720_744944_2749";
		/// <summary>Constant value for <see cref="MaterialFeedResponseClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1623846333720_744944_2749";
		/// <summary>Constant value for <see cref="MaterialFeedResponseClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="MaterialFeedResponseClass.Name" /></summary>
		public const string NAME = "MaterialFeed.Response";
		/// <summary>Constant value for <see cref="MaterialFeedResponseClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="MaterialFeedResponseClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="MaterialFeedResponseClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="MaterialFeedResponseClass.DeprecatedVersion" /></summary>
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="MaterialFeedResponseClass" />.
		/// </summary>
