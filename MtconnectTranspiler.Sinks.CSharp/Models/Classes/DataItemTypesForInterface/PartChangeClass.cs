...
{
	/// <summary>﻿<see cref="InterfaceEventEnum.PART_CHANGE">InterfaceEventEnum.PART_CHANGE</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218361_159569_1950">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class PartChangeClass : IClass
	{
		/// <summary>Constant value for <see cref="PartChangeClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218361_159569_1950";
		/// <summary>Constant value for <see cref="PartChangeClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218361_159569_1950";
		/// <summary>Constant value for <see cref="PartChangeClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(InterfaceEventEnum::PART_CHANGE)}}&#10;
";
		/// <summary>Constant value for <see cref="PartChangeClass.Name" /></summary>
		public const string NAME = "PartChange";
		/// <summary>Constant value for <see cref="PartChangeClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PartChangeClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PartChangeClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="PartChangeClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new PartChangeClassProperties Properties { get; } = new PartChangeClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="PartChangeClass" />.
		...
		/// </summary>
		public class PartChangeClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PART_CHANGE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PartChangeClass" />.
		/// </summary>
