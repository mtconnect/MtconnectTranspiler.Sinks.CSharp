...
{
	/// <summary>
	﻿/// operating state of the <i>response</i> to a <i>request</i> to change the part or product associated with a piece of equipment to a different part or product.<br/><br />
