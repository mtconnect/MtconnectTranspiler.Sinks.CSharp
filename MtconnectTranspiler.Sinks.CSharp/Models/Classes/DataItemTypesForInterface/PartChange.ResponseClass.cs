...
{
	/// <summary>﻿operating state of the <i>response</i> to a <i>request</i> to change the part or product associated with a piece of equipment to a different part or product.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_68e0225_1623846332464_142258_2689">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	{
		/// <summary>Constant value for <see cref="PartChangeResponseClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1623846332464_142258_2689";
		/// <summary>Constant value for <see cref="PartChangeResponseClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1623846332464_142258_2689";
		/// <summary>Constant value for <see cref="PartChangeResponseClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="PartChangeResponseClass.Name" /></summary>
		public const string NAME = "PartChange.Response";
		/// <summary>Constant value for <see cref="PartChangeResponseClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PartChangeResponseClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PartChangeResponseClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="PartChangeResponseClass.DeprecatedVersion" /></summary>
		...
		/// <br/><b>Note</b>, some properties (<see cref="IProperty" />) are inherited from <see cref="Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface.PartChangeClass.PartChangeClassProperties" />.
		/// </summary>
		public class PartChangeResponseClassProperties : Mtconnect.InterfaceInteractionModel.DataItemTypesForInterface.PartChangeClass.PartChangeClassProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PartChangeResponseClass" />.
		/// </summary>
