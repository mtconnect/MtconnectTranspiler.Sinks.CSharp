...
{
	/// <summary>﻿<see cref="InterfaceEventEnum.CLOSE_DOOR">InterfaceEventEnum.CLOSE_DOOR</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218219_606998_1626">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	{
		/// <summary>Constant value for <see cref="CloseDoorClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218219_606998_1626";
		/// <summary>Constant value for <see cref="CloseDoorClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218219_606998_1626";
		/// <summary>Constant value for <see cref="CloseDoorClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(InterfaceEventEnum::CLOSE_DOOR)}}&#10;
";
		/// <summary>Constant value for <see cref="CloseDoorClass.Name" /></summary>
		public const string NAME = "CloseDoor";
		/// <summary>Constant value for <see cref="CloseDoorClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="CloseDoorClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="CloseDoorClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="CloseDoorClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new CloseDoorClassProperties Properties { get; } = new CloseDoorClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="CloseDoorClass" />.
		...
		/// </summary>
		public class CloseDoorClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "CLOSE_DOOR";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="CloseDoorClass" />.
		/// </summary>
