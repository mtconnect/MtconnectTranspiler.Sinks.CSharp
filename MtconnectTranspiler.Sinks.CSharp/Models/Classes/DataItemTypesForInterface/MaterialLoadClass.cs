...
{
	/// <summary>﻿<see cref="InterfaceEventEnum.MATERIAL_LOAD">InterfaceEventEnum.MATERIAL_LOAD</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218351_269470_1926">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class MaterialLoadClass : IClass
	{
		/// <summary>Constant value for <see cref="MaterialLoadClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218351_269470_1926";
		/// <summary>Constant value for <see cref="MaterialLoadClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218351_269470_1926";
		/// <summary>Constant value for <see cref="MaterialLoadClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(InterfaceEventEnum::MATERIAL_LOAD)}}&#10;
";
		/// <summary>Constant value for <see cref="MaterialLoadClass.Name" /></summary>
		public const string NAME = "MaterialLoad";
		/// <summary>Constant value for <see cref="MaterialLoadClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="MaterialLoadClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="MaterialLoadClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="MaterialLoadClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new MaterialLoadClassProperties Properties { get; } = new MaterialLoadClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="MaterialLoadClass" />.
		...
		/// </summary>
		public class MaterialLoadClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "MATERIAL_LOAD";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="MaterialLoadClass" />.
		/// </summary>
