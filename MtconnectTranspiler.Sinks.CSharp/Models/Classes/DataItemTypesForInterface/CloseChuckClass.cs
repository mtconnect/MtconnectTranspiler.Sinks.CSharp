...
{
	/// <summary>﻿<see cref="InterfaceEventEnum.CLOSE_CHUCK">InterfaceEventEnum.CLOSE_CHUCK</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218218_173108_1623">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class CloseChuckClass : IClass
	{
		/// <summary>Constant value for <see cref="CloseChuckClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218218_173108_1623";
		/// <summary>Constant value for <see cref="CloseChuckClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218218_173108_1623";
		/// <summary>Constant value for <see cref="CloseChuckClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(InterfaceEventEnum::CLOSE_CHUCK)}}&#10;
";
		/// <summary>Constant value for <see cref="CloseChuckClass.Name" /></summary>
		public const string NAME = "CloseChuck";
		/// <summary>Constant value for <see cref="CloseChuckClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="CloseChuckClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="CloseChuckClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="CloseChuckClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new CloseChuckClassProperties Properties { get; } = new CloseChuckClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="CloseChuckClass" />.
		...
		/// </summary>
		public class CloseChuckClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "CLOSE_CHUCK";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="CloseChuckClass" />.
		/// </summary>
