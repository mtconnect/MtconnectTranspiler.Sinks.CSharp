...
{
	/// <summary>
	/// operating state of the <i>response</i> to a <i>request</i> to remove or retract material or product.
	...
	public sealed class MaterialRetractResponseClass : IClass
	{
		...
		/// <inheritdoc />
		public string Summary => @"/// operating state of the <i>response</i> to a <i>request</i> to remove or retract material or product.";
