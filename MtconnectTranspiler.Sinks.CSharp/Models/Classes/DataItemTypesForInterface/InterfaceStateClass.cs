...
{
	/// <summary>﻿<see cref="InterfaceEventEnum.INTERFACE_STATE">InterfaceEventEnum.INTERFACE_STATE</see><br /><br />When the <see cref="InterfaceState">InterfaceState</see> is <c>DISABLED</c>, the state of all data items that are specific for the <i>interaction model</i> associated with that <see cref="Interface">Interface</see> <b>MUST</b> be set to <c>NOT_READY</c>.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="InterfaceStateClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218325_627294_1860";
		/// <summary>Constant value for <see cref="InterfaceStateClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218325_627294_1860";
		/// <summary>Constant value for <see cref="InterfaceStateClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="InterfaceStateClass.Name" /></summary>
		public const string NAME = "InterfaceState";
		/// <summary>Constant value for <see cref="InterfaceStateClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="InterfaceStateClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="InterfaceStateClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="InterfaceStateClass.DeprecatedVersion" /></summary>
		...
		public class InterfaceStateClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "INTERFACE_STATE";
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: InterfaceStateEnumMetaClass </remarks>
				/// </summary>
