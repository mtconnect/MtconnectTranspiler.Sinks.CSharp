...
{
	/// <summary>﻿<see cref="FilterEnum.PERIOD">FilterEnum.PERIOD</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="PeriodFilterGeneralization.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_4_45f01b9_1644604750458_164137_46";
		/// <summary>Constant value for <see cref="PeriodFilterGeneralization.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_4_45f01b9_1644604750458_164137_46";
		/// <summary>Constant value for <see cref="PeriodFilterGeneralization.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(FilterEnum::PERIOD)}}&#10;
";
		/// <summary>Constant value for <see cref="PeriodFilterGeneralization.Name" /></summary>
		public const string NAME = "PeriodFilter";
		/// <summary>Constant value for <see cref="PeriodFilterGeneralization.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PeriodFilterGeneralization.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PeriodFilterGeneralization.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="PeriodFilterGeneralization.DeprecatedVersion" /></summary>
		...
		public class PeriodFilterGeneralizationProperties : Mtconnect.DeviceInformationModel.DataItems.PropertiesOfDataItem.FilterClass.FilterClassProperties
		{
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PERIOD";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PeriodFilterGeneralization" />.
		/// </summary>
