...
namespace Mtconnect.DeviceInformationModel.DataItems.PropertiesOfDataItem
{
	...
	{
		/// <summary>Constant value for <see cref="InitialValueClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "EAID_3F705CFA_0BDC_4dc1_91C8_0A38B91DD3E6";
		/// <summary>Constant value for <see cref="InitialValueClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure__EAID_3F705CFA_0BDC_4dc1_91C8_0A38B91DD3E6";
		/// <summary>Constant value for <see cref="InitialValueClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;starting value for a {{block(DataItem)}} as well as the value to be set for the {{block(DataItem)}} after a reset event.&#10;
";
		/// <summary>Constant value for <see cref="InitialValueClass.Name" /></summary>
		public const string NAME = "InitialValue";
		/// <summary>Constant value for <see cref="InitialValueClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="InitialValueClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="InitialValueClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="InitialValueClass.DeprecatedVersion" /></summary>
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="InitialValueClass" />.
		/// </summary>
