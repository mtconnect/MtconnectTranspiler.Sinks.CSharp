...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingItem.CuttingItemMeasurementSubtypes
{
	...
	{
		/// <summary>Constant value for <see cref="CornerRadiusClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1582919119550_987439_1489";
		/// <summary>Constant value for <see cref="CornerRadiusClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119550_987439_1489";
		/// <summary>Constant value for <see cref="CornerRadiusClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;nominal radius of a rounded corner measured in the X Y-plane.&#10;
";
		/// <summary>Constant value for <see cref="CornerRadiusClass.Name" /></summary>
		public const string NAME = "CornerRadius";
		/// <summary>Constant value for <see cref="CornerRadiusClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="CornerRadiusClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="CornerRadiusClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="CornerRadiusClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new CornerRadiusClassProperties Properties { get; } = new CornerRadiusClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="CornerRadiusClass" />.
		...
		/// </summary>
		public class CornerRadiusClassProperties : Mtconnect.AssetInformationModel.CuttingTool.CuttingToolLifeCycle.ToolingMeasurementGeneralization.ToolingMeasurementGeneralizationProperties
		{
			/// <inheritdoc />
			...
			public new sealed class CodeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "RE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="CornerRadiusClass" />.
		/// </summary>
