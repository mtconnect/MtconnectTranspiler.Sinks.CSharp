...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingItem.CuttingItemMeasurementSubtypes
{
	...
	{
		/// <summary>Constant value for <see cref="FunctionalWidthClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1582919119528_340813_1456";
		/// <summary>Constant value for <see cref="FunctionalWidthClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119528_340813_1456";
		/// <summary>Constant value for <see cref="FunctionalWidthClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="FunctionalWidthClass.Name" /></summary>
		public const string NAME = "FunctionalWidth";
		/// <summary>Constant value for <see cref="FunctionalWidthClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="FunctionalWidthClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="FunctionalWidthClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="FunctionalWidthClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new FunctionalWidthClassProperties Properties { get; } = new FunctionalWidthClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="FunctionalWidthClass" />.
		...
		/// </summary>
		public class FunctionalWidthClassProperties : Mtconnect.AssetInformationModel.CuttingTool.CuttingToolLifeCycle.ToolingMeasurementGeneralization.ToolingMeasurementGeneralizationProperties
		{
			/// <inheritdoc />
			...
			public new sealed class CodeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "WF";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="FunctionalWidthClass" />.
		/// </summary>
