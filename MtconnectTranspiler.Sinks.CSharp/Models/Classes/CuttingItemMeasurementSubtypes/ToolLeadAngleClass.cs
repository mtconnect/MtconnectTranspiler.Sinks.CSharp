...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingItem.CuttingItemMeasurementSubtypes
{
	...
	{
		/// <summary>Constant value for <see cref="ToolLeadAngleClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1582919119536_882157_1468";
		/// <summary>Constant value for <see cref="ToolLeadAngleClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119536_882157_1468";
		/// <summary>Constant value for <see cref="ToolLeadAngleClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="ToolLeadAngleClass.Name" /></summary>
		public const string NAME = "ToolLeadAngle";
		/// <summary>Constant value for <see cref="ToolLeadAngleClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ToolLeadAngleClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ToolLeadAngleClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="ToolLeadAngleClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ToolLeadAngleClassProperties Properties { get; } = new ToolLeadAngleClassProperties();
		...
		/// </summary>
		public class ToolLeadAngleClassProperties : Mtconnect.AssetInformationModel.CuttingTool.CuttingToolLifeCycle.ToolingMeasurementGeneralization.ToolingMeasurementGeneralizationProperties
		{
			/// <inheritdoc />
			...
			public new sealed class CodeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PSIR";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ToolLeadAngleClass" />.
		/// </summary>
