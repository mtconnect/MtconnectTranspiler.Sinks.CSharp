...
{
	/// <summary>﻿W1 is used for the insert width when an inscribed circle diameter is not practical.<br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119555_438468_1498">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class InsertWidthClass : IClass
	{
		/// <summary>Constant value for <see cref="InsertWidthClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1582919119555_438468_1498";
		/// <summary>Constant value for <see cref="InsertWidthClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119555_438468_1498";
		/// <summary>Constant value for <see cref="InsertWidthClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;W1 is used for the insert width when an inscribed circle diameter is not practical.&#10;
";
		/// <summary>Constant value for <see cref="InsertWidthClass.Name" /></summary>
		public const string NAME = "InsertWidth";
		/// <summary>Constant value for <see cref="InsertWidthClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="InsertWidthClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="InsertWidthClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="InsertWidthClass.DeprecatedVersion" /></summary>
		...
		/// </summary>
		public class InsertWidthClassProperties : Mtconnect.AssetInformationModel.CuttingTool.CuttingToolLifeCycle.ToolingMeasurementGeneralization.ToolingMeasurementGeneralizationProperties
		{
			/// <inheritdoc />
			...
			public new sealed class CodeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "W1";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="InsertWidthClass" />.
		/// </summary>
