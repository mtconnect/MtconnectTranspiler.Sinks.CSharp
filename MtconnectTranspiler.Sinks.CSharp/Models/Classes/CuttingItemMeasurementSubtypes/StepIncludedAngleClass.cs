...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingItem.CuttingItemMeasurementSubtypes
{
	...
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119543_450680_1480">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class StepIncludedAngleClass : IClass
	{
		/// <summary>Constant value for <see cref="StepIncludedAngleClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1582919119543_450680_1480";
		/// <summary>Constant value for <see cref="StepIncludedAngleClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119543_450680_1480";
		/// <summary>Constant value for <see cref="StepIncludedAngleClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="StepIncludedAngleClass.Name" /></summary>
		public const string NAME = "StepIncludedAngle";
		/// <summary>Constant value for <see cref="StepIncludedAngleClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="StepIncludedAngleClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="StepIncludedAngleClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="StepIncludedAngleClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new StepIncludedAngleClassProperties Properties { get; } = new StepIncludedAngleClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="StepIncludedAngleClass" />.
		...
		/// </summary>
		public class StepIncludedAngleClassProperties : Mtconnect.AssetInformationModel.CuttingTool.CuttingToolLifeCycle.ToolingMeasurementGeneralization.ToolingMeasurementGeneralizationProperties
		{
			/// <inheritdoc />
			...
			public new sealed class CodeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "STAx";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="StepIncludedAngleClass" />.
		/// </summary>
