...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingItem.CuttingItemMeasurementSubtypes
{
	...
	{
		/// <summary>Constant value for <see cref="PointAngleClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1582919119533_180185_1462";
		/// <summary>Constant value for <see cref="PointAngleClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119533_180185_1462";
		/// <summary>Constant value for <see cref="PointAngleClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;angle between the major cutting edge and the same cutting edge rotated by 180 degrees about the tool axis.&#10;
";
		/// <summary>Constant value for <see cref="PointAngleClass.Name" /></summary>
		public const string NAME = "PointAngle";
		/// <summary>Constant value for <see cref="PointAngleClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PointAngleClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PointAngleClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="PointAngleClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new PointAngleClassProperties Properties { get; } = new PointAngleClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="PointAngleClass" />.
		...
		/// </summary>
		public class PointAngleClassProperties : Mtconnect.AssetInformationModel.CuttingTool.CuttingToolLifeCycle.ToolingMeasurementGeneralization.ToolingMeasurementGeneralizationProperties
		{
			/// <inheritdoc />
			...
			public new sealed class CodeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "SIG";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PointAngleClass" />.
		/// </summary>
