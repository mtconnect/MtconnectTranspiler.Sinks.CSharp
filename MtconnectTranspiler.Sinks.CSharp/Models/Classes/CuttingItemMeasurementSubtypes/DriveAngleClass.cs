...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingItem.CuttingItemMeasurementSubtypes
{
	...
	{
		/// <summary>Constant value for <see cref="DriveAngleClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1582919119525_506701_1450";
		/// <summary>Constant value for <see cref="DriveAngleClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119525_506701_1450";
		/// <summary>Constant value for <see cref="DriveAngleClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;angle between the driving mechanism locator on a tool item and the main cutting edge.&#10;
";
		/// <summary>Constant value for <see cref="DriveAngleClass.Name" /></summary>
		public const string NAME = "DriveAngle";
		/// <summary>Constant value for <see cref="DriveAngleClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DriveAngleClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DriveAngleClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="DriveAngleClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new DriveAngleClassProperties Properties { get; } = new DriveAngleClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="DriveAngleClass" />.
		...
		/// </summary>
		public class DriveAngleClassProperties : Mtconnect.AssetInformationModel.CuttingTool.CuttingToolLifeCycle.ToolingMeasurementGeneralization.ToolingMeasurementGeneralizationProperties
		{
			/// <inheritdoc />
			...
			public new sealed class CodeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DRVA";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DriveAngleClass" />.
		/// </summary>
