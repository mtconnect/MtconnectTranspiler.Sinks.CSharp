...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingItem.CuttingItemMeasurementSubtypes
{
	...
	{
		/// <summary>Constant value for <see cref="CuttingDiameterClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1582919119546_393506_1483";
		/// <summary>Constant value for <see cref="CuttingDiameterClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119546_393506_1483";
		/// <summary>Constant value for <see cref="CuttingDiameterClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="CuttingDiameterClass.Name" /></summary>
		public const string NAME = "CuttingDiameter";
		/// <summary>Constant value for <see cref="CuttingDiameterClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="CuttingDiameterClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="CuttingDiameterClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="CuttingDiameterClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new CuttingDiameterClassProperties Properties { get; } = new CuttingDiameterClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="CuttingDiameterClass" />.
		...
		/// </summary>
		public class CuttingDiameterClassProperties : Mtconnect.AssetInformationModel.CuttingTool.CuttingToolLifeCycle.ToolingMeasurementGeneralization.ToolingMeasurementGeneralizationProperties
		{
			/// <inheritdoc />
			...
			public new sealed class CodeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DCx";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="CuttingDiameterClass" />.
		/// </summary>
