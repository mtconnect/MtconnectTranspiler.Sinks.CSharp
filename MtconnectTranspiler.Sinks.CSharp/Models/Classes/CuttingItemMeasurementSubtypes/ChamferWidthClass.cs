...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingItem.CuttingItemMeasurementSubtypes
{
	...
	{
		/// <summary>Constant value for <see cref="ChamferWidthClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1582919119553_748475_1495";
		/// <summary>Constant value for <see cref="ChamferWidthClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119553_748475_1495";
		/// <summary>Constant value for <see cref="ChamferWidthClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;width of the chamfer.&#10;
";
		/// <summary>Constant value for <see cref="ChamferWidthClass.Name" /></summary>
		public const string NAME = "ChamferWidth";
		/// <summary>Constant value for <see cref="ChamferWidthClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ChamferWidthClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ChamferWidthClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="ChamferWidthClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ChamferWidthClassProperties Properties { get; } = new ChamferWidthClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ChamferWidthClass" />.
		...
		/// </summary>
		public class ChamferWidthClassProperties : Mtconnect.AssetInformationModel.CuttingTool.CuttingToolLifeCycle.ToolingMeasurementGeneralization.ToolingMeasurementGeneralizationProperties
		{
			/// <inheritdoc />
			...
			public new sealed class CodeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "CHW";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ChamferWidthClass" />.
		/// </summary>
