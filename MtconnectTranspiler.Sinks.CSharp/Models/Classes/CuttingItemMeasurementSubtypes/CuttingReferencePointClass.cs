...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingItem.CuttingItemMeasurementSubtypes
{
	...
	{
		/// <summary>Constant value for <see cref="CuttingReferencePointClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1582919119521_500277_1444";
		/// <summary>Constant value for <see cref="CuttingReferencePointClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119521_500277_1444";
		/// <summary>Constant value for <see cref="CuttingReferencePointClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;theoretical sharp point of the cutting tool from which the major functional dimensions are taken.&#10;
";
		/// <summary>Constant value for <see cref="CuttingReferencePointClass.Name" /></summary>
		public const string NAME = "CuttingReferencePoint";
		/// <summary>Constant value for <see cref="CuttingReferencePointClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="CuttingReferencePointClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="CuttingReferencePointClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="CuttingReferencePointClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new CuttingReferencePointClassProperties Properties { get; } = new CuttingReferencePointClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="CuttingReferencePointClass" />.
		...
		/// </summary>
		public class CuttingReferencePointClassProperties : Mtconnect.AssetInformationModel.CuttingTool.CuttingToolLifeCycle.ToolingMeasurementGeneralization.ToolingMeasurementGeneralizationProperties
		{
			/// <inheritdoc />
			...
			public new sealed class CodeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "CRP";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="CuttingReferencePointClass" />.
		/// </summary>
