...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingItem.CuttingItemMeasurementSubtypes
{
	...
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119542_8236_1477">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class StepDiameterLengthClass : IClass
	{
		/// <summary>Constant value for <see cref="StepDiameterLengthClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1582919119542_8236_1477";
		/// <summary>Constant value for <see cref="StepDiameterLengthClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119542_8236_1477";
		/// <summary>Constant value for <see cref="StepDiameterLengthClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="StepDiameterLengthClass.Name" /></summary>
		public const string NAME = "StepDiameterLength";
		/// <summary>Constant value for <see cref="StepDiameterLengthClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="StepDiameterLengthClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="StepDiameterLengthClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="StepDiameterLengthClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new StepDiameterLengthClassProperties Properties { get; } = new StepDiameterLengthClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="StepDiameterLengthClass" />.
		...
		/// </summary>
		public class StepDiameterLengthClassProperties : Mtconnect.AssetInformationModel.CuttingTool.CuttingToolLifeCycle.ToolingMeasurementGeneralization.ToolingMeasurementGeneralizationProperties
		{
			/// <inheritdoc />
			...
			public new sealed class CodeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "SDLx";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="StepDiameterLengthClass" />.
		/// </summary>
