...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingItem.CuttingItemMeasurementSubtypes
{
	...
	{
		/// <summary>Constant value for <see cref="IncribedCircleDiameterClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1582919119531_697760_1459";
		/// <summary>Constant value for <see cref="IncribedCircleDiameterClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119531_697760_1459";
		/// <summary>Constant value for <see cref="IncribedCircleDiameterClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;diameter of a circle to which all edges of a equilateral and round regular insert are tangential.&#10;
";
		/// <summary>Constant value for <see cref="IncribedCircleDiameterClass.Name" /></summary>
		public const string NAME = "IncribedCircleDiameter";
		/// <summary>Constant value for <see cref="IncribedCircleDiameterClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="IncribedCircleDiameterClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="IncribedCircleDiameterClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="IncribedCircleDiameterClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new IncribedCircleDiameterClassProperties Properties { get; } = new IncribedCircleDiameterClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="IncribedCircleDiameterClass" />.
		...
		/// </summary>
		public class IncribedCircleDiameterClassProperties : Mtconnect.AssetInformationModel.CuttingTool.CuttingToolLifeCycle.ToolingMeasurementGeneralization.ToolingMeasurementGeneralizationProperties
		{
			/// <inheritdoc />
			...
			public new sealed class CodeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "IC";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="IncribedCircleDiameterClass" />.
		/// </summary>
