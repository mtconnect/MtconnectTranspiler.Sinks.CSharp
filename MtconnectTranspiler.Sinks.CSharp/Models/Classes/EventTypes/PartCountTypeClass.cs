...
{
	/// <summary>﻿<see cref="EventEnum.PART_COUNT_TYPE">EventEnum.PART_COUNT_TYPE</see><br /><br /><br />
	...
	public sealed class PartCountTypeClass : IClass
	{
		/// <summary>Constant value for <see cref="PartCountTypeClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1640701999569_209325_30";
		/// <summary>Constant value for <see cref="PartCountTypeClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1640701999569_209325_30";
		/// <summary>Constant value for <see cref="PartCountTypeClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::PART_COUNT_TYPE)}}&#10;
";
		/// <summary>Constant value for <see cref="PartCountTypeClass.Name" /></summary>
		public const string NAME = "PartCountType";
		/// <summary>Constant value for <see cref="PartCountTypeClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PartCountTypeClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PartCountTypeClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.0";
		/// <summary>Constant value for <see cref="PartCountTypeClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new PartCountTypeClassProperties Properties { get; } = new PartCountTypeClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="PartCountTypeClass" />.
		...
		/// </summary>
		public class PartCountTypeClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: PartCountTypeEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.PartCountTypeEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PART_COUNT_TYPE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PartCountTypeClass" />.
		/// </summary>
