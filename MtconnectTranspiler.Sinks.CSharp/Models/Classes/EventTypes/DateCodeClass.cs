...
{
	/// <summary>﻿<see cref="EventEnum.DATE_CODE">EventEnum.DATE_CODE</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="DateCodeClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218252_114493_1692";
		/// <summary>Constant value for <see cref="DateCodeClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218252_114493_1692";
		/// <summary>Constant value for <see cref="DateCodeClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::DATE_CODE)}}&#10;
";
		/// <summary>Constant value for <see cref="DateCodeClass.Name" /></summary>
		public const string NAME = "DateCode";
		/// <summary>Constant value for <see cref="DateCodeClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DateCodeClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DateCodeClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="DateCodeClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new DateCodeClassProperties Properties { get; } = new DateCodeClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="DateCodeClass" />.
		...
		public class DateCodeClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DATE_CODE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DateCodeClass" />.
		/// </summary>
