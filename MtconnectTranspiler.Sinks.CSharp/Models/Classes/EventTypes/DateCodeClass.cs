...
{
	/// <summary>
	/// <see cref="EventEnum::DATE_CODE">EventEnum::DATE_CODE</see>
	/// </summary>
	...
	public sealed class DateCodeClass : IClass
	{
		...
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""EventEnum::DATE_CODE"">EventEnum::DATE_CODE</see>";

		/// <inheritdoc />
		public string Name => "DateCodeClass";
		...
		public sealed class DateCodeClassProperties : IPropertyList
		{
			/// <inheritdoc />
