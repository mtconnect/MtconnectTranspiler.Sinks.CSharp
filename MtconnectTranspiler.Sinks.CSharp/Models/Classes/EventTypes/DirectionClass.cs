...
{
	/// <summary>﻿<see cref="EventEnum.DIRECTION">EventEnum.DIRECTION</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218278_641962_1755">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class DirectionClass : IClass
	{
		/// <summary>Constant value for <see cref="DirectionClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218278_641962_1755";
		/// <summary>Constant value for <see cref="DirectionClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218278_641962_1755";
		/// <summary>Constant value for <see cref="DirectionClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::DIRECTION)}}&#10;
";
		/// <summary>Constant value for <see cref="DirectionClass.Name" /></summary>
		public const string NAME = "Direction";
		/// <summary>Constant value for <see cref="DirectionClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DirectionClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DirectionClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.0";
		/// <summary>Constant value for <see cref="DirectionClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new DirectionClassProperties Properties { get; } = new DirectionClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="DirectionClass" />.
		...
		/// </summary>
		public class DirectionClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DIRECTION";
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: DirectionEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.DirectionEnumMetaClass);
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DirectionClass" />.
		/// </summary>
