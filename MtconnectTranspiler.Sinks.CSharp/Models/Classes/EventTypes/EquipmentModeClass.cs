...
{
	/// <summary>﻿<see cref="EventEnum.EQUIPMENT_MODE">EventEnum.EQUIPMENT_MODE</see><br /><br /><br />
	...
	public sealed class EquipmentModeClass : IClass
	{
		/// <summary>Constant value for <see cref="EquipmentModeClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218291_180049_1785";
		/// <summary>Constant value for <see cref="EquipmentModeClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218291_180049_1785";
		/// <summary>Constant value for <see cref="EquipmentModeClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::EQUIPMENT_MODE)}}&#10;
";
		/// <summary>Constant value for <see cref="EquipmentModeClass.Name" /></summary>
		public const string NAME = "EquipmentMode";
		/// <summary>Constant value for <see cref="EquipmentModeClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="EquipmentModeClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="EquipmentModeClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="EquipmentModeClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new EquipmentModeClassProperties Properties { get; } = new EquipmentModeClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="EquipmentModeClass" />.
		...
		/// </summary>
		public class EquipmentModeClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: EquipmentModeEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.EquipmentModeEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "EQUIPMENT_MODE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="EquipmentModeClass" />.
		/// </summary>
