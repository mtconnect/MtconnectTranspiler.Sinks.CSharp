...
{
	/// <summary>﻿<see cref="EventEnum.OPERATING_SYSTEM">EventEnum.OPERATING_SYSTEM</see><br /><br /><br />
	...
	public sealed class OperatingSystemClass : IClass
	{
		/// <summary>Constant value for <see cref="OperatingSystemClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_91b028d_1587749356759_918178_2174";
		/// <summary>Constant value for <see cref="OperatingSystemClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587749356759_918178_2174";
		/// <summary>Constant value for <see cref="OperatingSystemClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::OPERATING_SYSTEM)}}&#10;
";
		/// <summary>Constant value for <see cref="OperatingSystemClass.Name" /></summary>
		public const string NAME = "OperatingSystem";
		/// <summary>Constant value for <see cref="OperatingSystemClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="OperatingSystemClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="OperatingSystemClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.6";
		/// <summary>Constant value for <see cref="OperatingSystemClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new OperatingSystemClassProperties Properties { get; } = new OperatingSystemClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="OperatingSystemClass" />.
		...
		/// </summary>
		public class OperatingSystemClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "OPERATING_SYSTEM";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="OperatingSystemClass" />.
		/// </summary>
