...
{
	/// <summary>﻿<see cref="EventEnum.PART_UNIQUE_ID">EventEnum.PART_UNIQUE_ID</see><br /><br />If no <see cref="DataItem.subType">subType in DataItem</see> is specified, <c>UUID</c> is default.<br /><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="PartUniqueIdClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1605549240508_290295_764";
		/// <summary>Constant value for <see cref="PartUniqueIdClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605549240508_290295_764";
		/// <summary>Constant value for <see cref="PartUniqueIdClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::PART_UNIQUE_ID)}}

If no {{property(DataItem::subType)}} is specified, `UUID` is default.&#10;
";
		/// <summary>Constant value for <see cref="PartUniqueIdClass.Name" /></summary>
		public const string NAME = "PartUniqueId";
		/// <summary>Constant value for <see cref="PartUniqueIdClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PartUniqueIdClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PartUniqueIdClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.7";
		/// <summary>Constant value for <see cref="PartUniqueIdClass.DeprecatedVersion" /></summary>
		...
		/// </summary>
		public class PartUniqueIdClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PART_UNIQUE_ID";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PartUniqueIdClass" />.
		/// </summary>
