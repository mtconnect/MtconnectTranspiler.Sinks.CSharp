...
{
	/// <summary>﻿<see cref="EventEnum.POWER_SOURCE">EventEnum.POWER_SOURCE</see><br /><br /><br />
...
";
		...
		/// </summary>
		public class PowerSourceClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "POWER_SOURCE";
