...
{
	/// <summary>
	/// <see cref="EventEnum::POWER_SOURCE">EventEnum::POWER_SOURCE</see>
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_68e0225_1696872166478_3528_3677";
		
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""EventEnum::POWER_SOURCE"">EventEnum::POWER_SOURCE</see>";
		...
		public class PowerSourceClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			...
			public sealed class TypeProperty : IProperty
			{
				...
				/// <inheritdoc />
				public string DefaultValue => "POWER_SOURCE";
			}
			/// <summary>
