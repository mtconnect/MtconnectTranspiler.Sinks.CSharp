...
{
	/// <summary>﻿<see cref="EventEnum.FEATURE_PERSISTENT_ID">EventEnum.FEATURE_PERSISTENT_ID</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_68e0225_1677579833995_963806_528">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class FeaturePersisitentIdClass : IClass
	{
		/// <summary>Constant value for <see cref="FeaturePersisitentIdClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1677579833995_963806_528";
		/// <summary>Constant value for <see cref="FeaturePersisitentIdClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1677579833995_963806_528";
		/// <summary>Constant value for <see cref="FeaturePersisitentIdClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::FEATURE_PERSISTENT_ID)}}&#10;
";
		/// <summary>Constant value for <see cref="FeaturePersisitentIdClass.Name" /></summary>
		public const string NAME = "FeaturePersisitentId";
		/// <summary>Constant value for <see cref="FeaturePersisitentIdClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="FeaturePersisitentIdClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="FeaturePersisitentIdClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.2";
		/// <summary>Constant value for <see cref="FeaturePersisitentIdClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new FeaturePersisitentIdClassProperties Properties { get; } = new FeaturePersisitentIdClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="FeaturePersisitentIdClass" />.
		...
		/// </summary>
		public class FeaturePersisitentIdClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "FEATURE_PERSISTENT_ID";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="FeaturePersisitentIdClass" />.
		/// </summary>
