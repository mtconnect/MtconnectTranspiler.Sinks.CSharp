...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes
{
	...
	{
		/// <summary>Constant value for <see cref="EquipmentModeWorkingClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218294_549129_1791";
		/// <summary>Constant value for <see cref="EquipmentModeWorkingClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218294_549129_1791";
		/// <summary>Constant value for <see cref="EquipmentModeWorkingClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="EquipmentModeWorkingClass.Name" /></summary>
		public const string NAME = "EquipmentMode.Working";
		/// <summary>Constant value for <see cref="EquipmentModeWorkingClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="EquipmentModeWorkingClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="EquipmentModeWorkingClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="EquipmentModeWorkingClass.DeprecatedVersion" /></summary>
		...
		public class EquipmentModeWorkingClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.EquipmentModeClass.EquipmentModeClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "WORKING";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="EquipmentModeWorkingClass" />.
		/// </summary>
