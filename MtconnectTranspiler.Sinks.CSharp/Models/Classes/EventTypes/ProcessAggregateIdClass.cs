...
{
	/// <summary>﻿<see cref="EventEnum.PROCESS_AGGREGATE_ID">EventEnum.PROCESS_AGGREGATE_ID</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="ProcessAggregateIdClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1605549689754_638221_1396";
		/// <summary>Constant value for <see cref="ProcessAggregateIdClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605549689754_638221_1396";
		/// <summary>Constant value for <see cref="ProcessAggregateIdClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::PROCESS_AGGREGATE_ID)}}&#10;
";
		/// <summary>Constant value for <see cref="ProcessAggregateIdClass.Name" /></summary>
		public const string NAME = "ProcessAggregateId";
		/// <summary>Constant value for <see cref="ProcessAggregateIdClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ProcessAggregateIdClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ProcessAggregateIdClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.7";
		/// <summary>Constant value for <see cref="ProcessAggregateIdClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ProcessAggregateIdClassProperties Properties { get; } = new ProcessAggregateIdClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ProcessAggregateIdClass" />.
		...
		public class ProcessAggregateIdClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PROCESS_AGGREGATE_ID";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ProcessAggregateIdClass" />.
		/// </summary>
