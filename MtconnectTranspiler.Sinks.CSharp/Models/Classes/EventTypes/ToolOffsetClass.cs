...
{
	/// <summary>
	/// <see cref="EventEnum::TOOL_OFFSET">EventEnum::TOOL_OFFSET</see>
	/// </summary>
	...
	public sealed class ToolOffsetClass : IClass
	{
		...
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""EventEnum::TOOL_OFFSET"">EventEnum::TOOL_OFFSET</see>";

		/// <inheritdoc />
		public string Name => "ToolOffsetClass";
		...
		public sealed class ToolOffsetClassProperties : IPropertyList
		{
			/// <inheritdoc />
