...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes
{
	...
	{
		/// <summary>Constant value for <see cref="ToolOffsetClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218458_345999_2226";
		/// <summary>Constant value for <see cref="ToolOffsetClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218458_345999_2226";
		/// <summary>Constant value for <see cref="ToolOffsetClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::TOOL_OFFSET)}}&#10;
";
		/// <summary>Constant value for <see cref="ToolOffsetClass.Name" /></summary>
		public const string NAME = "ToolOffset";
		/// <summary>Constant value for <see cref="ToolOffsetClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ToolOffsetClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ToolOffsetClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="ToolOffsetClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ToolOffsetClassProperties Properties { get; } = new ToolOffsetClassProperties();
		...
		public class ToolOffsetClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "TOOL_OFFSET";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ToolOffsetClass" />.
		/// </summary>
