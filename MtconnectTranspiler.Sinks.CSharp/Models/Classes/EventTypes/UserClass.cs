...
{
	/// <summary>﻿<see cref="EventEnum.USER">EventEnum.USER</see><br /><br /><br />
	...
	public sealed class UserClass : IClass
	{
		/// <summary>Constant value for <see cref="UserClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218462_589955_2238";
		/// <summary>Constant value for <see cref="UserClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218462_589955_2238";
		/// <summary>Constant value for <see cref="UserClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::USER)}}&#10;
";
		/// <summary>Constant value for <see cref="UserClass.Name" /></summary>
		public const string NAME = "User";
		/// <summary>Constant value for <see cref="UserClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="UserClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="UserClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="UserClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new UserClassProperties Properties { get; } = new UserClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="UserClass" />.
		...
		/// </summary>
		public class UserClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "USER";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="UserClass" />.
		/// </summary>
