...
{
	/// <summary>﻿identifier given to a group of parts having similarities in geometry, manufacturing process, and/or functions.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="PartKindIdPartFamilyClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1605549487194_494116_1162";
		/// <summary>Constant value for <see cref="PartKindIdPartFamilyClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605549487194_494116_1162";
		/// <summary>Constant value for <see cref="PartKindIdPartFamilyClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;identifier given to a group of parts having similarities in geometry, manufacturing process, and/or functions.&#10;
";
		/// <summary>Constant value for <see cref="PartKindIdPartFamilyClass.Name" /></summary>
		public const string NAME = "PartKindId.PartFamily";
		/// <summary>Constant value for <see cref="PartKindIdPartFamilyClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PartKindIdPartFamilyClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PartKindIdPartFamilyClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.7";
		/// <summary>Constant value for <see cref="PartKindIdPartFamilyClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new PartKindIdPartFamilyClassProperties Properties { get; } = new PartKindIdPartFamilyClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="PartKindIdPartFamilyClass" />.
		...
		public class PartKindIdPartFamilyClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.PartKindIdClass.PartKindIdClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PART_FAMILY";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PartKindIdPartFamilyClass" />.
		/// </summary>
