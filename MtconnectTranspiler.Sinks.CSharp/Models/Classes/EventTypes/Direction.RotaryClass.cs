...
{
	/// <summary>﻿rotational direction of a rotary motion using the right hand rule convention.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="DirectionRotaryClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218280_535236_1758";
		/// <summary>Constant value for <see cref="DirectionRotaryClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218280_535236_1758";
		/// <summary>Constant value for <see cref="DirectionRotaryClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;rotational direction of a rotary motion using the right hand rule convention.&#10;
";
		/// <summary>Constant value for <see cref="DirectionRotaryClass.Name" /></summary>
		public const string NAME = "Direction.Rotary";
		/// <summary>Constant value for <see cref="DirectionRotaryClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DirectionRotaryClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DirectionRotaryClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="DirectionRotaryClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		/// <remarks>
		/// Original Type: _19_0_3_45f01b9_1580378218278_641962_1755
		/// </remarks>
		public Type Generalization => typeof(Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.DirectionClass);

		/// <inheritdoc />
		public new DirectionRotaryClassProperties Properties { get; } = new DirectionRotaryClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="DirectionRotaryClass" />.
		/// <br/><b>Note</b>, some properties (<see cref="IProperty" />) are inherited from <see cref="Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.DirectionClass.DirectionClassProperties" />.
		/// </summary>
		public class DirectionRotaryClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.DirectionClass.DirectionClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "ROTARY";
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: DirectionRotaryEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.DirectionRotaryEnumMetaClass);
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DirectionRotaryClass" />.
		/// </summary>
