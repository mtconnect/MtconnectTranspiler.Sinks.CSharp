...
{
	/// <summary>﻿<see cref="EventEnum.CONNECTION_STATUS">EventEnum.CONNECTION_STATUS</see><br /><br /><br />
	...
	public sealed class ConnectionStatusClass : IClass
	{
		/// <summary>Constant value for <see cref="ConnectionStatusClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1605104021452_397920_743";
		/// <summary>Constant value for <see cref="ConnectionStatusClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605104021452_397920_743";
		/// <summary>Constant value for <see cref="ConnectionStatusClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::CONNECTION_STATUS)}}&#10;
";
		/// <summary>Constant value for <see cref="ConnectionStatusClass.Name" /></summary>
		public const string NAME = "ConnectionStatus";
		/// <summary>Constant value for <see cref="ConnectionStatusClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ConnectionStatusClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ConnectionStatusClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.7";
		/// <summary>Constant value for <see cref="ConnectionStatusClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ConnectionStatusClassProperties Properties { get; } = new ConnectionStatusClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ConnectionStatusClass" />.
		...
		/// </summary>
		public class ConnectionStatusClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: ConnectionStatusEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.ConnectionStatusEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "CONNECTION_STATUS";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ConnectionStatusClass" />.
		/// </summary>
