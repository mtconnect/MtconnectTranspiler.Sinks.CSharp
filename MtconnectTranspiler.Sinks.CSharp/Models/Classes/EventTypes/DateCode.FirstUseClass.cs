...
{
	/// <summary>﻿time and date code relating the first use of a material or other physical item.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="DateCodeFirstUseClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218256_219043_1701";
		/// <summary>Constant value for <see cref="DateCodeFirstUseClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218256_219043_1701";
		/// <summary>Constant value for <see cref="DateCodeFirstUseClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;time and date code relating the first use of a material or other physical item.&#10;
";
		/// <summary>Constant value for <see cref="DateCodeFirstUseClass.Name" /></summary>
		public const string NAME = "DateCode.FirstUse";
		/// <summary>Constant value for <see cref="DateCodeFirstUseClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DateCodeFirstUseClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DateCodeFirstUseClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="DateCodeFirstUseClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new DateCodeFirstUseClassProperties Properties { get; } = new DateCodeFirstUseClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="DateCodeFirstUseClass" />.
		...
		public class DateCodeFirstUseClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.DateCodeClass.DateCodeClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "FIRST_USE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DateCodeFirstUseClass" />.
		/// </summary>
