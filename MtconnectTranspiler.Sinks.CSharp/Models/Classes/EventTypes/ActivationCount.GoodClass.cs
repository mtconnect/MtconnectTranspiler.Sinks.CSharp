...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes
{
	...
	public sealed class ActivationCountGoodClass : IClass
	{
		...
		/// <inheritdoc />
		public string Name => "ActivationCount.GoodClass";
		...
		/// <inheritdoc />
		public ActivationCountGoodClassProperties Properties { get; } = new ActivationCountGoodClassProperties();
        IPropertyList IClass.Properties => Properties;
		public sealed class ActivationCountGoodClassProperties : IPropertyList
		{
			/// <inheritdoc />
