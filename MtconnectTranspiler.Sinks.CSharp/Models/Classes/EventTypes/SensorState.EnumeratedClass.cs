...
{
	/// <summary>﻿<see cref="EventEnum.SENSOR_STATE">EventEnum.SENSOR_STATE</see> where the state is <see cref="DataItemSubTypeEnum.ENUMERATED">DataItemSubTypeEnum.ENUMERATED</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_68e0225_1677588817279_537934_783">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class SensorStateEnumeratedClass : IClass
	{
		/// <summary>Constant value for <see cref="SensorStateEnumeratedClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1677588817279_537934_783";
		/// <summary>Constant value for <see cref="SensorStateEnumeratedClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1677588817279_537934_783";
		/// <summary>Constant value for <see cref="SensorStateEnumeratedClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::SENSOR_STATE)}} where the state is {{def(DataItemSubTypeEnum::ENUMERATED)}}&#10;
";
		/// <summary>Constant value for <see cref="SensorStateEnumeratedClass.Name" /></summary>
		public const string NAME = "SensorState.Enumerated";
		/// <summary>Constant value for <see cref="SensorStateEnumeratedClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="SensorStateEnumeratedClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="SensorStateEnumeratedClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.2";
		/// <summary>Constant value for <see cref="SensorStateEnumeratedClass.DeprecatedVersion" /></summary>
		...
		public class SensorStateEnumeratedClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.SensorStateClass.SensorStateClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "ENUMERATED";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="SensorStateEnumeratedClass" />.
		/// </summary>
