...
{
	/// <summary>
	﻿/// <see cref="EventEnum.SENSOR_STATE">EventEnum.SENSOR_STATE</see> where the state is <see cref="DataItemSubTypeEnum.ENUMERATED">DataItemSubTypeEnum.ENUMERATED</see><br/><br />
