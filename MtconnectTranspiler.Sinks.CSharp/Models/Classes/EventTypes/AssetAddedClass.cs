...
{
	/// <summary>﻿<see cref="EventEnum.ASSET_ADDED">EventEnum.ASSET_ADDED</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___2024x_68e0225_1744799118784_270323_23376">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class AssetAddedClass : IClass
	{
		/// <summary>Constant value for <see cref="AssetAddedClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_2024x_68e0225_1744799118784_270323_23376";
		/// <summary>Constant value for <see cref="AssetAddedClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___2024x_68e0225_1744799118784_270323_23376";
		/// <summary>Constant value for <see cref="AssetAddedClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::ASSET_ADDED)}}&#10;
";
		/// <summary>Constant value for <see cref="AssetAddedClass.Name" /></summary>
		public const string NAME = "AssetAdded";
		/// <summary>Constant value for <see cref="AssetAddedClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="AssetAddedClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="AssetAddedClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.6";
		/// <summary>Constant value for <see cref="AssetAddedClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new AssetAddedClassProperties Properties { get; } = new AssetAddedClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="AssetAddedClass" />.
		...
		/// </summary>
		public class AssetAddedClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			/// <summary>﻿type of <see cref="Asset">Asset</see> added. See <see cref="Asset Information Model">Asset Information Model</see> for details on the <see cref="Asset">Asset</see> model.<br /><br /><br />
			/// </summary>
			public new sealed class AssetTypeProperty : IProperty
			{
				...
				public const string SUMMARY = @"&#10;&#10;&#10;type of {{block(Asset)}} added. See {{package(Asset Information Model)}} for details on the {{block(Asset)}} model.&#10;
";
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "ASSET_ADDED";
...
";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="AssetAddedClass" />.
		/// </summary>
