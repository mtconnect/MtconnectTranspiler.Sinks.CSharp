...
{
	/// <summary>﻿<see cref="EventEnum.NETWORK_PORT">EventEnum.NETWORK_PORT</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="NetworkPortClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1659031598181_501424_69";
		/// <summary>Constant value for <see cref="NetworkPortClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1659031598181_501424_69";
		/// <summary>Constant value for <see cref="NetworkPortClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::NETWORK_PORT)}}&#10;
";
		/// <summary>Constant value for <see cref="NetworkPortClass.Name" /></summary>
		public const string NAME = "NetworkPort";
		/// <summary>Constant value for <see cref="NetworkPortClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="NetworkPortClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="NetworkPortClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.1";
		/// <summary>Constant value for <see cref="NetworkPortClass.DeprecatedVersion" /></summary>
		...
		/// </summary>
		public class NetworkPortClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "NETWORK_PORT";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="NetworkPortClass" />.
		/// </summary>
