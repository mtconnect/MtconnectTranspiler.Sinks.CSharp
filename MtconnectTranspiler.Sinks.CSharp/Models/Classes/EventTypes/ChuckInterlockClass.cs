...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes
{
	...
	{
		/// <summary>Constant value for <see cref="ChuckInterlockClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218212_381005_1611";
		/// <summary>Constant value for <see cref="ChuckInterlockClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218212_381005_1611";
		/// <summary>Constant value for <see cref="ChuckInterlockClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::CHUCK_INTERLOCK)}}&#10;
";
		/// <summary>Constant value for <see cref="ChuckInterlockClass.Name" /></summary>
		public const string NAME = "ChuckInterlock";
		/// <summary>Constant value for <see cref="ChuckInterlockClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ChuckInterlockClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ChuckInterlockClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="ChuckInterlockClass.DeprecatedVersion" /></summary>
		...
		public class ChuckInterlockClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: ChuckInterlockEnumMetaClass </remarks>
				/// </summary>
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "CHUCK_INTERLOCK";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ChuckInterlockClass" />.
		/// </summary>
