...
{
	/// <summary>﻿<see cref="EventEnum.BINDING_STATE">EventEnum.BINDING_STATE</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___2024x_68e0225_1760880056046_720411_4043">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class BindingStateClass : IClass
	{
		/// <summary>Constant value for <see cref="BindingStateClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_2024x_68e0225_1760880056046_720411_4043";
		/// <summary>Constant value for <see cref="BindingStateClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___2024x_68e0225_1760880056046_720411_4043";
		/// <summary>Constant value for <see cref="BindingStateClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::BINDING_STATE)}}&#10;
";
		/// <summary>Constant value for <see cref="BindingStateClass.Name" /></summary>
		public const string NAME = "BindingState";
		/// <summary>Constant value for <see cref="BindingStateClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="BindingStateClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="BindingStateClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.7";
		/// <summary>Constant value for <see cref="BindingStateClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new BindingStateClassProperties Properties { get; } = new BindingStateClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="BindingStateClass" />.
		...
		/// </summary>
		public class BindingStateClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: BindingStateEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.BindingStateEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "BINDING_STATE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="BindingStateClass" />.
		/// </summary>
