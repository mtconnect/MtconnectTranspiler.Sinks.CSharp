...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes
{
	...
	public sealed class NetworkVLanIdClass : IClass
	{
		...
		/// <inheritdoc />
		public string Summary => @"/// layer2 Virtual Local Network (VLAN) ID for the component network.";

		/// <inheritdoc />
		public string Name => "Network.VLanIdClass";
		...
		public sealed class NetworkVLanIdClassProperties : IPropertyList
		{
			/// <inheritdoc />
