...
{
	/// <summary>﻿layer2 Virtual Local Network (VLAN) ID for the component network.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="NetworkVLanIdClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_91b028d_1587752238033_807415_3815";
		/// <summary>Constant value for <see cref="NetworkVLanIdClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587752238033_807415_3815";
		/// <summary>Constant value for <see cref="NetworkVLanIdClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;layer2 Virtual Local Network (VLAN) ID for the component network.&#10;
";
		/// <summary>Constant value for <see cref="NetworkVLanIdClass.Name" /></summary>
		public const string NAME = "Network.VLanId";
		/// <summary>Constant value for <see cref="NetworkVLanIdClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="NetworkVLanIdClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="NetworkVLanIdClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.6";
		/// <summary>Constant value for <see cref="NetworkVLanIdClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new NetworkVLanIdClassProperties Properties { get; } = new NetworkVLanIdClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="NetworkVLanIdClass" />.
		...
		public class NetworkVLanIdClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.NetworkClass.NetworkClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "VLAN_ID";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="NetworkVLanIdClass" />.
		/// </summary>
