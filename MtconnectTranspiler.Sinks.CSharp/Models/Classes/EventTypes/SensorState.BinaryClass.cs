...
{
	/// <summary>﻿<see cref="EventEnum.SENSOR_STATE">EventEnum.SENSOR_STATE</see> where the state is <see cref="DataItemSubTypeEnum.BINARY">DataItemSubTypeEnum.BINARY</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_68e0225_1677588817279_722263_781">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class SensorStateBinaryClass : IClass
	{
		/// <summary>Constant value for <see cref="SensorStateBinaryClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1677588817279_722263_781";
		/// <summary>Constant value for <see cref="SensorStateBinaryClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1677588817279_722263_781";
		/// <summary>Constant value for <see cref="SensorStateBinaryClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::SENSOR_STATE)}} where the state is {{def(DataItemSubTypeEnum::BINARY)}}&#10;
";
		/// <summary>Constant value for <see cref="SensorStateBinaryClass.Name" /></summary>
		public const string NAME = "SensorState.Binary";
		/// <summary>Constant value for <see cref="SensorStateBinaryClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="SensorStateBinaryClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="SensorStateBinaryClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.2";
		/// <summary>Constant value for <see cref="SensorStateBinaryClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new SensorStateBinaryClassProperties Properties { get; } = new SensorStateBinaryClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="SensorStateBinaryClass" />.
		/// <br/><b>Note</b>, some properties (<see cref="IProperty" />) are inherited from <see cref="Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.SensorStateClass.SensorStateClassProperties" />.
		/// </summary>
		public class SensorStateBinaryClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.SensorStateClass.SensorStateClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "BINARY";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="SensorStateBinaryClass" />.
		/// </summary>
