...
{
	/// <summary>﻿<see cref="EventEnum.DOOR_STATE">EventEnum.DOOR_STATE</see><br /><br /><br />
	...
	public sealed class DoorStateClass : IClass
	{
		/// <summary>Constant value for <see cref="DoorStateClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218284_523548_1767";
		/// <summary>Constant value for <see cref="DoorStateClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218284_523548_1767";
		/// <summary>Constant value for <see cref="DoorStateClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::DOOR_STATE)}}&#10;
";
		/// <summary>Constant value for <see cref="DoorStateClass.Name" /></summary>
		public const string NAME = "DoorState";
		/// <summary>Constant value for <see cref="DoorStateClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DoorStateClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DoorStateClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.1";
		/// <summary>Constant value for <see cref="DoorStateClass.DeprecatedVersion" /></summary>
		...
		/// </summary>
		public class DoorStateClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: DoorStateEnumMetaClass </remarks>
				/// </summary>
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DOOR_STATE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DoorStateClass" />.
		/// </summary>
