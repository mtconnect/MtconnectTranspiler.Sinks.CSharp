...
{
	/// <summary>﻿date the hardware or software was released for general use. <br /><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587751251551_422984_2528">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class ApplicationReleaseDateClass : IClass
	{
		/// <summary>Constant value for <see cref="ApplicationReleaseDateClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_91b028d_1587751251551_422984_2528";
		/// <summary>Constant value for <see cref="ApplicationReleaseDateClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587751251551_422984_2528";
		/// <summary>Constant value for <see cref="ApplicationReleaseDateClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;date the hardware or software was released for general use. &#10;
";
		/// <summary>Constant value for <see cref="ApplicationReleaseDateClass.Name" /></summary>
		public const string NAME = "Application.ReleaseDate";
		/// <summary>Constant value for <see cref="ApplicationReleaseDateClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ApplicationReleaseDateClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ApplicationReleaseDateClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.6";
		/// <summary>Constant value for <see cref="ApplicationReleaseDateClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ApplicationReleaseDateClassProperties Properties { get; } = new ApplicationReleaseDateClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ApplicationReleaseDateClass" />.
		/// <br/><b>Note</b>, some properties (<see cref="IProperty" />) are inherited from <see cref="Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.ApplicationClass.ApplicationClassProperties" />.
		/// </summary>
		public class ApplicationReleaseDateClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.ApplicationClass.ApplicationClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "RELEASE_DATE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ApplicationReleaseDateClass" />.
		/// </summary>
