...
{
	/// <summary>﻿<see cref="EventEnum.POWER_SOURCE">EventEnum.POWER_SOURCE</see> that is <see cref="DataItemSubTypeEnum.SECONDARY">DataItemSubTypeEnum.SECONDARY</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="PowerSourceSecondaryClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1696872166479_807394_3679";
		/// <summary>Constant value for <see cref="PowerSourceSecondaryClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1696872166479_807394_3679";
		/// <summary>Constant value for <see cref="PowerSourceSecondaryClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::POWER_SOURCE)}} that is {{def(DataItemSubTypeEnum::SECONDARY)}}&#10;
";
		/// <summary>Constant value for <see cref="PowerSourceSecondaryClass.Name" /></summary>
		public const string NAME = "PowerSource.Secondary";
		/// <summary>Constant value for <see cref="PowerSourceSecondaryClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PowerSourceSecondaryClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PowerSourceSecondaryClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.3";
		/// <summary>Constant value for <see cref="PowerSourceSecondaryClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new PowerSourceSecondaryClassProperties Properties { get; } = new PowerSourceSecondaryClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="PowerSourceSecondaryClass" />.
		...
		public class PowerSourceSecondaryClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.PowerSourceClass.PowerSourceClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "SECONDARY";
