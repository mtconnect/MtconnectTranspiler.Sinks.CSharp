...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes
{
	...
	{
		/// <summary>Constant value for <see cref="ProgramLocationMainClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218428_40392_2121";
		/// <summary>Constant value for <see cref="ProgramLocationMainClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218428_40392_2121";
		/// <summary>Constant value for <see cref="ProgramLocationMainClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="ProgramLocationMainClass.Name" /></summary>
		public const string NAME = "ProgramLocation.Main";
		/// <summary>Constant value for <see cref="ProgramLocationMainClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ProgramLocationMainClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ProgramLocationMainClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="ProgramLocationMainClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ProgramLocationMainClassProperties Properties { get; } = new ProgramLocationMainClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ProgramLocationMainClass" />.
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ProgramLocationMainClass" />.
		/// </summary>
