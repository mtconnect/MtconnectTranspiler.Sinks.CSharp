...
{
	/// <summary>﻿<see cref="EventEnum.BLOCK_COUNT">EventEnum.BLOCK_COUNT</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218208_179832_1602">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class BlockCountClass : IClass
	{
		/// <summary>Constant value for <see cref="BlockCountClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218208_179832_1602";
		/// <summary>Constant value for <see cref="BlockCountClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218208_179832_1602";
		/// <summary>Constant value for <see cref="BlockCountClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::BLOCK_COUNT)}}&#10;
";
		/// <summary>Constant value for <see cref="BlockCountClass.Name" /></summary>
		public const string NAME = "BlockCount";
		/// <summary>Constant value for <see cref="BlockCountClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="BlockCountClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="BlockCountClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="BlockCountClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new BlockCountClassProperties Properties { get; } = new BlockCountClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="BlockCountClass" />.
		...
		/// </summary>
		public class BlockCountClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "BLOCK_COUNT";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="BlockCountClass" />.
		/// </summary>
