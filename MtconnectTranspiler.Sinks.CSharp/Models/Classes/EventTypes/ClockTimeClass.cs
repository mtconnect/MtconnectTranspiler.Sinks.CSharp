...
{
	/// <summary>﻿<see cref="EventEnum.CLOCK_TIME">EventEnum.CLOCK_TIME</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218216_670260_1620">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class ClockTimeClass : IClass
	{
		/// <summary>Constant value for <see cref="ClockTimeClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218216_670260_1620";
		/// <summary>Constant value for <see cref="ClockTimeClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218216_670260_1620";
		/// <summary>Constant value for <see cref="ClockTimeClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::CLOCK_TIME)}}&#10;
";
		/// <summary>Constant value for <see cref="ClockTimeClass.Name" /></summary>
		public const string NAME = "ClockTime";
		/// <summary>Constant value for <see cref="ClockTimeClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ClockTimeClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ClockTimeClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="ClockTimeClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ClockTimeClassProperties Properties { get; } = new ClockTimeClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ClockTimeClass" />.
		...
		/// </summary>
		public class ClockTimeClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "CLOCK_TIME";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ClockTimeClass" />.
		/// </summary>
