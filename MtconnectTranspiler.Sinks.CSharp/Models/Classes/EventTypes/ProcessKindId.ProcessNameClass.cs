...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes
{
	...
	{
		/// <summary>Constant value for <see cref="ProcessKindIdProcessNameClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1605550088194_398416_1794";
		/// <summary>Constant value for <see cref="ProcessKindIdProcessNameClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605550088194_398416_1794";
		/// <summary>Constant value for <see cref="ProcessKindIdProcessNameClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="ProcessKindIdProcessNameClass.Name" /></summary>
		public const string NAME = "ProcessKindId.ProcessName";
		/// <summary>Constant value for <see cref="ProcessKindIdProcessNameClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ProcessKindIdProcessNameClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ProcessKindIdProcessNameClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.7";
		/// <summary>Constant value for <see cref="ProcessKindIdProcessNameClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ProcessKindIdProcessNameClassProperties Properties { get; } = new ProcessKindIdProcessNameClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ProcessKindIdProcessNameClass" />.
		...
		public class ProcessKindIdProcessNameClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.ProcessKindIdClass.ProcessKindIdClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PROCESS_NAME";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ProcessKindIdProcessNameClass" />.
		/// </summary>
