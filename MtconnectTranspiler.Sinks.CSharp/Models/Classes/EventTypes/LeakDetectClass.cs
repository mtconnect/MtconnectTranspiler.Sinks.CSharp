...
{
	/// <summary>﻿<see cref="EventEnum.LEAK_DETECT">EventEnum.LEAK_DETECT</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="LeakDetectClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1659073414212_549101_96";
		/// <summary>Constant value for <see cref="LeakDetectClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1659073414212_549101_96";
		/// <summary>Constant value for <see cref="LeakDetectClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::LEAK_DETECT)}}&#10;
";
		/// <summary>Constant value for <see cref="LeakDetectClass.Name" /></summary>
		public const string NAME = "LeakDetect";
		/// <summary>Constant value for <see cref="LeakDetectClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="LeakDetectClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="LeakDetectClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.1";
		/// <summary>Constant value for <see cref="LeakDetectClass.DeprecatedVersion" /></summary>
		...
		/// </summary>
		public class LeakDetectClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: LeakDetectEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.LeakDetectEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "LEAK_DETECT";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="LeakDetectClass" />.
		/// </summary>
