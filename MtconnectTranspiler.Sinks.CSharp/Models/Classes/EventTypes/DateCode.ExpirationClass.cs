...
{
	/// <summary>﻿time and date code relating to the expiration or end of useful life for a material or other physical item.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="DateCodeExpirationClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218255_944717_1698";
		/// <summary>Constant value for <see cref="DateCodeExpirationClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218255_944717_1698";
		/// <summary>Constant value for <see cref="DateCodeExpirationClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;time and date code relating to the expiration or end of useful life for a material or other physical item.&#10;
";
		/// <summary>Constant value for <see cref="DateCodeExpirationClass.Name" /></summary>
		public const string NAME = "DateCode.Expiration";
		/// <summary>Constant value for <see cref="DateCodeExpirationClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DateCodeExpirationClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DateCodeExpirationClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="DateCodeExpirationClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new DateCodeExpirationClassProperties Properties { get; } = new DateCodeExpirationClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="DateCodeExpirationClass" />.
		/// <br/><b>Note</b>, some properties (<see cref="IProperty" />) are inherited from <see cref="Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.DateCodeClass.DateCodeClassProperties" />.
		/// </summary>
		public class DateCodeExpirationClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.DateCodeClass.DateCodeClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "EXPIRATION";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DateCodeExpirationClass" />.
		/// </summary>
