...
{
	/// <summary>﻿<see cref="EventEnum.AXIS_INTERLOCK">EventEnum.AXIS_INTERLOCK</see><br /><br /><br />
	...
	public sealed class AxisInterlockClass : IClass
	{
		/// <summary>Constant value for <see cref="AxisInterlockClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218203_465402_1593";
		/// <summary>Constant value for <see cref="AxisInterlockClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218203_465402_1593";
		/// <summary>Constant value for <see cref="AxisInterlockClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::AXIS_INTERLOCK)}}&#10;
";
		/// <summary>Constant value for <see cref="AxisInterlockClass.Name" /></summary>
		public const string NAME = "AxisInterlock";
		/// <summary>Constant value for <see cref="AxisInterlockClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="AxisInterlockClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="AxisInterlockClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="AxisInterlockClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new AxisInterlockClassProperties Properties { get; } = new AxisInterlockClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="AxisInterlockClass" />.
		...
		/// </summary>
		public class AxisInterlockClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: AxisInterlockEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.AxisInterlockEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "AXIS_INTERLOCK";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="AxisInterlockClass" />.
		/// </summary>
