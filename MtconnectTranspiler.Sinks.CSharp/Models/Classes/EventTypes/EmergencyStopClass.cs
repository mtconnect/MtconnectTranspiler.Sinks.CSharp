...
{
	/// <summary>﻿<see cref="EventEnum.EMERGENCY_STOP">EventEnum.EMERGENCY_STOP</see><br /><br /><br />
	...
	public sealed class EmergencyStopClass : IClass
	{
		/// <summary>Constant value for <see cref="EmergencyStopClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218286_842979_1773";
		/// <summary>Constant value for <see cref="EmergencyStopClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218286_842979_1773";
		/// <summary>Constant value for <see cref="EmergencyStopClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::EMERGENCY_STOP)}}&#10;
";
		/// <summary>Constant value for <see cref="EmergencyStopClass.Name" /></summary>
		public const string NAME = "EmergencyStop";
		/// <summary>Constant value for <see cref="EmergencyStopClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="EmergencyStopClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="EmergencyStopClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.1";
		/// <summary>Constant value for <see cref="EmergencyStopClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new EmergencyStopClassProperties Properties { get; } = new EmergencyStopClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="EmergencyStopClass" />.
		...
		/// </summary>
		public class EmergencyStopClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: EmergencyStopEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.EmergencyStopEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "EMERGENCY_STOP";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="EmergencyStopClass" />.
		/// </summary>
