...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes
{
	...
	public sealed class HardwareClass : IClass
	{
		/// <summary>Constant value for <see cref="HardwareClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_91b028d_1587751253562_643001_2625";
		/// <summary>Constant value for <see cref="HardwareClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587751253562_643001_2625";
		/// <summary>Constant value for <see cref="HardwareClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::HARDWARE)}}&#10;
";
		/// <summary>Constant value for <see cref="HardwareClass.Name" /></summary>
		public const string NAME = "Hardware";
		/// <summary>Constant value for <see cref="HardwareClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="HardwareClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="HardwareClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.6";
		/// <summary>Constant value for <see cref="HardwareClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new HardwareClassProperties Properties { get; } = new HardwareClassProperties();
		...
		public class HardwareClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "HARDWARE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="HardwareClass" />.
		/// </summary>
