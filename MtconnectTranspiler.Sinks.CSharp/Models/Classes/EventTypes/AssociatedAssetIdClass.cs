...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes
{
	...
	public sealed class AssociatedAssetIdClass : IClass
	{
		/// <summary>Constant value for <see cref="AssociatedAssetIdClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_2024x_68e0225_1744720952328_73710_24751";
		/// <summary>Constant value for <see cref="AssociatedAssetIdClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___2024x_68e0225_1744720952328_73710_24751";
		/// <summary>Constant value for <see cref="AssociatedAssetIdClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::ASSOCIATED_ASSET_ID)}}
...
";
		/// <summary>Constant value for <see cref="AssociatedAssetIdClass.Name" /></summary>
		public const string NAME = "AssociatedAssetId";
		/// <summary>Constant value for <see cref="AssociatedAssetIdClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="AssociatedAssetIdClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="AssociatedAssetIdClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.6";
		/// <summary>Constant value for <see cref="AssociatedAssetIdClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new AssociatedAssetIdClassProperties Properties { get; } = new AssociatedAssetIdClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="AssociatedAssetIdClass" />.
		...
		/// </summary>
		public class AssociatedAssetIdClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "ASSOCIATED_ASSET_ID";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="AssociatedAssetIdClass" />.
		/// </summary>
