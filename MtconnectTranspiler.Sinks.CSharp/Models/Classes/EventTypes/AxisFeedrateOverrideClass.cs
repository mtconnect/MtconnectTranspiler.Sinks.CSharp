...
{
	/// <summary>
	/// <see cref="EventEnum::AXIS_FEEDRATE_OVERRIDE">EventEnum::AXIS_FEEDRATE_OVERRIDE</see>
	...
	public sealed class AxisFeedrateOverrideClass : IClass
	{
		...
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""EventEnum::AXIS_FEEDRATE_OVERRIDE"">EventEnum::AXIS_FEEDRATE_OVERRIDE</see>";
