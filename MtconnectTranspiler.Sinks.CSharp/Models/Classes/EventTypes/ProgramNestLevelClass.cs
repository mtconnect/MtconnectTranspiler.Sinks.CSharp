...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes
{
	...
	{
		/// <summary>Constant value for <see cref="ProgramNestLevelClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218433_608443_2139";
		/// <summary>Constant value for <see cref="ProgramNestLevelClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218433_608443_2139";
		/// <summary>Constant value for <see cref="ProgramNestLevelClass.Summary" /></summary>
...
&#10;
";
		/// <summary>Constant value for <see cref="ProgramNestLevelClass.Name" /></summary>
		public const string NAME = "ProgramNestLevel";
		/// <summary>Constant value for <see cref="ProgramNestLevelClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ProgramNestLevelClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ProgramNestLevelClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="ProgramNestLevelClass.DeprecatedVersion" /></summary>
		...
		public class ProgramNestLevelClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PROGRAM_NEST_LEVEL";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ProgramNestLevelClass" />.
		/// </summary>
