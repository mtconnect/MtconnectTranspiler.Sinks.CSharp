...
{
	/// <summary>﻿<see cref="EventEnum.SENSOR_ATTACHMENT">EventEnum.SENSOR_ATTACHMENT</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605115194197_946259_1333">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class SensorAttachmentClass : IClass
	{
		/// <summary>Constant value for <see cref="SensorAttachmentClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1605115194197_946259_1333";
		/// <summary>Constant value for <see cref="SensorAttachmentClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605115194197_946259_1333";
		/// <summary>Constant value for <see cref="SensorAttachmentClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::SENSOR_ATTACHMENT)}}&#10;
";
		/// <summary>Constant value for <see cref="SensorAttachmentClass.Name" /></summary>
		public const string NAME = "SensorAttachment";
		/// <summary>Constant value for <see cref="SensorAttachmentClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="SensorAttachmentClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="SensorAttachmentClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.7";
		/// <summary>Constant value for <see cref="SensorAttachmentClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new SensorAttachmentClassProperties Properties { get; } = new SensorAttachmentClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="SensorAttachmentClass" />.
		...
		/// </summary>
		public class SensorAttachmentClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "SENSOR_ATTACHMENT";
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: SensorAttachmentResultClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.SensorAttachmentResultClass);
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="SensorAttachmentClass" />.
		/// </summary>
