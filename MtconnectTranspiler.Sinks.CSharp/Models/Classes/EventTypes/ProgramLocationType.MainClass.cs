...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes
{
	...
	{
		/// <summary>Constant value for <see cref="ProgramLocationTypeMainClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218431_68146_2133";
		/// <summary>Constant value for <see cref="ProgramLocationTypeMainClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218431_68146_2133";
		/// <summary>Constant value for <see cref="ProgramLocationTypeMainClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="ProgramLocationTypeMainClass.Name" /></summary>
		public const string NAME = "ProgramLocationType.Main";
		/// <summary>Constant value for <see cref="ProgramLocationTypeMainClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ProgramLocationTypeMainClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ProgramLocationTypeMainClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="ProgramLocationTypeMainClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ProgramLocationTypeMainClassProperties Properties { get; } = new ProgramLocationTypeMainClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ProgramLocationTypeMainClass" />.
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ProgramLocationTypeMainClass" />.
		/// </summary>
