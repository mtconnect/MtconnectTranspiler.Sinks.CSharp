...
{
	/// <summary>
	/// <see cref="EventEnum::PROGRAM_EDIT_NAME">EventEnum::PROGRAM_EDIT_NAME</see>
	/// </summary>
	...
	public sealed class ProgramEditNameClass : IClass
	{
		...
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""EventEnum::PROGRAM_EDIT_NAME"">EventEnum::PROGRAM_EDIT_NAME</see>";

		/// <inheritdoc />
		public string Name => "ProgramEditNameClass";
		...
		public sealed class ProgramEditNameClassProperties : IPropertyList
		{
			/// <inheritdoc />
