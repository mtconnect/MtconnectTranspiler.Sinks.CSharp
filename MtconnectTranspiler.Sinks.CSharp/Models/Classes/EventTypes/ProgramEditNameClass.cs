...
{
	/// <summary>﻿<see cref="EventEnum.PROGRAM_EDIT_NAME">EventEnum.PROGRAM_EDIT_NAME</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="ProgramEditNameClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218424_573300_2109";
		/// <summary>Constant value for <see cref="ProgramEditNameClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218424_573300_2109";
		/// <summary>Constant value for <see cref="ProgramEditNameClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::PROGRAM_EDIT_NAME)}}&#10;
";
		/// <summary>Constant value for <see cref="ProgramEditNameClass.Name" /></summary>
		public const string NAME = "ProgramEditName";
		/// <summary>Constant value for <see cref="ProgramEditNameClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ProgramEditNameClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ProgramEditNameClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="ProgramEditNameClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ProgramEditNameClassProperties Properties { get; } = new ProgramEditNameClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ProgramEditNameClass" />.
		...
		public class ProgramEditNameClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PROGRAM_EDIT_NAME";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ProgramEditNameClass" />.
		/// </summary>
