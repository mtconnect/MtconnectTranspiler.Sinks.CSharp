...
{
	/// <summary>﻿position of a block of program code relative to the beginning of the control program.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="LineNumberAbsoluteClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218340_564692_1896";
		/// <summary>Constant value for <see cref="LineNumberAbsoluteClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218340_564692_1896";
		/// <summary>Constant value for <see cref="LineNumberAbsoluteClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;position of a block of program code relative to the beginning of the control program.&#10;
";
		/// <summary>Constant value for <see cref="LineNumberAbsoluteClass.Name" /></summary>
		public const string NAME = "LineNumber.Absolute";
		/// <summary>Constant value for <see cref="LineNumberAbsoluteClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="LineNumberAbsoluteClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="LineNumberAbsoluteClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="LineNumberAbsoluteClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new LineNumberAbsoluteClassProperties Properties { get; } = new LineNumberAbsoluteClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="LineNumberAbsoluteClass" />.
		...
		/// </summary>
		public class LineNumberAbsoluteClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.LineNumberClass.LineNumberClassProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="LineNumberAbsoluteClass" />.
		/// </summary>
