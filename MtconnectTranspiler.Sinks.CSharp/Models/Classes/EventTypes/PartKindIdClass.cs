...
{
	/// <summary>﻿<see cref="EventEnum.PART_KIND_ID">EventEnum.PART_KIND_ID</see><br /><br />If no <see cref="DataItem.subType">subType in DataItem</see> is specified, <c>UUID</c> is default.<br /><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605549230052_910367_748">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	{
		/// <summary>Constant value for <see cref="PartKindIdClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1605549230052_910367_748";
		/// <summary>Constant value for <see cref="PartKindIdClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605549230052_910367_748";
		/// <summary>Constant value for <see cref="PartKindIdClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::PART_KIND_ID)}}

If no {{property(DataItem::subType)}} is specified, `UUID` is default.&#10;
";
		/// <summary>Constant value for <see cref="PartKindIdClass.Name" /></summary>
		public const string NAME = "PartKindId";
		/// <summary>Constant value for <see cref="PartKindIdClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PartKindIdClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PartKindIdClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.7";
		/// <summary>Constant value for <see cref="PartKindIdClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new PartKindIdClassProperties Properties { get; } = new PartKindIdClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="PartKindIdClass" />.
		...
		/// </summary>
		public class PartKindIdClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PART_KIND_ID";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PartKindIdClass" />.
		/// </summary>
