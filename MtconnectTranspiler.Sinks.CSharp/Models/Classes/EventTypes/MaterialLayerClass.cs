...
{
	/// <summary>﻿<see cref="EventEnum.MATERIAL_LAYER">EventEnum.MATERIAL_LAYER</see><br /><br /><br />
	...
	public sealed class MaterialLayerClass : IClass
	{
		/// <summary>Constant value for <see cref="MaterialLayerClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218348_114353_1917";
		/// <summary>Constant value for <see cref="MaterialLayerClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218348_114353_1917";
		/// <summary>Constant value for <see cref="MaterialLayerClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::MATERIAL_LAYER)}}&#10;
";
		/// <summary>Constant value for <see cref="MaterialLayerClass.Name" /></summary>
		public const string NAME = "MaterialLayer";
		/// <summary>Constant value for <see cref="MaterialLayerClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="MaterialLayerClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="MaterialLayerClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="MaterialLayerClass.DeprecatedVersion" /></summary>
		...
		/// </summary>
		public class MaterialLayerClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "MATERIAL_LAYER";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="MaterialLayerClass" />.
		/// </summary>
