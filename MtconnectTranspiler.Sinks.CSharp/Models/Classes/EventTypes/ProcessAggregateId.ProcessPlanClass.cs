...
{
	/// <summary>﻿identifier of the process plan that this occurrence belongs to. Synonyms include "routing id", "job id".<br /><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="ProcessAggregateIdProcessPlanClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1605549941144_813107_1698";
		/// <summary>Constant value for <see cref="ProcessAggregateIdProcessPlanClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605549941144_813107_1698";
		/// <summary>Constant value for <see cref="ProcessAggregateIdProcessPlanClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;identifier of the process plan that this occurrence belongs to. Synonyms include ""routing id"", ""job id"".&#10;
";
		/// <summary>Constant value for <see cref="ProcessAggregateIdProcessPlanClass.Name" /></summary>
		public const string NAME = "ProcessAggregateId.ProcessPlan";
		/// <summary>Constant value for <see cref="ProcessAggregateIdProcessPlanClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ProcessAggregateIdProcessPlanClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ProcessAggregateIdProcessPlanClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.7";
		/// <summary>Constant value for <see cref="ProcessAggregateIdProcessPlanClass.DeprecatedVersion" /></summary>
		...
		public class ProcessAggregateIdProcessPlanClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.ProcessAggregateIdClass.ProcessAggregateIdClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PROCESS_PLAN";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ProcessAggregateIdProcessPlanClass" />.
		/// </summary>
