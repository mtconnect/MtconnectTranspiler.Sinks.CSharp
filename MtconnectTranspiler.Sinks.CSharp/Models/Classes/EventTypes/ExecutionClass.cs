...
{
	/// <summary>﻿<see cref="EventEnum.EXECUTION">EventEnum.EXECUTION</see><br /><br /><br />
	...
	public sealed class ExecutionClass : IClass
	{
		/// <summary>Constant value for <see cref="ExecutionClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218306_196644_1821";
		/// <summary>Constant value for <see cref="ExecutionClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218306_196644_1821";
		/// <summary>Constant value for <see cref="ExecutionClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::EXECUTION)}}&#10;
";
		/// <summary>Constant value for <see cref="ExecutionClass.Name" /></summary>
		public const string NAME = "Execution";
		/// <summary>Constant value for <see cref="ExecutionClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ExecutionClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ExecutionClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.0";
		/// <summary>Constant value for <see cref="ExecutionClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ExecutionClassProperties Properties { get; } = new ExecutionClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ExecutionClass" />.
		...
		/// </summary>
		public class ExecutionClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: ExecutionEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.ExecutionEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "EXECUTION";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ExecutionClass" />.
		/// </summary>
