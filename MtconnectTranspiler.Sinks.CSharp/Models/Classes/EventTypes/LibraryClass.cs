...
{
	/// <summary>﻿<see cref="EventEnum.LIBRARY">EventEnum.LIBRARY</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587751252597_838265_2577">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class LibraryClass : IClass
	{
		/// <summary>Constant value for <see cref="LibraryClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_91b028d_1587751252597_838265_2577";
		/// <summary>Constant value for <see cref="LibraryClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587751252597_838265_2577";
		/// <summary>Constant value for <see cref="LibraryClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::LIBRARY)}}&#10;
";
		/// <summary>Constant value for <see cref="LibraryClass.Name" /></summary>
		public const string NAME = "Library";
		/// <summary>Constant value for <see cref="LibraryClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="LibraryClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="LibraryClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.6";
		/// <summary>Constant value for <see cref="LibraryClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new LibraryClassProperties Properties { get; } = new LibraryClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="LibraryClass" />.
		...
		/// </summary>
		public class LibraryClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "LIBRARY";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="LibraryClass" />.
		/// </summary>
