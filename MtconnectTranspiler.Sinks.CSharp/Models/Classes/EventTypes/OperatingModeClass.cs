...
{
	/// <summary>﻿<see cref="EventEnum.OPERATING_MODE">EventEnum.OPERATING_MODE</see><br /><br /><br />
	...
	public sealed class OperatingModeClass : IClass
	{
		/// <summary>Constant value for <see cref="OperatingModeClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1637936881318_547715_125";
		/// <summary>Constant value for <see cref="OperatingModeClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1637936881318_547715_125";
		/// <summary>Constant value for <see cref="OperatingModeClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::OPERATING_MODE)}}&#10;
";
		/// <summary>Constant value for <see cref="OperatingModeClass.Name" /></summary>
		public const string NAME = "OperatingMode";
		/// <summary>Constant value for <see cref="OperatingModeClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="OperatingModeClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="OperatingModeClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.0";
		/// <summary>Constant value for <see cref="OperatingModeClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new OperatingModeClassProperties Properties { get; } = new OperatingModeClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="OperatingModeClass" />.
		...
		/// </summary>
		public class OperatingModeClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: OperatingModeEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.OperatingModeEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "OPERATING_MODE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="OperatingModeClass" />.
		/// </summary>
