...
{
	/// <summary>﻿<see cref="EventEnum.PART_COUNT">EventEnum.PART_COUNT</see><br /><br /><br />
	...
	public sealed class PartCountClass : IClass
	{
		/// <summary>Constant value for <see cref="PartCountClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218363_437912_1953";
		/// <summary>Constant value for <see cref="PartCountClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218363_437912_1953";
		/// <summary>Constant value for <see cref="PartCountClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::PART_COUNT)}}&#10;
";
		/// <summary>Constant value for <see cref="PartCountClass.Name" /></summary>
		public const string NAME = "PartCount";
		/// <summary>Constant value for <see cref="PartCountClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PartCountClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PartCountClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.0";
		/// <summary>Constant value for <see cref="PartCountClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new PartCountClassProperties Properties { get; } = new PartCountClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="PartCountClass" />.
		...
		/// </summary>
		public class PartCountClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PART_COUNT";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PartCountClass" />.
		/// </summary>
