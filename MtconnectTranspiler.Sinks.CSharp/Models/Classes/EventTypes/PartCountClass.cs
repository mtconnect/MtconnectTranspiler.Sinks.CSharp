...
{
	/// <summary>
	/// <see cref="EventEnum::PART_COUNT">EventEnum::PART_COUNT</see>
	...
	{
		/// <inheritdoc />
		public string ReferenceId => "_19_0_3_45f01b9_1580378218363_437912_1953";
		
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""EventEnum::PART_COUNT"">EventEnum::PART_COUNT</see>";

		/// <inheritdoc />
		public string Name => "PartCount";
		...
		/// <inheritdoc />
		public PartCountClassProperties Properties { get; } = new PartCountClassProperties();
		...
		public class PartCountClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			...
			public sealed class TypeProperty : IProperty
			{
				...
				// Note: DefaultValue.Name
				/// <inheritdoc />
				public string DefaultValue => "PART_COUNT";
			}
			/// <summary>
