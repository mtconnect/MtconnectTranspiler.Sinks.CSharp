...
{
	/// <summary>﻿<see cref="EventEnum.LINE_NUMBER">EventEnum.LINE_NUMBER</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218338_357401_1893">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class LineNumberClass : IClass
	{
		/// <summary>Constant value for <see cref="LineNumberClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218338_357401_1893";
		/// <summary>Constant value for <see cref="LineNumberClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218338_357401_1893";
		/// <summary>Constant value for <see cref="LineNumberClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::LINE_NUMBER)}}&#10;
";
		/// <summary>Constant value for <see cref="LineNumberClass.Name" /></summary>
		public const string NAME = "LineNumber";
		/// <summary>Constant value for <see cref="LineNumberClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="LineNumberClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="LineNumberClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="LineNumberClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new LineNumberClassProperties Properties { get; } = new LineNumberClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="LineNumberClass" />.
		...
		/// </summary>
		public class LineNumberClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "LINE_NUMBER";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="LineNumberClass" />.
		/// </summary>
