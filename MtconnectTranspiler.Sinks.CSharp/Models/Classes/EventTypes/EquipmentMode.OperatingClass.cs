...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes
{
	...
	{
		/// <summary>Constant value for <see cref="EquipmentModeOperatingClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218295_856400_1794";
		/// <summary>Constant value for <see cref="EquipmentModeOperatingClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218295_856400_1794";
		/// <summary>Constant value for <see cref="EquipmentModeOperatingClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="EquipmentModeOperatingClass.Name" /></summary>
		public const string NAME = "EquipmentMode.Operating";
		/// <summary>Constant value for <see cref="EquipmentModeOperatingClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="EquipmentModeOperatingClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="EquipmentModeOperatingClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="EquipmentModeOperatingClass.DeprecatedVersion" /></summary>
		...
		public class EquipmentModeOperatingClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.EquipmentModeClass.EquipmentModeClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "OPERATING";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="EquipmentModeOperatingClass" />.
		/// </summary>
