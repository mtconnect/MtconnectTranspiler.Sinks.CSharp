...
{
	/// <summary>﻿<see cref="EventEnum.BATTERY_STATE">EventEnum.BATTERY_STATE</see><br /><br /><br />
	...
	public sealed class BatteryStateClass : IClass
	{
		/// <summary>Constant value for <see cref="BatteryStateClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1660319644994_162266_445";
		/// <summary>Constant value for <see cref="BatteryStateClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1660319644994_162266_445";
		/// <summary>Constant value for <see cref="BatteryStateClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::BATTERY_STATE)}}&#10;
";
		/// <summary>Constant value for <see cref="BatteryStateClass.Name" /></summary>
		public const string NAME = "BatteryState";
		/// <summary>Constant value for <see cref="BatteryStateClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="BatteryStateClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="BatteryStateClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.1";
		/// <summary>Constant value for <see cref="BatteryStateClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new BatteryStateClassProperties Properties { get; } = new BatteryStateClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="BatteryStateClass" />.
		...
		/// </summary>
		public class BatteryStateClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: BatteryStateEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.BatteryStateEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "BATTERY_STATE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="BatteryStateClass" />.
		/// </summary>
