...
{
	/// <summary>﻿<see cref="EventEnum.HARDNESS">EventEnum.HARDNESS</see><br /><br /><br />
	...
	public sealed class HardnessClass : IClass
	{
		/// <summary>Constant value for <see cref="HardnessClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218314_342350_1839";
		/// <summary>Constant value for <see cref="HardnessClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218314_342350_1839";
		/// <summary>Constant value for <see cref="HardnessClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::HARDNESS)}}&#10;
";
		/// <summary>Constant value for <see cref="HardnessClass.Name" /></summary>
		public const string NAME = "Hardness";
		/// <summary>Constant value for <see cref="HardnessClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="HardnessClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="HardnessClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="HardnessClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new HardnessClassProperties Properties { get; } = new HardnessClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="HardnessClass" />.
		...
		/// </summary>
		public class HardnessClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "HARDNESS";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="HardnessClass" />.
		/// </summary>
