...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes
{
	...
	public sealed class DepthCutClass : IClass
	{
		...
		public const string REFERENCE_ID = "_2024x_68e0225_1760962181131_97195_478";
...
";
		...
		/// <summary>Constant value for <see cref="DepthCutClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="DepthCutClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="DepthCutClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.7";
		/// <summary>Constant value for <see cref="DepthCutClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new DepthCutClassProperties Properties { get; } = new DepthCutClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="DepthCutClass" />.
		...
		/// </summary>
		public class DepthCutClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.DepthClass.DepthClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "CUT";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="DepthCutClass" />.
		/// </summary>
