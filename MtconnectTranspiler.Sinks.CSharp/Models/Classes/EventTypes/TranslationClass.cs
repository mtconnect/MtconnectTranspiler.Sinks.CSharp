...
{
	/// <summary>
	/// <see cref="EventEnum::TRANSLATION">EventEnum::TRANSLATION</see>
	...
	public sealed class TranslationClass : IClass
	{
		...
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""EventEnum::TRANSLATION"">EventEnum::TRANSLATION</see>";
		...
		public class TranslationClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			...
			public sealed class TypeProperty : IProperty
			{
				...
				// Note: DefaultValue.Name
				/// <inheritdoc />
				public string DefaultValue => "TRANSLATION";
			}
			/// <summary>
