...
{
	/// <summary>﻿<see cref="EventEnum.FUNCTIONAL_MODE">EventEnum.FUNCTIONAL_MODE</see><br /><br /><br />
	...
	public sealed class FunctionalModeClass : IClass
	{
		/// <summary>Constant value for <see cref="FunctionalModeClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218312_721573_1833";
		/// <summary>Constant value for <see cref="FunctionalModeClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218312_721573_1833";
		/// <summary>Constant value for <see cref="FunctionalModeClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::FUNCTIONAL_MODE)}}&#10;
";
		/// <summary>Constant value for <see cref="FunctionalModeClass.Name" /></summary>
		public const string NAME = "FunctionalMode";
		/// <summary>Constant value for <see cref="FunctionalModeClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="FunctionalModeClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="FunctionalModeClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="FunctionalModeClass.DeprecatedVersion" /></summary>
		...
		/// </summary>
		public class FunctionalModeClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: FunctionalModeEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.FunctionalModeEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "FUNCTIONAL_MODE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="FunctionalModeClass" />.
		/// </summary>
