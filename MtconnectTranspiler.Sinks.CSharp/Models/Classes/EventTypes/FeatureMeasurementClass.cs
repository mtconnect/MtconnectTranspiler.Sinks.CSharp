...
{
	/// <summary>﻿tabular representation of <see cref="EventEnum.FEATURE_MEASUREMENT">EventEnum.FEATURE_MEASUREMENT</see><br /><br /><see cref="FeatureMeasurement">FeatureMeasurement</see> <b>MAY</b> include a <i>characteristic</i> in which case it <b>MAY</b> include a <c>CHARACTERISTIC_STATUS</c>.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="FeatureMeasurementClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1678194652938_418535_17145";
		/// <summary>Constant value for <see cref="FeatureMeasurementClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1678194652938_418535_17145";
		/// <summary>Constant value for <see cref="FeatureMeasurementClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="FeatureMeasurementClass.Name" /></summary>
		public const string NAME = "FeatureMeasurement";
		/// <summary>Constant value for <see cref="FeatureMeasurementClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="FeatureMeasurementClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="FeatureMeasurementClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.2";
		/// <summary>Constant value for <see cref="FeatureMeasurementClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new FeatureMeasurementClassProperties Properties { get; } = new FeatureMeasurementClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="FeatureMeasurementClass" />.
		...
		public class FeatureMeasurementClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "FEATURE_MEASUREMENT";
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: FeatureMeasurementResultClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.FeatureMeasurementResultClass);
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="FeatureMeasurementClass" />.
		/// </summary>
