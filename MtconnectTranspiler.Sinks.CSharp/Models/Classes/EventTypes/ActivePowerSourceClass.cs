...
{
	/// <summary>﻿<see cref="EventEnum.ACTIVE_POWER_SOURCE">EventEnum.ACTIVE_POWER_SOURCE</see><br /><br /><br />
	...
	public sealed class ActivePowerSourceClass : IClass
	{
		/// <summary>Constant value for <see cref="ActivePowerSourceClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1696872166478_3528_3677";
		/// <summary>Constant value for <see cref="ActivePowerSourceClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1696872166478_3528_3677";
		/// <summary>Constant value for <see cref="ActivePowerSourceClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::ACTIVE_POWER_SOURCE)}}&#10;
";
		/// <summary>Constant value for <see cref="ActivePowerSourceClass.Name" /></summary>
		public const string NAME = "ActivePowerSource";
		/// <summary>Constant value for <see cref="ActivePowerSourceClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ActivePowerSourceClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ActivePowerSourceClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.3";
		/// <summary>Constant value for <see cref="ActivePowerSourceClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ActivePowerSourceClassProperties Properties { get; } = new ActivePowerSourceClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ActivePowerSourceClass" />.
		...
		/// </summary>
		public class ActivePowerSourceClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			/// <summary>﻿name of the power source referring to <see cref="Configuration">Configuration</see> <see cref="PowerSource.value">value in PowerSource</see>.<br /><br /><br />
			/// </summary>
			public new sealed class ResultProperty : IProperty
			{
				...
				public const string SUMMARY = @"&#10;&#10;&#10;name of the power source referring to {{block(Configuration)}} {{property(PowerSource::value)}}.&#10;
";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ActivePowerSourceClass" />.
		/// </summary>
