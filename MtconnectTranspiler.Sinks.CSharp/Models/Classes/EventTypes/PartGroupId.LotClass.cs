...
{
	/// <summary>﻿identifier that references a group of parts tracked as a lot.<br /><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="PartGroupIdLotClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1605549060880_815075_556";
		/// <summary>Constant value for <see cref="PartGroupIdLotClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605549060880_815075_556";
		/// <summary>Constant value for <see cref="PartGroupIdLotClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;identifier that references a group of parts tracked as a lot.&#10;
";
		/// <summary>Constant value for <see cref="PartGroupIdLotClass.Name" /></summary>
		public const string NAME = "PartGroupId.Lot";
		/// <summary>Constant value for <see cref="PartGroupIdLotClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PartGroupIdLotClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PartGroupIdLotClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.7";
		/// <summary>Constant value for <see cref="PartGroupIdLotClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new PartGroupIdLotClassProperties Properties { get; } = new PartGroupIdLotClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="PartGroupIdLotClass" />.
		...
		public class PartGroupIdLotClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.PartGroupIdClass.PartGroupIdClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "LOT";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PartGroupIdLotClass" />.
		/// </summary>
