...
{
	/// <summary>﻿<see cref="EventEnum.CHUCK_STATE">EventEnum.CHUCK_STATE</see><br /><br /><br />
	...
	public sealed class ChuckStateClass : IClass
	{
		/// <summary>Constant value for <see cref="ChuckStateClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218215_224787_1617";
		/// <summary>Constant value for <see cref="ChuckStateClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218215_224787_1617";
		/// <summary>Constant value for <see cref="ChuckStateClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::CHUCK_STATE)}}&#10;
";
		/// <summary>Constant value for <see cref="ChuckStateClass.Name" /></summary>
		public const string NAME = "ChuckState";
		/// <summary>Constant value for <see cref="ChuckStateClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ChuckStateClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ChuckStateClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="ChuckStateClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ChuckStateClassProperties Properties { get; } = new ChuckStateClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ChuckStateClass" />.
		...
		/// </summary>
		public class ChuckStateClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: ChuckStateEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.ChuckStateEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "CHUCK_STATE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ChuckStateClass" />.
		/// </summary>
