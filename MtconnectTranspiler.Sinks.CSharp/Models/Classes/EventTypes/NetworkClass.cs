...
{
	/// <summary>﻿<see cref="EventEnum.NETWORK">EventEnum.NETWORK</see><br /><br /><br />
	...
	public sealed class NetworkClass : IClass
	{
		/// <summary>Constant value for <see cref="NetworkClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_91b028d_1587752011247_360664_3696";
		/// <summary>Constant value for <see cref="NetworkClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_91b028d_1587752011247_360664_3696";
		/// <summary>Constant value for <see cref="NetworkClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::NETWORK)}}&#10;
";
		/// <summary>Constant value for <see cref="NetworkClass.Name" /></summary>
		public const string NAME = "Network";
		/// <summary>Constant value for <see cref="NetworkClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="NetworkClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="NetworkClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.6";
		/// <summary>Constant value for <see cref="NetworkClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new NetworkClassProperties Properties { get; } = new NetworkClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="NetworkClass" />.
		...
		/// </summary>
		public class NetworkClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "NETWORK";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="NetworkClass" />.
		/// </summary>
