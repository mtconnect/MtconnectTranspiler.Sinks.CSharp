...
{
	/// <summary>﻿<see cref="EventEnum.AXIS_STATE">EventEnum.AXIS_STATE</see><br /><br /><br />
	...
	public sealed class AxisStateClass : IClass
	{
		/// <summary>Constant value for <see cref="AxisStateClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218205_154539_1596";
		/// <summary>Constant value for <see cref="AxisStateClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218205_154539_1596";
		/// <summary>Constant value for <see cref="AxisStateClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::AXIS_STATE)}}&#10;
";
		/// <summary>Constant value for <see cref="AxisStateClass.Name" /></summary>
		public const string NAME = "AxisState";
		/// <summary>Constant value for <see cref="AxisStateClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="AxisStateClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="AxisStateClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="AxisStateClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new AxisStateClassProperties Properties { get; } = new AxisStateClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="AxisStateClass" />.
		...
		/// </summary>
		public class AxisStateClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: AxisStateEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.AxisStateEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "AXIS_STATE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="AxisStateClass" />.
		/// </summary>
