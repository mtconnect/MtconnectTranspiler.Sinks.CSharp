...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes
{
	...
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218226_122905_1638">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class CompositionStateLateralClass : IClass
	{
		/// <summary>Constant value for <see cref="CompositionStateLateralClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218226_122905_1638";
		/// <summary>Constant value for <see cref="CompositionStateLateralClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218226_122905_1638";
		/// <summary>Constant value for <see cref="CompositionStateLateralClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;indication of the position of a mechanism that may move in a lateral direction.   &#10;
";
		/// <summary>Constant value for <see cref="CompositionStateLateralClass.Name" /></summary>
		public const string NAME = "CompositionState.Lateral";
		/// <summary>Constant value for <see cref="CompositionStateLateralClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="CompositionStateLateralClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="CompositionStateLateralClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="CompositionStateLateralClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new CompositionStateLateralClassProperties Properties { get; } = new CompositionStateLateralClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="CompositionStateLateralClass" />.
		...
		/// </summary>
		public class CompositionStateLateralClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.CompositionStateClass.CompositionStateClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "LATERAL";
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: CompositionStateLateralEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.CompositionStateLateralEnumMetaClass);
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="CompositionStateLateralClass" />.
		/// </summary>
