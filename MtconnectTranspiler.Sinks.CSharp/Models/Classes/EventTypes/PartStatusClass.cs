...
{
	/// <summary>﻿<see cref="EventEnum.PART_STATUS">EventEnum.PART_STATUS</see><br /><br />If unique identifier is given, part status is for that individual. If group identifier is given without a unique identifier, then the status is assumed to be for the whole group.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="PartStatusClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1605549230538_92395_756";
		/// <summary>Constant value for <see cref="PartStatusClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1605549230538_92395_756";
		/// <summary>Constant value for <see cref="PartStatusClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="PartStatusClass.Name" /></summary>
		public const string NAME = "PartStatus";
		/// <summary>Constant value for <see cref="PartStatusClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PartStatusClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PartStatusClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.7";
		/// <summary>Constant value for <see cref="PartStatusClass.DeprecatedVersion" /></summary>
		...
		public class PartStatusClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: PartStatusEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.PartStatusEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PART_STATUS";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PartStatusClass" />.
		/// </summary>
