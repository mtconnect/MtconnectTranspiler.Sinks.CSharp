...
{
	/// <summary>﻿<see cref="EventEnum.PROCESS_TIME">EventEnum.PROCESS_TIME</see><br /><br /><br />
	...
	public sealed class ProcessTimeClass : IClass
	{
		/// <summary>Constant value for <see cref="ProcessTimeClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218411_953996_2079";
		/// <summary>Constant value for <see cref="ProcessTimeClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218411_953996_2079";
		/// <summary>Constant value for <see cref="ProcessTimeClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::PROCESS_TIME)}}&#10;
";
		/// <summary>Constant value for <see cref="ProcessTimeClass.Name" /></summary>
		public const string NAME = "ProcessTime";
		/// <summary>Constant value for <see cref="ProcessTimeClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ProcessTimeClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ProcessTimeClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="ProcessTimeClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ProcessTimeClassProperties Properties { get; } = new ProcessTimeClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ProcessTimeClass" />.
		...
		/// </summary>
		public class ProcessTimeClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PROCESS_TIME";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ProcessTimeClass" />.
		/// </summary>
