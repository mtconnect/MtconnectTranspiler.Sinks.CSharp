...
{
	/// <summary>﻿<see cref="EventEnum.CONTROLLER_MODE_OVERRIDE">EventEnum.CONTROLLER_MODE_OVERRIDE</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="ControllerModeOverrideClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218236_117661_1659";
		/// <summary>Constant value for <see cref="ControllerModeOverrideClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218236_117661_1659";
		/// <summary>Constant value for <see cref="ControllerModeOverrideClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::CONTROLLER_MODE_OVERRIDE)}}&#10;
";
		/// <summary>Constant value for <see cref="ControllerModeOverrideClass.Name" /></summary>
		public const string NAME = "ControllerModeOverride";
		/// <summary>Constant value for <see cref="ControllerModeOverrideClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ControllerModeOverrideClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ControllerModeOverrideClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="ControllerModeOverrideClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ControllerModeOverrideClassProperties Properties { get; } = new ControllerModeOverrideClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ControllerModeOverrideClass" />.
		...
		/// </summary>
		public class ControllerModeOverrideClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "CONTROLLER_MODE_OVERRIDE";
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: ControllerModeOverrideEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.ControllerModeOverrideEnumMetaClass);
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ControllerModeOverrideClass" />.
		/// </summary>
