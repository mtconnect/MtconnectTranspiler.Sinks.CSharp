...
{
	/// <summary>﻿<see cref="EventEnum.PROGRAM_HEADER">EventEnum.PROGRAM_HEADER</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218425_677557_2112">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class ProgramHeaderClass : IClass
	{
		/// <summary>Constant value for <see cref="ProgramHeaderClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218425_677557_2112";
		/// <summary>Constant value for <see cref="ProgramHeaderClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218425_677557_2112";
		/// <summary>Constant value for <see cref="ProgramHeaderClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::PROGRAM_HEADER)}}&#10;
";
		/// <summary>Constant value for <see cref="ProgramHeaderClass.Name" /></summary>
		public const string NAME = "ProgramHeader";
		/// <summary>Constant value for <see cref="ProgramHeaderClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ProgramHeaderClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ProgramHeaderClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="ProgramHeaderClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ProgramHeaderClassProperties Properties { get; } = new ProgramHeaderClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ProgramHeaderClass" />.
		...
		/// </summary>
		public class ProgramHeaderClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PROGRAM_HEADER";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ProgramHeaderClass" />.
		/// </summary>
