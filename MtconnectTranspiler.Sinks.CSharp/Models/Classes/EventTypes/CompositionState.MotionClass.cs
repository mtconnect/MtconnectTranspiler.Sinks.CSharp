...
{
	/// <summary>﻿indication of the open or closed state of a mechanism.<br /><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218227_296717_1641">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class CompositionStateMotionClass : IClass
	{
		/// <summary>Constant value for <see cref="CompositionStateMotionClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218227_296717_1641";
		/// <summary>Constant value for <see cref="CompositionStateMotionClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218227_296717_1641";
		/// <summary>Constant value for <see cref="CompositionStateMotionClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;indication of the open or closed state of a mechanism.
&#10;
";
		/// <summary>Constant value for <see cref="CompositionStateMotionClass.Name" /></summary>
		public const string NAME = "CompositionState.Motion";
		/// <summary>Constant value for <see cref="CompositionStateMotionClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="CompositionStateMotionClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="CompositionStateMotionClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="CompositionStateMotionClass.DeprecatedVersion" /></summary>
		...
		/// </summary>
		public class CompositionStateMotionClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.CompositionStateClass.CompositionStateClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "MOTION";
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: CompositionStateMotionEnumMetaClass </remarks>
				/// </summary>
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="CompositionStateMotionClass" />.
		/// </summary>
