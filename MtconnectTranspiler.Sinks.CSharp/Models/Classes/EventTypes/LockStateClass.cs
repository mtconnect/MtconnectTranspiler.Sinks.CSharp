...
{
	/// <summary>﻿<see cref="EventEnum.LOCK_STATE">EventEnum.LOCK_STATE</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="LockStateClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1622457702589_196111_730";
		/// <summary>Constant value for <see cref="LockStateClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1622457702589_196111_730";
		/// <summary>Constant value for <see cref="LockStateClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::LOCK_STATE)}}&#10;
";
		/// <summary>Constant value for <see cref="LockStateClass.Name" /></summary>
		public const string NAME = "LockState";
		/// <summary>Constant value for <see cref="LockStateClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="LockStateClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="LockStateClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.8";
		/// <summary>Constant value for <see cref="LockStateClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new LockStateClassProperties Properties { get; } = new LockStateClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="LockStateClass" />.
		...
		public class LockStateClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: LockStateEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.LockStateEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "LOCK_STATE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="LockStateClass" />.
		/// </summary>
