...
{
	/// <summary>﻿<see cref="EventEnum.ROTARY_VELOCITY_OVERRIDE">EventEnum.ROTARY_VELOCITY_OVERRIDE</see><br /><br />This command represents a percentage change to the velocity calculated by a logic or motion program or set by a switch for a <see cref="Rotary">Rotary</see> type axis.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="RotaryVelocityOverrideClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218440_585732_2163";
		/// <summary>Constant value for <see cref="RotaryVelocityOverrideClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218440_585732_2163";
		/// <summary>Constant value for <see cref="RotaryVelocityOverrideClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="RotaryVelocityOverrideClass.Name" /></summary>
		public const string NAME = "RotaryVelocityOverride";
		/// <summary>Constant value for <see cref="RotaryVelocityOverrideClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="RotaryVelocityOverrideClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="RotaryVelocityOverrideClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="RotaryVelocityOverrideClass.DeprecatedVersion" /></summary>
		...
		/// </summary>
		public class RotaryVelocityOverrideClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="RotaryVelocityOverrideClass" />.
		/// </summary>
