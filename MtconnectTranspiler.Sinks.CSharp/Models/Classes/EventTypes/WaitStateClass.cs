...
{
	/// <summary>﻿<see cref="EventEnum.WAIT_STATE">EventEnum.WAIT_STATE</see><br /><br />When <see cref="Execution.result">result in Execution</see> is not <c>WAIT</c>, <see cref="Observation.isUnavailable">isUnavailable in Observation</see> of <see cref="WaitState">WaitState</see> <b>MUST</b> be <c>true</c>.<br /><br /><br />
	...
	public sealed class WaitStateClass : IClass
	{
		...
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218483_193774_2298";
		/// <summary>Constant value for <see cref="WaitStateClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218483_193774_2298";
		/// <summary>Constant value for <see cref="WaitStateClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="WaitStateClass.Name" /></summary>
		public const string NAME = "WaitState";
		/// <summary>Constant value for <see cref="WaitStateClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="WaitStateClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="WaitStateClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="WaitStateClass.DeprecatedVersion" /></summary>
		...
		public class WaitStateClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: WaitStateEnumMetaClass </remarks>
				/// </summary>
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "WAIT_STATE";
