...
{
	/// <summary>﻿<see cref="EventEnum.SENSOR_STATE">EventEnum.SENSOR_STATE</see> where the state is <see cref="DataItemSubTypeEnum.BOOLEAN">DataItemSubTypeEnum.BOOLEAN</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="SensorStateBooleanClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1677588817279_198819_782";
		/// <summary>Constant value for <see cref="SensorStateBooleanClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1677588817279_198819_782";
		/// <summary>Constant value for <see cref="SensorStateBooleanClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::SENSOR_STATE)}} where the state is {{def(DataItemSubTypeEnum::BOOLEAN)}}&#10;
";
		/// <summary>Constant value for <see cref="SensorStateBooleanClass.Name" /></summary>
		public const string NAME = "SensorState.Boolean";
		/// <summary>Constant value for <see cref="SensorStateBooleanClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="SensorStateBooleanClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="SensorStateBooleanClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "2.2";
		/// <summary>Constant value for <see cref="SensorStateBooleanClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new SensorStateBooleanClassProperties Properties { get; } = new SensorStateBooleanClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="SensorStateBooleanClass" />.
		...
		public class SensorStateBooleanClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.SensorStateClass.SensorStateClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "BOOLEAN";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="SensorStateBooleanClass" />.
		/// </summary>
