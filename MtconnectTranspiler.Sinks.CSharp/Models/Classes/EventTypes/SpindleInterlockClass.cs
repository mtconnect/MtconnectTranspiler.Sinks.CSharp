...
{
	/// <summary>﻿<see cref="EventEnum.SPINDLE_INTERLOCK">EventEnum.SPINDLE_INTERLOCK</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218446_291783_2187">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class SpindleInterlockClass : IClass
	{
		/// <summary>Constant value for <see cref="SpindleInterlockClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218446_291783_2187";
		/// <summary>Constant value for <see cref="SpindleInterlockClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218446_291783_2187";
		/// <summary>Constant value for <see cref="SpindleInterlockClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::SPINDLE_INTERLOCK)}}&#10;
";
		/// <summary>Constant value for <see cref="SpindleInterlockClass.Name" /></summary>
		public const string NAME = "SpindleInterlock";
		/// <summary>Constant value for <see cref="SpindleInterlockClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="SpindleInterlockClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="SpindleInterlockClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="SpindleInterlockClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new SpindleInterlockClassProperties Properties { get; } = new SpindleInterlockClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="SpindleInterlockClass" />.
		...
		/// </summary>
		public class SpindleInterlockClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: SpindleInterlockEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.SpindleInterlockEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "SPINDLE_INTERLOCK";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="SpindleInterlockClass" />.
		/// </summary>
