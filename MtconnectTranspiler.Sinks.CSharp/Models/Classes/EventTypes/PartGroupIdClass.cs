...
{
	/// <summary>
	﻿/// <see cref="EventEnum.PART_GROUP_ID">EventEnum.PART_GROUP_ID</see><br /><br />If no <see cref="DataItem.subType">subType in DataItem</see> is specified, <c>UUID</c> is default.<br/><br />
