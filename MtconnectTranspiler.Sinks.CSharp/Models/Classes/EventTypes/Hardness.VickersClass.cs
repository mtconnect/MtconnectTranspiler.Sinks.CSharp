...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes
{
	...
	{
		/// <summary>Constant value for <see cref="HardnessVickersClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218318_467155_1845";
		/// <summary>Constant value for <see cref="HardnessVickersClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218318_467155_1845";
		/// <summary>Constant value for <see cref="HardnessVickersClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;scale to measure the resistance to deformation of a surface.&#10;
";
		/// <summary>Constant value for <see cref="HardnessVickersClass.Name" /></summary>
		public const string NAME = "Hardness.Vickers";
		/// <summary>Constant value for <see cref="HardnessVickersClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="HardnessVickersClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="HardnessVickersClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="HardnessVickersClass.DeprecatedVersion" /></summary>
		...
		public class HardnessVickersClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.HardnessClass.HardnessClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "VICKERS";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="HardnessVickersClass" />.
		/// </summary>
