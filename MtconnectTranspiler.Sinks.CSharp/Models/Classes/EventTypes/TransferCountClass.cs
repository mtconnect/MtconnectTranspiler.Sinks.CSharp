...
{
	/// <summary>﻿<see cref="EventEnum.TRANSFER_COUNT">EventEnum.TRANSFER_COUNT</see><br /><br /><br />
	...
	public sealed class TransferCountClass : IClass
	{
		/// <summary>Constant value for <see cref="TransferCountClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1622197600319_862998_718";
		/// <summary>Constant value for <see cref="TransferCountClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1622197600319_862998_718";
		/// <summary>Constant value for <see cref="TransferCountClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::TRANSFER_COUNT)}}&#10;
";
		/// <summary>Constant value for <see cref="TransferCountClass.Name" /></summary>
		public const string NAME = "TransferCount";
		/// <summary>Constant value for <see cref="TransferCountClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="TransferCountClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="TransferCountClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.8";
		/// <summary>Constant value for <see cref="TransferCountClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new TransferCountClassProperties Properties { get; } = new TransferCountClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="TransferCountClass" />.
		...
		/// </summary>
		public class TransferCountClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "TRANSFER_COUNT";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="TransferCountClass" />.
		/// </summary>
