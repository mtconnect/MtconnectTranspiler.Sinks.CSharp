...
{
	/// <summary>
	/// <see cref="EventEnum::MEASUREMENT_UNITS">EventEnum::MEASUREMENT_UNITS</see>
	...
	public sealed class MeasurementUnitsClass : IClass
	{
		...
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""EventEnum::MEASUREMENT_UNITS"">EventEnum::MEASUREMENT_UNITS</see>";
		...
		/// <inheritdoc />
		public MeasurementUnitsClassProperties Properties { get; } = new MeasurementUnitsClassProperties();
        IPropertyList IClass.Properties => Properties;
		public class MeasurementUnitsClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
