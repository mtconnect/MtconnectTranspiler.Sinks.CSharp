...
{
	/// <summary>﻿<see cref="EventEnum.PROCESS_STATE">EventEnum.PROCESS_STATE</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_68e0225_1622460054393_582789_1245">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class ProcessStateClass : IClass
	{
		/// <summary>Constant value for <see cref="ProcessStateClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1622460054393_582789_1245";
		/// <summary>Constant value for <see cref="ProcessStateClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1622460054393_582789_1245";
		/// <summary>Constant value for <see cref="ProcessStateClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::PROCESS_STATE)}}&#10;
";
		/// <summary>Constant value for <see cref="ProcessStateClass.Name" /></summary>
		public const string NAME = "ProcessState";
		/// <summary>Constant value for <see cref="ProcessStateClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ProcessStateClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ProcessStateClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.8";
		/// <summary>Constant value for <see cref="ProcessStateClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ProcessStateClassProperties Properties { get; } = new ProcessStateClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ProcessStateClass" />.
		...
		/// </summary>
		public class ProcessStateClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: ProcessStateEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.ProcessStateEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PROCESS_STATE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ProcessStateClass" />.
		/// </summary>
