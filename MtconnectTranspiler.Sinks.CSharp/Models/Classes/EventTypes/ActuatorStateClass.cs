...
{
	/// <summary>﻿<see cref="EventEnum.ACTUATOR_STATE">EventEnum.ACTUATOR_STATE</see><br /><br /><br />
	...
	public sealed class ActuatorStateClass : IClass
	{
		/// <summary>Constant value for <see cref="ActuatorStateClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218141_894098_1512";
		/// <summary>Constant value for <see cref="ActuatorStateClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218141_894098_1512";
		/// <summary>Constant value for <see cref="ActuatorStateClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::ACTUATOR_STATE)}}&#10;
";
		/// <summary>Constant value for <see cref="ActuatorStateClass.Name" /></summary>
		public const string NAME = "ActuatorState";
		/// <summary>Constant value for <see cref="ActuatorStateClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ActuatorStateClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ActuatorStateClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="ActuatorStateClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ActuatorStateClassProperties Properties { get; } = new ActuatorStateClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ActuatorStateClass" />.
		...
		/// </summary>
		public class ActuatorStateClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: ActuatorStateEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.ActuatorStateEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "ACTUATOR_STATE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ActuatorStateClass" />.
		/// </summary>
