...
{
	/// <summary>﻿<see cref="EventEnum.END_OF_BAR">EventEnum.END_OF_BAR</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218288_775940_1776">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class EndOfBarClass : IClass
	{
		/// <summary>Constant value for <see cref="EndOfBarClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218288_775940_1776";
		/// <summary>Constant value for <see cref="EndOfBarClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218288_775940_1776";
		/// <summary>Constant value for <see cref="EndOfBarClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::END_OF_BAR)}}&#10;
";
		/// <summary>Constant value for <see cref="EndOfBarClass.Name" /></summary>
		public const string NAME = "EndOfBar";
		/// <summary>Constant value for <see cref="EndOfBarClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="EndOfBarClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="EndOfBarClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="EndOfBarClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new EndOfBarClassProperties Properties { get; } = new EndOfBarClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="EndOfBarClass" />.
		...
		/// </summary>
		public class EndOfBarClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: EndOfBarEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.EndOfBarEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "END_OF_BAR";
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PRIMARY";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="EndOfBarClass" />.
		/// </summary>
