...
{
	/// <summary>﻿<see cref="EventEnum.TOOL_GROUP">EventEnum.TOOL_GROUP</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="ToolGroupClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218454_932545_2217";
		/// <summary>Constant value for <see cref="ToolGroupClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218454_932545_2217";
		/// <summary>Constant value for <see cref="ToolGroupClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::TOOL_GROUP)}}&#10;
";
		/// <summary>Constant value for <see cref="ToolGroupClass.Name" /></summary>
		public const string NAME = "ToolGroup";
		/// <summary>Constant value for <see cref="ToolGroupClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ToolGroupClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ToolGroupClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="ToolGroupClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ToolGroupClassProperties Properties { get; } = new ToolGroupClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ToolGroupClass" />.
		...
		public class ToolGroupClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "TOOL_GROUP";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ToolGroupClass" />.
		/// </summary>
