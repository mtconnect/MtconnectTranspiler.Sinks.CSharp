...
{
	/// <summary>﻿when multiple locations on a piece of bar stock are referenced as the indication for the <see cref="EndOfBar">EndOfBar</see>, the additional location(s) <b>MUST</b> be designated as <c>AUXILIARY</c> indication(s) for the <see cref="EndOfBar">EndOfBar</see>.  <br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="EndOfBarAuxiliaryClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218290_73647_1782";
		/// <summary>Constant value for <see cref="EndOfBarAuxiliaryClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218290_73647_1782";
		/// <summary>Constant value for <see cref="EndOfBarAuxiliaryClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="EndOfBarAuxiliaryClass.Name" /></summary>
		public const string NAME = "EndOfBar.Auxiliary";
		/// <summary>Constant value for <see cref="EndOfBarAuxiliaryClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="EndOfBarAuxiliaryClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="EndOfBarAuxiliaryClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="EndOfBarAuxiliaryClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new EndOfBarAuxiliaryClassProperties Properties { get; } = new EndOfBarAuxiliaryClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="EndOfBarAuxiliaryClass" />.
		...
		public class EndOfBarAuxiliaryClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.EndOfBarClass.EndOfBarClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "AUXILIARY";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="EndOfBarAuxiliaryClass" />.
		/// </summary>
