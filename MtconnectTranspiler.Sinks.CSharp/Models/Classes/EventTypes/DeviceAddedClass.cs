...
{
	/// <summary>
	/// <see cref="EventEnum::DEVICE_ADDED">EventEnum::DEVICE_ADDED</see>
	/// </summary>
	...
	public sealed class DeviceAddedClass : IClass
	{
		...
		/// <inheritdoc />
		public string Summary => @"/// <see cref=""EventEnum::DEVICE_ADDED"">EventEnum::DEVICE_ADDED</see>";

		/// <inheritdoc />
		public string Name => "DeviceAddedClass";
		...
		/// <inheritdoc />
		public DeviceAddedClassProperties Properties { get; } = new DeviceAddedClassProperties();
        IPropertyList IClass.Properties => Properties;
		public sealed class DeviceAddedClassProperties : IPropertyList
		{
			/// <inheritdoc />
