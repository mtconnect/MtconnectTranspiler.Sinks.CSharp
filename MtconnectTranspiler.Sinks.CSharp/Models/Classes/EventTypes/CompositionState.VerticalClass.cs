...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes
{
	...
	{
		/// <summary>Constant value for <see cref="CompositionStateVerticalClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218230_768917_1647";
		/// <summary>Constant value for <see cref="CompositionStateVerticalClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218230_768917_1647";
		/// <summary>Constant value for <see cref="CompositionStateVerticalClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;indication of the position of a mechanism that may move in a vertical direction.&#10;
";
		/// <summary>Constant value for <see cref="CompositionStateVerticalClass.Name" /></summary>
		public const string NAME = "CompositionState.Vertical";
		/// <summary>Constant value for <see cref="CompositionStateVerticalClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="CompositionStateVerticalClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="CompositionStateVerticalClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="CompositionStateVerticalClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new CompositionStateVerticalClassProperties Properties { get; } = new CompositionStateVerticalClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="CompositionStateVerticalClass" />.
		...
		public class CompositionStateVerticalClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.CompositionStateClass.CompositionStateClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "VERTICAL";
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: CompositionStateVerticalEnumMetaClass </remarks>
				/// </summary>
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="CompositionStateVerticalClass" />.
		/// </summary>
