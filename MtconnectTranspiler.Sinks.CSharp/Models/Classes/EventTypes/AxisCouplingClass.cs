...
{
	/// <summary>﻿<see cref="EventEnum.AXIS_COUPLING">EventEnum.AXIS_COUPLING</see><br /><br /><br />
	...
	public sealed class AxisCouplingClass : IClass
	{
		/// <summary>Constant value for <see cref="AxisCouplingClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218184_367826_1557";
		/// <summary>Constant value for <see cref="AxisCouplingClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218184_367826_1557";
		/// <summary>Constant value for <see cref="AxisCouplingClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::AXIS_COUPLING)}}&#10;
";
		/// <summary>Constant value for <see cref="AxisCouplingClass.Name" /></summary>
		public const string NAME = "AxisCoupling";
		/// <summary>Constant value for <see cref="AxisCouplingClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="AxisCouplingClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="AxisCouplingClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.1";
		/// <summary>Constant value for <see cref="AxisCouplingClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new AxisCouplingClassProperties Properties { get; } = new AxisCouplingClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="AxisCouplingClass" />.
		...
		/// </summary>
		public class AxisCouplingClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: AxisCouplingEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.AxisCouplingEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "AXIS_COUPLING";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="AxisCouplingClass" />.
		/// </summary>
