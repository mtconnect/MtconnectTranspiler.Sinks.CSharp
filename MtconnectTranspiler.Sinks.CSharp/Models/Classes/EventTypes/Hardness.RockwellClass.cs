...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes
{
	...
	{
		/// <summary>Constant value for <see cref="HardnessRockwellClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218316_492545_1842";
		/// <summary>Constant value for <see cref="HardnessRockwellClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218316_492545_1842";
		/// <summary>Constant value for <see cref="HardnessRockwellClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;scale to measure the resistance to deformation of a surface.&#10;
";
		/// <summary>Constant value for <see cref="HardnessRockwellClass.Name" /></summary>
		public const string NAME = "Hardness.Rockwell";
		/// <summary>Constant value for <see cref="HardnessRockwellClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="HardnessRockwellClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="HardnessRockwellClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="HardnessRockwellClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new HardnessRockwellClassProperties Properties { get; } = new HardnessRockwellClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="HardnessRockwellClass" />.
		...
		/// </summary>
		public class HardnessRockwellClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.HardnessClass.HardnessClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "ROCKWELL";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="HardnessRockwellClass" />.
		/// </summary>
