...
{
	/// <summary>﻿<see cref="EventEnum.ACTIVE_AXES">EventEnum.ACTIVE_AXES</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218138_831122_1509">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class ActiveAxesClass : IClass
	{
		/// <summary>Constant value for <see cref="ActiveAxesClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218138_831122_1509";
		/// <summary>Constant value for <see cref="ActiveAxesClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218138_831122_1509";
		/// <summary>Constant value for <see cref="ActiveAxesClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::ACTIVE_AXES)}}&#10;
";
		/// <summary>Constant value for <see cref="ActiveAxesClass.Name" /></summary>
		public const string NAME = "ActiveAxes";
		/// <summary>Constant value for <see cref="ActiveAxesClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ActiveAxesClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ActiveAxesClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.1";
		/// <summary>Constant value for <see cref="ActiveAxesClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ActiveAxesClassProperties Properties { get; } = new ActiveAxesClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ActiveAxesClass" />.
		...
		/// </summary>
		public class ActiveAxesClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "ACTIVE_AXES";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ActiveAxesClass" />.
		/// </summary>
