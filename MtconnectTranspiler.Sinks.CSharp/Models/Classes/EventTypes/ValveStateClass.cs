...
{
	/// <summary>﻿<see cref="EventEnum.VALVE_STATE">EventEnum.VALVE_STATE</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="ValveStateClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_68e0225_1622456026145_896882_60";
		/// <summary>Constant value for <see cref="ValveStateClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_68e0225_1622456026145_896882_60";
		/// <summary>Constant value for <see cref="ValveStateClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::VALVE_STATE)}}&#10;
";
		/// <summary>Constant value for <see cref="ValveStateClass.Name" /></summary>
		public const string NAME = "ValveState";
		/// <summary>Constant value for <see cref="ValveStateClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ValveStateClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ValveStateClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.8";
		/// <summary>Constant value for <see cref="ValveStateClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ValveStateClassProperties Properties { get; } = new ValveStateClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ValveStateClass" />.
		...
		/// </summary>
		public class ValveStateClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: ValveStateEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.ValveStateEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "VALVE_STATE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ValveStateClass" />.
		/// </summary>
