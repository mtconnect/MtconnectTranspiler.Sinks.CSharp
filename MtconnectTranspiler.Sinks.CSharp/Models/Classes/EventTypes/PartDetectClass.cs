...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes
{
	...
	{
		/// <summary>Constant value for <see cref="PartDetectClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218370_623546_1971";
		/// <summary>Constant value for <see cref="PartDetectClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218370_623546_1971";
		/// <summary>Constant value for <see cref="PartDetectClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::PART_DETECT)}}&#10;
";
		/// <summary>Constant value for <see cref="PartDetectClass.Name" /></summary>
		public const string NAME = "PartDetect";
		/// <summary>Constant value for <see cref="PartDetectClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PartDetectClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PartDetectClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="PartDetectClass.DeprecatedVersion" /></summary>
		...
		public class PartDetectClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: PartDetectEnumMetaClass </remarks>
				/// </summary>
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PART_DETECT";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PartDetectClass" />.
		/// </summary>
