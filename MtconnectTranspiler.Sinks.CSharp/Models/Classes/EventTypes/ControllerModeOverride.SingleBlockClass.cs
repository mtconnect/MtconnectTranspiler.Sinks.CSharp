...
{
	/// <summary>﻿setting or operator selection that changes the behavior of the controller on a piece of equipment. <br /><br />Program execution is paused after each block of code is executed when <c>SINGLE_BLOCK</c> is <c>ON</c>.   <br /><br />When <c>SINGLE_BLOCK</c> is <c>ON</c>, <see cref="Execution">Execution</see> <b>MUST</b> change to <c>INTERRUPTED</c> after completion of each block of code. <br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="ControllerModeOverrideSingleBlockClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218239_202787_1665";
		/// <summary>Constant value for <see cref="ControllerModeOverrideSingleBlockClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218239_202787_1665";
		/// <summary>Constant value for <see cref="ControllerModeOverrideSingleBlockClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="ControllerModeOverrideSingleBlockClass.Name" /></summary>
		public const string NAME = "ControllerModeOverride.SingleBlock";
		/// <summary>Constant value for <see cref="ControllerModeOverrideSingleBlockClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ControllerModeOverrideSingleBlockClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ControllerModeOverrideSingleBlockClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="ControllerModeOverrideSingleBlockClass.DeprecatedVersion" /></summary>
		...
		public class ControllerModeOverrideSingleBlockClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.ControllerModeOverrideClass.ControllerModeOverrideClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "SINGLE_BLOCK";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ControllerModeOverrideSingleBlockClass" />.
		/// </summary>
