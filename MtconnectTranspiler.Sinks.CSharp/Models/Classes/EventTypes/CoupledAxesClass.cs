...
{
	/// <summary>﻿<see cref="EventEnum.COUPLED_AXES">EventEnum.COUPLED_AXES</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218245_451201_1677">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	{
		/// <summary>Constant value for <see cref="CoupledAxesClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218245_451201_1677";
		/// <summary>Constant value for <see cref="CoupledAxesClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218245_451201_1677";
		/// <summary>Constant value for <see cref="CoupledAxesClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::COUPLED_AXES)}}&#10;
";
		/// <summary>Constant value for <see cref="CoupledAxesClass.Name" /></summary>
		public const string NAME = "CoupledAxes";
		/// <summary>Constant value for <see cref="CoupledAxesClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="CoupledAxesClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="CoupledAxesClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="CoupledAxesClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new CoupledAxesClassProperties Properties { get; } = new CoupledAxesClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="CoupledAxesClass" />.
		...
		/// </summary>
		public class CoupledAxesClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "COUPLED_AXES";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="CoupledAxesClass" />.
		/// </summary>
