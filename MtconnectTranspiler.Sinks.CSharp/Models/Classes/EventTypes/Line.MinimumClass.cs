...
{
	/// <summary>﻿minimum line number of the code being executed.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="LineMinimumClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218334_360453_1884";
		/// <summary>Constant value for <see cref="LineMinimumClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218334_360453_1884";
		/// <summary>Constant value for <see cref="LineMinimumClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;minimum line number of the code being executed.&#10;
";
		/// <summary>Constant value for <see cref="LineMinimumClass.Name" /></summary>
		public const string NAME = "Line.Minimum";
		/// <summary>Constant value for <see cref="LineMinimumClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="LineMinimumClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="LineMinimumClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.1";
		/// <summary>Constant value for <see cref="LineMinimumClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new LineMinimumClassProperties Properties { get; } = new LineMinimumClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="LineMinimumClass" />.
		...
		public class LineMinimumClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.LineClass.LineClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "MINIMUM";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="LineMinimumClass" />.
		/// </summary>
