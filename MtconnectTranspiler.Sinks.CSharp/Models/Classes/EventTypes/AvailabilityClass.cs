...
{
	/// <summary>﻿<see cref="EventEnum.AVAILABILITY">EventEnum.AVAILABILITY</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218181_310908_1554">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class AvailabilityClass : IClass
	{
		/// <summary>Constant value for <see cref="AvailabilityClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218181_310908_1554";
		/// <summary>Constant value for <see cref="AvailabilityClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218181_310908_1554";
		/// <summary>Constant value for <see cref="AvailabilityClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::AVAILABILITY)}}&#10;
";
		/// <summary>Constant value for <see cref="AvailabilityClass.Name" /></summary>
		public const string NAME = "Availability";
		/// <summary>Constant value for <see cref="AvailabilityClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="AvailabilityClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="AvailabilityClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.1";
		/// <summary>Constant value for <see cref="AvailabilityClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new AvailabilityClassProperties Properties { get; } = new AvailabilityClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="AvailabilityClass" />.
		...
		/// </summary>
		public class AvailabilityClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: AvailabilityEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.AvailabilityEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "AVAILABILITY";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="AvailabilityClass" />.
		/// </summary>
