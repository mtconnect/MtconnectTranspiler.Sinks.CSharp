...
{
	/// <summary>﻿<see cref="EventEnum.PROGRAM_LOCATION_TYPE">EventEnum.PROGRAM_LOCATION_TYPE</see><br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="ProgramLocationTypeClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218430_336265_2127";
		/// <summary>Constant value for <see cref="ProgramLocationTypeClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218430_336265_2127";
		/// <summary>Constant value for <see cref="ProgramLocationTypeClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::PROGRAM_LOCATION_TYPE)}}&#10;
";
		/// <summary>Constant value for <see cref="ProgramLocationTypeClass.Name" /></summary>
		public const string NAME = "ProgramLocationType";
		/// <summary>Constant value for <see cref="ProgramLocationTypeClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ProgramLocationTypeClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ProgramLocationTypeClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.5";
		/// <summary>Constant value for <see cref="ProgramLocationTypeClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ProgramLocationTypeClassProperties Properties { get; } = new ProgramLocationTypeClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ProgramLocationTypeClass" />.
		...
		public class ProgramLocationTypeClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "PROGRAM_LOCATION_TYPE";
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: ProgramLocationTypeEnumMetaClass </remarks>
				/// </summary>
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ProgramLocationTypeClass" />.
		/// </summary>
