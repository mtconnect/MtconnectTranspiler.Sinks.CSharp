...
{
	/// <summary>﻿<see cref="EventEnum.ROTARY_MODE">EventEnum.ROTARY_MODE</see><br /><br /><br />
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218435_352480_2145">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	public sealed class RotaryModeClass : IClass
	{
		/// <summary>Constant value for <see cref="RotaryModeClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218435_352480_2145";
		/// <summary>Constant value for <see cref="RotaryModeClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218435_352480_2145";
		/// <summary>Constant value for <see cref="RotaryModeClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::ROTARY_MODE)}}&#10;
";
		/// <summary>Constant value for <see cref="RotaryModeClass.Name" /></summary>
		public const string NAME = "RotaryMode";
		/// <summary>Constant value for <see cref="RotaryModeClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="RotaryModeClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="RotaryModeClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.1";
		/// <summary>Constant value for <see cref="RotaryModeClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new RotaryModeClassProperties Properties { get; } = new RotaryModeClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="RotaryModeClass" />.
		...
		/// </summary>
		public class RotaryModeClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: RotaryModeEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.RotaryModeEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "ROTARY_MODE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="RotaryModeClass" />.
		/// </summary>
