...
{
	/// <summary>﻿<see cref="EventEnum.POWER_STATE">EventEnum.POWER_STATE</see><br /><br /><br />
	...
	public sealed class PowerStateClass : IClass
	{
		/// <summary>Constant value for <see cref="PowerStateClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218405_135132_2064";
		/// <summary>Constant value for <see cref="PowerStateClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218405_135132_2064";
		/// <summary>Constant value for <see cref="PowerStateClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::POWER_STATE)}}&#10;
";
		/// <summary>Constant value for <see cref="PowerStateClass.Name" /></summary>
		public const string NAME = "PowerState";
		/// <summary>Constant value for <see cref="PowerStateClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="PowerStateClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="PowerStateClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.1";
		/// <summary>Constant value for <see cref="PowerStateClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new PowerStateClassProperties Properties { get; } = new PowerStateClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="PowerStateClass" />.
		...
		/// </summary>
		public class PowerStateClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class ResultProperty : IProperty
			{
				...
				/// <summary>
				/// <inheritdoc />
				/// <remarks> Type: PowerStateEnumMetaClass </remarks>
				/// </summary>
				public System.Type Type => typeof(Mtconnect.DataTypes.PowerStateEnumMetaClass);
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "POWER_STATE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="PowerStateClass" />.
		/// </summary>
