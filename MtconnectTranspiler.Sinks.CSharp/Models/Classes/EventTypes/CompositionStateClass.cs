...
{
	/// <summary>﻿<see cref="EventEnum.COMPOSITION_STATE">EventEnum.COMPOSITION_STATE</see><br /><br /><br />
	...
	public sealed class CompositionStateClass : IClass
	{
		/// <summary>Constant value for <see cref="CompositionStateClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218222_423849_1632";
		/// <summary>Constant value for <see cref="CompositionStateClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218222_423849_1632";
		/// <summary>Constant value for <see cref="CompositionStateClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;{{def(EventEnum::COMPOSITION_STATE)}}&#10;
";
		/// <summary>Constant value for <see cref="CompositionStateClass.Name" /></summary>
		public const string NAME = "CompositionState";
		/// <summary>Constant value for <see cref="CompositionStateClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="CompositionStateClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="CompositionStateClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.4";
		/// <summary>Constant value for <see cref="CompositionStateClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new CompositionStateClassProperties Properties { get; } = new CompositionStateClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="CompositionStateClass" />.
		...
		/// </summary>
		public class CompositionStateClassProperties : Mtconnect.ObservationInformationModel.EventClass.EventClassProperties
		{
			/// <inheritdoc />
			...
			public new sealed class TypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "COMPOSITION_STATE";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="CompositionStateClass" />.
		/// </summary>
