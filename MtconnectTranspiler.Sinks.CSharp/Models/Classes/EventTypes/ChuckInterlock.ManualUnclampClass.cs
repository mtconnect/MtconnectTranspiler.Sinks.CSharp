...
namespace Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes
{
	...
	{
		/// <summary>Constant value for <see cref="ChuckInterlockManualUnclampClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1580378218214_457994_1614";
		/// <summary>Constant value for <see cref="ChuckInterlockManualUnclampClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1580378218214_457994_1614";
		/// <summary>Constant value for <see cref="ChuckInterlockManualUnclampClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="ChuckInterlockManualUnclampClass.Name" /></summary>
		public const string NAME = "ChuckInterlock.ManualUnclamp";
		/// <summary>Constant value for <see cref="ChuckInterlockManualUnclampClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ChuckInterlockManualUnclampClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ChuckInterlockManualUnclampClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.3";
		/// <summary>Constant value for <see cref="ChuckInterlockManualUnclampClass.DeprecatedVersion" /></summary>
		...
		public class ChuckInterlockManualUnclampClassProperties : Mtconnect.ObservationInformationModel.ObservationTypes.EventTypes.ChuckInterlockClass.ChuckInterlockClassProperties
		{
			...
			public new sealed class SubTypeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "MANUAL_UNCLAMP";
