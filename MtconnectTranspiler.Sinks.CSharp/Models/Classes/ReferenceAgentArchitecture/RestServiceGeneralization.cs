...
namespace Mtconnect.ReferenceAgentArchitecture
{
	...
	public sealed class RestServiceGeneralization : IClass
	{
		...
		/// </summary>
		public class RestServiceGeneralizationProperties : Mtconnect.ReferenceAgentArchitecture.ServiceClass.ServiceClassProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="RestServiceGeneralization" />.
		/// </summary>
