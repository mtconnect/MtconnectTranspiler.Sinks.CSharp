...
namespace Mtconnect.ReferenceAgentArchitecture
{
	...
	public sealed class NCLinkClass : IClass
	{
		...
		/// </summary>
		public class NCLinkClassProperties : Mtconnect.ReferenceAgentArchitecture.SinkClass.SinkClassProperties
		{
			/// <inheritdoc />
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="NCLinkClass" />.
		/// </summary>
