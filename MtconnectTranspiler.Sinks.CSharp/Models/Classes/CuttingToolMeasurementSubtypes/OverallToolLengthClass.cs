...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingToolMeasurementSubtypes
{
	...
	/// <br/>Visit <seealso href="https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119507_120351_1420">model.mtconnect.org</seealso> for more information.
	/// </summary>
	/// <remarks>
	/// <list type="bullet">
	...
	{
		/// <summary>Constant value for <see cref="OverallToolLengthClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1582919119507_120351_1420";
		/// <summary>Constant value for <see cref="OverallToolLengthClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119507_120351_1420";
		/// <summary>Constant value for <see cref="OverallToolLengthClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;largest length dimension of the cutting tool including the master insert where applicable.&#10;
";
		/// <summary>Constant value for <see cref="OverallToolLengthClass.Name" /></summary>
		public const string NAME = "OverallToolLength";
		/// <summary>Constant value for <see cref="OverallToolLengthClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="OverallToolLengthClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="OverallToolLengthClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="OverallToolLengthClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new OverallToolLengthClassProperties Properties { get; } = new OverallToolLengthClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="OverallToolLengthClass" />.
		...
		/// </summary>
		public class OverallToolLengthClassProperties : Mtconnect.AssetInformationModel.CuttingTool.CuttingToolLifeCycle.ToolingMeasurementGeneralization.ToolingMeasurementGeneralizationProperties
		{
			/// <inheritdoc />
			...
			public new sealed class CodeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "OAL";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="OverallToolLengthClass" />.
		/// </summary>
