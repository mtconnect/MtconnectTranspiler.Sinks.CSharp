...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingToolMeasurementSubtypes
{
	...
	{
		/// <summary>Constant value for <see cref="UsableLengthMaxClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1582919119515_469091_1432";
		/// <summary>Constant value for <see cref="UsableLengthMaxClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119515_469091_1432";
		/// <summary>Constant value for <see cref="UsableLengthMaxClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="UsableLengthMaxClass.Name" /></summary>
		public const string NAME = "UsableLengthMax";
		/// <summary>Constant value for <see cref="UsableLengthMaxClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="UsableLengthMaxClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="UsableLengthMaxClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="UsableLengthMaxClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new UsableLengthMaxClassProperties Properties { get; } = new UsableLengthMaxClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="UsableLengthMaxClass" />.
		...
		/// </summary>
		public class UsableLengthMaxClassProperties : Mtconnect.AssetInformationModel.CuttingTool.CuttingToolLifeCycle.ToolingMeasurementGeneralization.ToolingMeasurementGeneralizationProperties
		{
			/// <inheritdoc />
			...
			public new sealed class CodeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "LUX";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="UsableLengthMaxClass" />.
		/// </summary>
