...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingToolMeasurementSubtypes
{
	...
	{
		/// <summary>Constant value for <see cref="ProtrudingLengthClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1582919119517_195399_1435";
		/// <summary>Constant value for <see cref="ProtrudingLengthClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119517_195399_1435";
		/// <summary>Constant value for <see cref="ProtrudingLengthClass.Summary" /></summary>
		public const string SUMMARY = @"&#10;&#10;&#10;dimension from the yz-plane to the furthest point of the tool item or adaptive item measured in the -X direction.&#10;
";
		/// <summary>Constant value for <see cref="ProtrudingLengthClass.Name" /></summary>
		public const string NAME = "ProtrudingLength";
		/// <summary>Constant value for <see cref="ProtrudingLengthClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ProtrudingLengthClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ProtrudingLengthClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="ProtrudingLengthClass.DeprecatedVersion" /></summary>
		...
		/// </summary>
		public class ProtrudingLengthClassProperties : Mtconnect.AssetInformationModel.CuttingTool.CuttingToolLifeCycle.ToolingMeasurementGeneralization.ToolingMeasurementGeneralizationProperties
		{
			/// <inheritdoc />
			...
			public new sealed class CodeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "LPR";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ProtrudingLengthClass" />.
		/// </summary>
