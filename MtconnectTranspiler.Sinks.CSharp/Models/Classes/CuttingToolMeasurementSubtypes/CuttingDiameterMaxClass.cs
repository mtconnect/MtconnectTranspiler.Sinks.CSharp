...
{
	/// <summary>﻿maximum diameter of a circle on which the defined point Pk of each of the master inserts is located on a tool item. <br /><br />The normal of the machined peripheral surface points towards the axis of the cutting tool.<br /><br /><br />
	...
	{
		/// <summary>Constant value for <see cref="CuttingDiameterMaxClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1582919119503_763396_1414";
		/// <summary>Constant value for <see cref="CuttingDiameterMaxClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119503_763396_1414";
		/// <summary>Constant value for <see cref="CuttingDiameterMaxClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="CuttingDiameterMaxClass.Name" /></summary>
		public const string NAME = "CuttingDiameterMax";
		/// <summary>Constant value for <see cref="CuttingDiameterMaxClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="CuttingDiameterMaxClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="CuttingDiameterMaxClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="CuttingDiameterMaxClass.DeprecatedVersion" /></summary>
		...
		/// </summary>
		public class CuttingDiameterMaxClassProperties : Mtconnect.AssetInformationModel.CuttingTool.CuttingToolLifeCycle.ToolingMeasurementGeneralization.ToolingMeasurementGeneralizationProperties
		{
			/// <inheritdoc />
			...
			public new sealed class CodeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DC";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="CuttingDiameterMaxClass" />.
		/// </summary>
