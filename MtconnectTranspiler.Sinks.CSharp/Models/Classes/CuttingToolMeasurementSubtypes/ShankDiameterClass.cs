...
namespace Mtconnect.AssetInformationModel.CuttingTool.CuttingToolMeasurementSubtypes
{
	...
	{
		/// <summary>Constant value for <see cref="ShankDiameterClass.ReferenceId" /></summary>
		public const string REFERENCE_ID = "_19_0_3_45f01b9_1582919119509_829628_1423";
		/// <summary>Constant value for <see cref="ShankDiameterClass.HelpUrl" /></summary>
		public const string HELP_URL = "https://model.mtconnect.org/#Structure___19_0_3_45f01b9_1582919119509_829628_1423";
		/// <summary>Constant value for <see cref="ShankDiameterClass.Summary" /></summary>
...
";
		/// <summary>Constant value for <see cref="ShankDiameterClass.Name" /></summary>
		public const string NAME = "ShankDiameter";
		/// <summary>Constant value for <see cref="ShankDiameterClass.AccessModifier" /></summary>
		public const string ACCESS_MODIFIER = "public";
		/// <summary>Constant value for <see cref="ShankDiameterClass.Modifier" /></summary>
		public const string MODIFIER = "";
		/// <summary>Constant value for <see cref="ShankDiameterClass.NormativeVersion" /></summary>
		public const string NORMATIVE_VERSION = "1.2";
		/// <summary>Constant value for <see cref="ShankDiameterClass.DeprecatedVersion" /></summary>
		...
		/// <inheritdoc />
		public new ShankDiameterClassProperties Properties { get; } = new ShankDiameterClassProperties();
        IPropertyList IClass.Properties => Properties;
		/// <summary>
		/// Property list for <see cref="ShankDiameterClass" />.
		...
		/// </summary>
		public class ShankDiameterClassProperties : Mtconnect.AssetInformationModel.CuttingTool.CuttingToolLifeCycle.ToolingMeasurementGeneralization.ToolingMeasurementGeneralizationProperties
		{
			/// <inheritdoc />
			...
			public new sealed class CodeProperty : IProperty
			{
				...
				public const string DEFAULT_VALUE = "DMM";
		...
		# region Rules
		/// <summary>
		/// List of constraint rules for <see cref="ShankDiameterClass" />.
		/// </summary>
