...
namespace Mtconnect.DataTypes
{
	...
	public sealed class FilterEnumMetaClass : IEnum
	{
		...
		public sealed class MINIMUM_DELTAValue : IEnumInstance
		{
			...
			/// <inheritdoc />
			public string Summary => @"/// new value <b>MUST NOT</b> be reported for a data item unless the measured value has changed from the last reported value by at least the delta given as the value of this element.  The value of <see cref=""Filter"">Filter</see> <b>MUST</b> be an absolute value using the same units as the reported data.";
		}
		...
		public sealed class PERIODValue : IEnumInstance
		{
			...
			/// <inheritdoc />
			public string Summary => @"/// data reported for a data item is provided on a periodic basis. The <c>PERIOD</c> for reporting data is defined in the value of the <see cref=""Filter"">Filter</see>.  The value of <see cref=""Filter"">Filter</see> <b>MUST</b> be an absolute value reported in seconds representing the time between reported samples of the value of the data item.";
		}
	}
}