...
namespace Mtconnect.DataTypes
{
	...
	{
		/// <summary>
		﻿/// sliding linear motion along an axis with a fixed range of motion.<br/><br />
		...
		PRISMATIC,
		/// <summary>
		﻿/// revolves around an axis with a continuous range of motion.<br/><br />
		...
		CONTINUOUS,
		/// <summary>
		﻿/// rotates around an axis with a fixed range of motion.<br/><br />
