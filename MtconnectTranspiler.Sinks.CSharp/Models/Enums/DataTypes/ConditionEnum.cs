...
namespace Mtconnect.DataTypes
{
	...
	public sealed class ConditionEnumMetaClass : IEnum
	{
		...
		public sealed class COMMUNICATIONSValue : IEnumInstance
		{
			...
			/// <inheritdoc />
			public string Summary => @"/// indication that the piece of equipment has experienced a communications failure.";
		}
		...
		public sealed class DATA_RANGEValue : IEnumInstance
		{
			...
			/// <inheritdoc />
			public string Summary => @"/// indication that the value of the data associated with a measured value or a calculation is outside of an expected range.";
		}
		...
		public sealed class LOGIC_PROGRAMValue : IEnumInstance
		{
			...
			/// <inheritdoc />
			public string Summary => @"/// indication that an error occurred in the logic program or programmable logic controller (PLC) associated with a piece of equipment.";
		}
		...
		public sealed class MOTION_PROGRAMValue : IEnumInstance
		{
			...
			/// <inheritdoc />
			public string Summary => @"/// indication that an error occurred in the motion program associated with a piece of equipment.";
		}
		...
		public sealed class SYSTEMValue : IEnumInstance
		{
			...
			/// <inheritdoc />
			public string Summary => @"/// general purpose indication associated with an electronic component of a piece of equipment or a controller that represents a fault that is not associated with the operator, program, or hardware.";
		}
		...
		public sealed class ACTUATORValue : IEnumInstance
		{
			...
			/// <inheritdoc />
			public string Summary => @"/// indication of a fault associated with an actuator.";
		}
	}
}